...
@class NSString, NSURLRequest, SCHeader, UIButton, WKWebView;
@protocol SCOnDemandGeofilterWebViewControllerDelegate;

@interface SCOnDemandGeofilterWebViewController : SCOnDemandGeofilterBaseLeftSwipableViewController <WKNavigationDelegate, SCHeaderDelegate, SCHeaderDataSource>
{
    SCHeader *_header;
