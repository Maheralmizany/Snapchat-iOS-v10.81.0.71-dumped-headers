...
- (id)resolveFileForSnap:(id)arg1 assetDescriptor:(long long)arg2;
- (id)resolveFileForSnap:(id)arg1;
- (id)resolveFileForSnapId_DO_NOT_USE:(id)arg1;
- (_Bool)addSnapAssetForSnap:(id)arg1 assetDescriptor:(long long)arg2 assetURL:(id)arg3 isSnapSynced:(_Bool)arg4;
