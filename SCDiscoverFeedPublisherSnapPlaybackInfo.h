...
- (id)initWithSnapId:(id)arg1 snapURL:(id)arg2 hashValue:(id)arg3 snapType:(id)arg4 adType:(long long)arg5 adPlacementMetadata:(id)arg6 tile:(id)arg7 viewed:(_Bool)arg8 sequence:(long long)arg9 isUserGeneratedContent:(_Bool)arg10 originalSnapId:(id)arg11 mediaType:(int)arg12;
- (id)xLogObjectInfo;
