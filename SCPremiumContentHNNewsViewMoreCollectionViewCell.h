...
@class NSString, SCLoadingIndicatorView, SCShapeView, UILabel;
@protocol SCActionHandling, SCSectionKitCollectionViewViewMoreActionableDelegate;

@interface SCPremiumContentHNNewsViewMoreCollectionViewCell : UICollectionViewCell <SCViewModelConfigurable, SCActionable, SCSectionKitCollectionViewViewMoreActionable, SCDiscoverFeedCollectionViewCellAnimating>
{
