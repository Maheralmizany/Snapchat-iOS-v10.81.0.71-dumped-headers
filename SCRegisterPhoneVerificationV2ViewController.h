...
@class NSDictionary, NSString, NSTimer, SCAuthenticatedPhoneManager, SCFeatureSettingsService, SCLegacyRegistrationFindFriendsService, SCRegisterPhoneVerificationV2View, SCScopedAccess, SCUnauthenticatedPhoneManager, SCUserSession, UIToolbar;
...
- (void)_verifyNumberDidSucceed:(id)arg1;
- (void)verifyNumberDidSucceed:(id)arg1;
- (void)_verifyNumberFailed;
- (void)_verifyNumberDidFailSpecificErrors:(id)arg1;
- (void)_verifyNumberDidFailGeneralError;
