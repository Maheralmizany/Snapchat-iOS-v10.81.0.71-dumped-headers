...
- (id)initWithStoryCircleViewModel:(id)arg1 displayLabel:(id)arg2 actionSubtext:(id)arg3 tapActionModel:(id)arg4 longPressActionModel:(id)arg5 preferredSize:(struct CGSize)arg6 alpha:(double)arg7 actionButtonViewModel:(id)arg8 storyLoggingInfo:(id)arg9;
