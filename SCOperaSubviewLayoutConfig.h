...
+ (id)layoutConfigWithHeightToWidthAspectRatio:(double)arg1 docking:(unsigned long long)arg2;
+ (id)layoutConfig;
...
- (id)initWithHeightToWidthAspectRatio:(double)arg1 docking:(unsigned long long)arg2;
- (id)init;
