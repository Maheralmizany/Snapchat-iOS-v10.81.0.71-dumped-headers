...
- (id)initWithStoryType:(long long)arg1 storyTypeSpecific:(long long)arg2 posterId:(id)arg3 storyTimeViewed:(double)arg4 totalStoryTime:(double)arg5 numSnaps:(unsigned long long)arg6 numSnapsViewed:(unsigned long long)arg7 numSnapsUniqueViewed:(unsigned long long)arg8 entryReason:(long long)arg9 entryIntent:(long long)arg10 exitReason:(long long)arg11 fullyViewed:(_Bool)arg12 viewLocationPos:(long long)arg13 viewSource:(long long)arg14 playMode:(long long)arg15 storyAccessType:(long long)arg16;
