...
- (void)updateMetadataWithMessageId:(id)arg1 sendToFriendCount:(long long)arg2 sendToFsnGroupConversationIds:(id)arg3 sendToArroyoGroupConversationIds:(id)arg4 sendToStoryCount:(long long)arg5;
- (void)setMediaType:(long long)arg1 forMediaId:(id)arg2 messageId:(id)arg3;
- (void)registerBatchTaskId:(id)arg1;
- (void)updateMetadataWithMessageId:(id)arg1 captureId:(id)arg2 messageBodyType:(long long)arg3 mediaType:(long long)arg4 batchTaskId:(id)arg5;
