...
@protocol SCTConversationMetadata, SCTalkSession;
...
- (void)setActiveTalkSessionWithConversationId:(NSString *)arg1 conversationMetadata:(id <SCTConversationMetadata>)arg2 presenceEnabled:(_Bool)arg3;
