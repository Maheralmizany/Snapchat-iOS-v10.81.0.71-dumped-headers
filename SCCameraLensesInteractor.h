...
@class NSString, SCCameraLensesEventListenerAnnouncer;
@protocol SCCameraLensesControllerProtocol, SCLensCameraScreenDataProviderProtocol, SCLensDataProviderRegistryUpdatable;
...
{
    id <SCLensDataProviderRegistryUpdatable> _lensDataProviderRegistry;
