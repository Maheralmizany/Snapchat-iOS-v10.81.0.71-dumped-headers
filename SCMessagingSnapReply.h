...
@class SCMessagingExternalMedia, SCMessagingNote, SCMessagingShare, SCMessagingSnap, SCMessagingSnapdocWrapper, SCMessagingSticker, SCMessagingText, SDMSnapDoc;
...
@property(retain, nonatomic) SDMSnapDoc *originalSnapdoc; // @dynamic originalSnapdoc;
@property(retain, nonatomic) SCMessagingSnapdocWrapper *originalSnapdocWrapper; // @dynamic originalSnapdocWrapper;
...
@property(retain, nonatomic) SDMSnapDoc *replySnapdoc; // @dynamic replySnapdoc;
@property(retain, nonatomic) SCMessagingSnapdocWrapper *replySnapdocWrapper; // @dynamic replySnapdocWrapper;
