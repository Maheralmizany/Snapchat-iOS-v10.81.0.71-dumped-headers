...
@class NSData, NSString, SCPremiumPublisherTile, SCSnapDoc;
...
- (id)initWithSnapURL:(id)arg1 hashValue:(id)arg2 snapId:(id)arg3 snapType:(id)arg4 adType:(int)arg5 adPlacementMetadata:(id)arg6 tile:(id)arg7 viewed:(_Bool)arg8 sequence:(long long)arg9 mediaTypeImage:(_Bool)arg10 isUserGeneratedContent:(_Bool)arg11 originalSnapId:(id)arg12 mediaType:(long long)arg13 snapDoc:(id)arg14;
