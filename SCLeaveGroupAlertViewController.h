...
@protocol SCLeaveGroupAlertViewControllerDelegate;
...
@interface SCLeaveGroupAlertViewController : NSObject <SCLeaveGroupAlertDelegate>
{
    ...
    id <SCLeaveGroupAlertViewControllerDelegate> _delegate;
}

@property(nonatomic) __weak id <SCLeaveGroupAlertViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
