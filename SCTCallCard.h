...
@class NSDate, NSLayoutConstraint, NSString, SCTCallCardAudioRoutingButton, SCTCallCardIncomingCallAccessory, SCTCallCardMediaToggleButton, SCTFancyButton, SCTLocalMediaView, UILabel, UIPanGestureRecognizer;
...
@interface SCTCallCard : UIView <SCTV3ELMShrinkTarget, SCTLocalMediaViewListener>
{
    ...
    NSLayoutConstraint *_routeButtonTopConstraint;
    NSLayoutConstraint *_routeButtonTrailConstraint;
    NSLayoutConstraint *_muteButtonTopConstraint;
    NSLayoutConstraint *_muteButtonTrailConstraint;
    NSLayoutConstraint *_cameraButtonTopConstraint;
    NSLayoutConstraint *_cameraButtonTrailConstraint;
    _Bool _joinButtonEnabled;
    unsigned long long _mode;
}

@property(nonatomic, getter=isJoinButtonEnabled) _Bool joinButtonEnabled; // @synthesize joinButtonEnabled=_joinButtonEnabled;
...
- (void)_initSubviews;
- (void)_activateCameraButtonConstraintsIsInCall:(_Bool)arg1;
- (void)_activateMuteButtonConstraintsIsInCall:(_Bool)arg1;
- (void)_activateRouteButtonConstraintsIsInCall:(_Bool)arg1;
- (void)_activateConstraintsForButton:(id)arg1 isInCall:(_Bool)arg2 topConstraint:(id)arg3 trailConstraint:(id)arg4 topMarginInCall:(double)arg5 topMarginCalling:(double)arg6 trailMarginInCall:(double)arg7 trailMarginCalling:(double)arg8;
- (void)_pan:(id)arg1;
...
@property(readonly, nonatomic) SCTCallCardAudioRoutingButton *audioRoutingButton;
...
- (id)initWithDelegate:(id)arg1 talkUIContoller:(id)arg2 mode:(unsigned long long)arg3 audioRoutingEnabled:(_Bool)arg4;
