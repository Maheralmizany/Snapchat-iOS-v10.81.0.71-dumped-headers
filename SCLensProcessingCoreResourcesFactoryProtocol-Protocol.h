...
@protocol LSAExperimentProviderProtocol, SCCrashedLensIdProvider, SCLensCrashLoggerProtocol, SCLensCrashLoggerStoreProtocol, SCLensLoggerConsumptionTrackingProviding, SCLensPreferences, SCLensSDKLogLevelProviderProtocol, SCLensTraceLoggerProtocol;

@protocol SCLensProcessingCoreResourcesFactoryProtocol <NSObject>
- (id <SCLensPreferences>)lensPreferences;
- (id <SCLensLoggerConsumptionTrackingProviding>)lensConsumptionLogger;
