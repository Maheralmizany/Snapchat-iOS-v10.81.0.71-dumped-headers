...
- (id)initWithUserId:(id)arg1 avatarId:(id)arg2 selfieId:(id)arg3 scale:(id)arg4 modifier:(unsigned long long)arg5 type:(unsigned long long)arg6 willAcceptPriorAvatarVersion:(_Bool)arg7;
