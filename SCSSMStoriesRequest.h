...
@class BadgeMetadata, GPBInt32Array, GPBInt32Int32Dictionary, GPBInt32ObjectDictionary, NSData, NSMutableArray, NSString, SCSCORETweaks, SCSSMAdsClientInfo, SCSSMClientInfo, SCSSMCognacClientInfo, SCSSMStoriesRequest_DeltaFetchInfo, SCSSMStoriesRequest_LensMetadata, SCSSMStoriesRequest_TopicMetadata;
...
@property(nonatomic) _Bool hasTopicMetadata; // @dynamic hasTopicMetadata;
...
@property(nonatomic) int studyPriority; // @dynamic studyPriority;
@property(retain, nonatomic) SCSSMStoriesRequest_TopicMetadata *topicMetadata; // @dynamic topicMetadata;
