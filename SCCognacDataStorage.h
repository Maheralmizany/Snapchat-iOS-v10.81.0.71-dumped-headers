...
- (void)updateWithSearchAppDataModels:(id)arg1 completionQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)updateWithDestinationAppDataModels:(id)arg1 completionQueue:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (id)searchAppDict;
- (id)searchAppArray;
- (id)destinationAppDict;
- (id)destinationAppArray;
- (id)targetedAppDict;
- (id)targetedAppArray;
- (id)init;
