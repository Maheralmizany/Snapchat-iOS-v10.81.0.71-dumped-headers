...
@protocol SCCaptionEditingDelegate;
...
@interface SCCaptionDefaultTextView : NSObject <SCCaption, SCPreviewAlignableView>
{
    ...
    _Bool _editing;
    long long uniqueId;
    id <SCCaptionEditingDelegate> _editingDelegate;
...
@property(nonatomic) __weak id <SCCaptionEditingDelegate> editingDelegate; // @synthesize editingDelegate=_editingDelegate;
