...
@class NSString, SCExperimentManager, SCFeatureSettingsService, SCLazy, SCLocationSharingAudienceChooser, SCMapLoggerEventSender, SCMapModalViewController, SCMapSnapTokenService, SCMapStatusCreationGhostModeHelper, SCMapStatusCreationView, SCMapStatusStore, SCMapUserPreferences, SCStopwatch, SCUserInfoProvider;
@protocol SCBitmojiSettingsPresenting, SCCheckInOptionFetcher, SCLocationProvider, SCLocationSharingSettingsPresenting, SCMapPeopleFriendsProvider, SCMapPersonLocationsProviding, SCMapStatusCreationViewControllerDelegate, SCMapStatusCreationViewProvider;
...
@interface SCMapStatusCreationViewController : UIViewController <SCComposerViewOwner, SCMapCurrentStatusViewControllerDelegate, SCMapStatusFetcherListener, SCMapStatusCreationContext, SCVenueFeedbackViewControllerDelegate, SCMapModalViewControllerSubclass>
{
    ...
    long long _source;
    SCUserInfoProvider *_userBirthdayProvider;
    SCUserInfoProvider *_userRegistrationProvider;
...
- (void)viewDidLoad;
- (id)initWithBitmojiAvatarId:(id)arg1 bitmojiSettingsPresenter:(id)arg2 checkInOptionFetcher:(id)arg3 currentUserId:(id)arg4 delegate:(id)arg5 experimentManager:(id)arg6 featureSettingsService:(id)arg7 locationProvider:(id)arg8 locationSharingSettingsPresenter:(id)arg9 mapLoggerEventSender:(id)arg10 mapPeopleFriendsProvider:(id)arg11 mapPersonLocationsProvider:(id)arg12 mapStatusStore:(id)arg13 mapUserPreferences:(id)arg14 sharingPreferencesMutator:(id)arg15 sharingPreferencesProvider:(id)arg16 snapTokenService:(id)arg17 source:(long long)arg18 userBirthdayProvider:(id)arg19 userRegistrationProvider:(id)arg20 viewProvider:(id)arg21;
