...
- (id)initWithAdIdentifier:(id)arg1 snapIndex:(long long)arg2 deepLinkFromCard:(_Bool)arg3 deepLinkFallBackToAppStore:(_Bool)arg4 deepLinkFallBackToWebview:(_Bool)arg5 deepLinkURI:(id)arg6 interactionZoneItemIndex:(id)arg7;
