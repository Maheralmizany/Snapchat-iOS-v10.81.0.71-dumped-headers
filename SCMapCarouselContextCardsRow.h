...
@protocol SCEmbeddedContextCardsDelegate, SCMapCarouselRowHeightUpdatesObserver, SCPageNameLogging;
...
@interface SCMapCarouselContextCardsRow : NSObject <SCMapCarouselRow>
{
    ...
    id <SCEmbeddedContextCardsDelegate> _cardsLoadingDelegate;
