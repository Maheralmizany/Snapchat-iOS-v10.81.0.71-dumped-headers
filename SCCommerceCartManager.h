...
#import "SCCommerceCartCoordinating-Protocol.h"
...
@interface SCCommerceCartManager : NSObject <NSCoding, SCUserSessionScoped, SCEventAnnouncing, SCCommerceCartMetricsProvider, SCCommerceCartCoordinating>
{
...
- (void).cxx_destruct;
- (void)uploadCartLineItemArtifactsForStoreId:(id)arg1;
- (id)getLineItemsForCart:(id)arg1;
- (void)appendLineItemsToCart:(id)arg1 storeId:(id)arg2;
...
- (void)clearCartForStoreId:(id)arg1;
- (void)clear;
- (_Bool)saveState;
