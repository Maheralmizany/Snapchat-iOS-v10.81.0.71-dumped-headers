...
@class NSString, SCButton, SCDatePicker, SCFeatureSettingsService, SCLazy, SCSettingsSwitchTableViewCell, SCTextView, SCUserSession, UILabel, UITableView;
...
- (void)_handleBirthdayUpdateGeneralError:(id)arg1;
- (void)_handleBirthdayUpdateSuccess;
...
- (void)loadView;
- (id)pageViewName;
- (id)initWithUserSession:(id)arg1 birthdayProvider:(id)arg2 birthdayMutator:(id)arg3;
