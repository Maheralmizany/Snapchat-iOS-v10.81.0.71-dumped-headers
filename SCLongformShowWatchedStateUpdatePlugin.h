...
- (void)_outputUpdateForFullyViewedShow:(id)arg1 showId:(id)arg2 snapId:(id)arg3 forceSubmit:(_Bool)arg4;
- (void)_outputUpdateForParams:(id)arg1 context:(id)arg2 snap:(id)arg3 forceSubmit:(_Bool)arg4;
