...
@class NSArray, NSDate, NSDictionary, NSNumber, NSString, SCChatGroupUpdateContent, SCChatMediaContent, SCChatMediaSave, SCChatMessageParcel, SCChatSticker, SCSnapState, SOJUKhaleesiShare, SOJUNycShare, SOJUSearchShareStory, SOJUSearchShareStorySnap, SOJUSnapMetadata, SOJUSnapProStoryReplyInfo, SOJUSnapchatter, SOJUStoryShare;
...
@interface SCChatMessageV3 : NSObject <SCChatMessage, SCChatMessageState, SCChatRenderingMessage, SCChatMessageV3>
{
    ...
    NSString *_mediaSendTaskClientMessageId;
    ...
    SOJUSnapProStoryReplyInfo *_snapProStoryReplyInfo;
}

+ (unsigned long long *)fasterCodingKeys;
+ (unsigned long long)fasterCodingVersion;
@property(readonly, copy, nonatomic) SOJUSnapProStoryReplyInfo *snapProStoryReplyInfo; // @synthesize snapProStoryReplyInfo=_snapProStoryReplyInfo;
...
@property(readonly, copy, nonatomic) NSString *mediaSendTaskClientMessageId; // @synthesize mediaSendTaskClientMessageId=_mediaSendTaskClientMessageId;
...
- (id)initWithConsistentId:(id)arg1 encryptedId:(id)arg2 messageSender:(id)arg3 conversationId:(id)arg4 recipientForOneOnOneChat:(id)arg5 knownChatSequenceNumbers:(id)arg6 messageTimestamp:(id)arg7 sentTimestamp:(id)arg8 sendStartTimestamp:(id)arg9 iterToken:(id)arg10 savedState:(id)arg11 releaseState:(id)arg12 preserveState:(id)arg13 snapState:(id)arg14 type:(long long)arg15 text:(id)arg16 attributes:(id)arg17 mediaCardAttributes:(id)arg18 media:(id)arg19 overlayMedia:(id)arg20 medias:(id)arg21 chatSticker:(id)arg22 groupUpdate:(id)arg23 snapMetadata:(id)arg24 encryptedGeoData:(id)arg25 storyTitle:(id)arg26 speedwayStoryV2Source:(long long)arg27 storyShare:(id)arg28 mediaSendTaskId:(id)arg29 mediaSendTaskClientMessageId:(id)arg30 snapchatterShare:(id)arg31 khaleesiShare:(id)arg32 nycShare:(id)arg33 searchSnapShare:(id)arg34 searchStoryShare:(id)arg35 mediaSave:(id)arg36 sendStatus:(long long)arg37 groupId:(long long)arg38 mischiefVersion:(unsigned long long)arg39 typeVersion:(id)arg40 shouldRetryMediaSendTask:(_Bool)arg41 isSnapEnvelopeReleased:(_Bool)arg42 snapServerId:(id)arg43 isPendingSnap:(_Bool)arg44 isSavedToMemories:(_Bool)arg45 replyMedias:(id)arg46 messageParcel:(id)arg47 isScreenRecording:(_Bool)arg48 screenCaptureSource:(long long)arg49 markedForDeletionByServer:(_Bool)arg50 retentionInMinutes:(unsigned long long)arg51 snapProStoryReplyInfo:(id)arg52;
