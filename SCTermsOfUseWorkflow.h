...
@class NSString;
@protocol SCGraphene, SCPrivacyPolicyService, SCTermsOfUsePageRouter, SCTermsOfUseService, SCTermsOfUseWorkflowDelegate;
...
- (void)beginWorkflow;
- (id)initWithTermsOfUseService:(id)arg1 privacyPolicyService:(id)arg2 delegate:(id)arg3 pageRouter:(id)arg4 enableTermsOfServiceV8Experience:(_Bool)arg5 graphene:(id)arg6;
