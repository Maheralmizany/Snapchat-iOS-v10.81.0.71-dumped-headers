...
@property(readonly, copy, nonatomic) NSString *externalLink; // @synthesize externalLink=_externalLink;
...
- (id)initWithProductId:(id)arg1 storeId:(id)arg2 title:(id)arg3 descriptionHTML:(id)arg4 iconUrl:(id)arg5 partner:(id)arg6 checkoutItemLimit:(unsigned long long)arg7 imageUrls:(id)arg8 variants:(id)arg9 isShareable:(_Bool)arg10 externalLink:(id)arg11;
