...
@class NSString, SCChatLoadHistoryActionHandler, SCChatMetadataFetchActionHandler, UIViewController;
@protocol SCActionHandling, SCChatCellGestureDelegate><SCChatFullscreenMediaChatTableCellDelegate><SCChatVisibilityProvider><SCActionable><SCPageNameLogging, SCChatConversationViewModel, SCSavableItemChatTableViewCellDelegate, SCSnapReplayViewCellDelegate, UIScrollViewDelegate;
...
@interface SCChatTableViewV3Delegate : NSObject <SCTraceEnabled, UITableViewDelegate, UITableViewDataSource, SCChatConversationUpdaterListener, SCChatViewLifeCycleListener, SCChatCellMediaDelegate>
{
    ...
    NSString *_inflightPaginationRequestToken;
}
...
- (void)_loadHistoryWithActionModel:(id)arg1 paginationToken:(id)arg2;
- (void)_loadHistoryForLoadingViewModel:(id)arg1;
...
- (id)initWithScrollDelegate:(id)arg1 withParentVC:(id)arg2 savableCellDelegate:(id)arg3 replayCellDelegate:(id)arg4 chatActionHandler:(id)arg5;
