...
@class SCCognacAdRules, SCCognacAdSDKInfo, SCCognacAdWatchInfo, SCEventListenerAnnouncer, UIViewController;
...
- (void)initializeAdsWithRules:(SCCognacAdRules *)arg1 sdkInfo:(SCCognacAdSDKInfo *)arg2 cognacDataUpdateAnnouncer:(SCEventListenerAnnouncer *)arg3;
@end
