...
- (void)insertSticker:(id <SCStickerProtocol>)arg1 center:(struct CGPoint)arg2 thumbnail:(UIImage *)arg3 isFromRecents:(_Bool)arg4 isFromSearch:(_Bool)arg5 createdCustomSticker:(_Bool)arg6 contentView:(SCPreviewStickerViewContentView *)arg7;
