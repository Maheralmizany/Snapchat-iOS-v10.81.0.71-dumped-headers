...
- (void).cxx_destruct;
- (void)setDeepLinkFromCard:(_Bool)arg1 deepLinkFallBackToAppStore:(_Bool)arg2 deepLinkFallBackToWebview:(_Bool)arg3 deepLinkURI:(id)arg4 interactionZoneItemIndex:(id)arg5;
