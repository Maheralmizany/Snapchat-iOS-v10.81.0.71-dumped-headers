...
@protocol SCGeoFilterLogger, SCImageProcessVideoPlaybackLogging, SCPreviewAggregateLatencyLogging, SCPreviewLatencyLogging, SCPreviewUserInteractionStateLogging, SCStickerProtocol;
...
@property(retain, nonatomic) id <SCImageProcessVideoPlaybackLogging> videoPlaybackLogger;
...
- (NSArray *)blizzardEventsForSendingSharedMessage:(SCSnapCommonLoggingParameters *)arg1 isFromSnapchatGallery:(_Bool)arg2;
