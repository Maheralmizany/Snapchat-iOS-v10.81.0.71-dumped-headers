...
- (id)rootUsage;
- (void)scan:(id)arg1 emitSubDirectoriesMetricsForTmpDirectory:(_Bool)arg2 emitDiskMetricsForExtensionDirectory:(_Bool)arg3;
- (void)_scanRoot:(id)arg1 emitSubDirectoriesMetricsForTmpDirectory:(_Bool)arg2 emitDiskMetricsForExtensionDirectory:(_Bool)arg3;
