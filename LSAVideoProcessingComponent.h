...
{
    struct unique_ptr<LS::FrameBuffer, LS::Common::Callable<void (LS::FrameBuffer *)>> _frameBuffer;
...
- (void)updateTextureOrientationWithCameraInfo:(const struct CameraInfo *)arg1;
...
- (tuple_48339975)imageAndTextureFromYUVPixelBuffer:(struct __CVBuffer *)arg1 processingInfo:(id)arg2 cameraInfo:(const struct CameraInfo *)arg3 inputSize:(struct CGSize)arg4 shouldDownscaleImage:(_Bool)arg5 coreManager:(shared_ptr_6e078de4)arg6;
- (id)_processBGRAPixelBuffer:(struct __CVBuffer *)arg1 processingInfo:(id)arg2 coreManager:(shared_ptr_6e078de4)arg3;
- (unique_ptr_430f0bd3)imageFromBGRAPixelBuffer:(struct __CVBuffer *)arg1 processingInfo:(id)arg2 cameraInfo:(const struct CameraInfo *)arg3 coreManager:(shared_ptr_6e078de4)arg4;
- (shared_ptr_19c28840)imageProcessingConfigFromProcessingInfo:(id)arg1 texture:(const shared_ptr_c46ccacf *)arg2 cameraInfo:(const struct CameraInfo *)arg3;
- (void)updateImageProcessingConfig:(LSAObjCppPtrWrapper_dcbd9e45)arg1 withProcessingInfo:(id)arg2 texture:(const shared_ptr_c46ccacf *)arg3 size:(struct CGSize)arg4;
