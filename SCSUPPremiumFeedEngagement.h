...
@property(nonatomic) _Bool hasWindowedHappeningNowStats; // @dynamic hasWindowedHappeningNowStats;
...
@property(retain, nonatomic) SCSUPWindowedEngagementStats *windowedHappeningNowStats; // @dynamic windowedHappeningNowStats;
