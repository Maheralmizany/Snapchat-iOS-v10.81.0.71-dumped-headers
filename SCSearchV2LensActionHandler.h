...
@protocol SCFeatureLensFeed, SCLensLiveLensPreviewCameraPresenterProtocol, SCLensUnlockerProtocol;
...
- (id)initWithLensFeedFeature:(id)arg1 liveLensPreviewCameraPresenter:(id)arg2 lensUnlocker:(id)arg3;
