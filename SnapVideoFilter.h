...
- (long long)_spectaclesLensDisparityOffset;
...
- (void)_prepareSpectaclesMedia:(id)arg1 snap:(id)arg2 snapOverlay:(id)arg3 isExporting:(_Bool)arg4 userSession:(id)arg5 videoTargetSize:(struct CGSize)arg6 spectaclesExportFormat:(long long)arg7 primaryCamera:(unsigned long long)arg8;
- (void)_checkIfUrlIsValidForAVAsset:(id)arg1 forVideoSnap:(id)arg2;
- (void)filterVideoSnap:(id)arg1 cloudFile:(id)arg2 encryptedContentManager:(id)arg3 reverseAudioCache:(id)arg4 respectSnapOrientation:(_Bool)arg5 scaleMalibu:(_Bool)arg6 blendOverlayIntoVideo:(_Bool)arg7 highQuality:(_Bool)arg8 videoTargetSize:(struct CGSize)arg9 isExporting:(_Bool)arg10 magicMomentCache:(id)arg11 spectaclesExportFormat:(long long)arg12 primaryCamera:(unsigned long long)arg13 userSession:(id)arg14 queue:(id)arg15 completion:(CDUnknownBlockType)arg16;
