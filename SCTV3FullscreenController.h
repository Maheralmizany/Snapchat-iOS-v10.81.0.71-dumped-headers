...
- (id)initWithChatServices:(id)arg1 callingServices:(id)arg2 fullscreenBarController:(id)arg3 talkUIController:(id)arg4 audioRoutingEnabled:(_Bool)arg5 groupConversation:(_Bool)arg6;
