...
@class AVAsset, NSArray, NSError, NSMutableArray, NSString, NSURL, SCBatchCaptureConfiguration, SCBatchCaptureSegmentExportSession, SCMultiSnapVideoSegmentedExportSession, SCQueuePerformer, SCSentinel, SCUserSession;
...
- (void)setAppMetadataWithAppAttachment:(id)arg1;
- (void)setGroupInviteWithGroupId:(id)arg1 inviteId:(id)arg2;
- (void)_cacheBatchCaptureStorySnapsToGalleryStore;
- (long long)_generateSnapVideoFilterList:(id)arg1 atIndex:(long long)arg2 forBatchCaptureSegment:(id)arg3;
...
- (void)generateBatchCaptureSnapVideoFilterList;
