...
+ (id)getMobileNumberForLogIn:(id)arg1 mobileNumber:(id)arg2;
+ (id)getCountryCodeAbbreviation:(id)arg1;
+ (id)getFullCountryNameFromCountryCodeAbbreviation:(id)arg1;
+ (id)formatMobileNumber:(id)arg1 countryCodeNumber:(id)arg2;
+ (id)getCountryCodeNumber:(id)arg1;
