...
@interface SCFeatureVolumeButtonCaptureImpl : SCFeature <SCCameraVolumeButtonHandlerDelegate, SCAudioSessionListener, SCTraceEnabled, SCFeatureVolumeButtonCapture>
{
...
- (void)audioSessionSilenceSecondaryAudioHintTypeDidChangeToStart:(id)arg1;
