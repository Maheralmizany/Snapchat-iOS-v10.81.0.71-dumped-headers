...
- (void)_configureWithSize:(unsigned long long)arg1 color:(unsigned long long)arg2 arcStyle:(unsigned long long)arg3;
...
- (id)initWithColor:(unsigned long long)arg1 size:(unsigned long long)arg2 arcStyle:(unsigned long long)arg3;
