...
@class BoltSignals, CameraSignals, ContentManagerSignals, FeatureProvidedSignals_SpectacleMetadata, FeatureProvidedSignals_StoryMetadata, LensesSignals, SDMMediaMetadata;
...
@property(nonatomic) _Bool hasLensesSignals; // @dynamic hasLensesSignals;
...
@property(retain, nonatomic) LensesSignals *lensesSignals; // @dynamic lensesSignals;
