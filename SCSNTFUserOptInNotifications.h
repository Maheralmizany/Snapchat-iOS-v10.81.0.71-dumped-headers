...
@class NSMutableArray, NSString, SCSNTFOptInNotification;
...
@property(nonatomic) _Bool hasHnNewsSectionOptIn; // @dynamic hasHnNewsSectionOptIn;
@property(retain, nonatomic) SCSNTFOptInNotification *hnNewsSectionOptIn; // @dynamic hnNewsSectionOptIn;
