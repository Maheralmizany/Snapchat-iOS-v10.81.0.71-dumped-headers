...
#import "SCCameraRollSaveableModel-Protocol.h"
...
@interface SCChatMediaContent : NSObject <SCCameraRollSaveableModel, SCChatMediaContent>
{
    _Bool _isBroadcast;
...
+ (void)generateThumbnailWithOverlayImage:(id)arg1 contentData:(id)arg2 videoURL:(id)arg3 mediaId:(id)arg4 isSpectacles:(_Bool)arg5 handler:(CDUnknownBlockType)arg6;
...
- (void)_logCorruptedData:(id)arg1;
