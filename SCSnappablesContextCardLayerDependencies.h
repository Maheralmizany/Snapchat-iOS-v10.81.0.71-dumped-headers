...
@protocol SCLensIconInMemoryCache, SCSnappablesAnalyticsEventController, SCSnappablesContextCardAppearanceEventHandler, SCSnappablesContextCardLayerViewProtocol;
...
@property(readonly, nonatomic) id <SCLensIconInMemoryCache> lensIconInMemoryCache; // @synthesize lensIconInMemoryCache=_lensIconInMemoryCache;
...
- (void).cxx_destruct;
- (id)initWithEventAnnouncer:(id)arg1 sharedResourceManager:(id)arg2 view:(id)arg3 analyticsController:(id)arg4 appearanceEventHandler:(id)arg5 snappablesPresenter:(id)arg6 layerLensControllerBuildBlock:(CDUnknownBlockType)arg7 lensIconInMemoryCache:(id)arg8;
