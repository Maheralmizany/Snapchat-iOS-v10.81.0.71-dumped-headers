...
@class SCAddFriendsQuickAddLogger, SCBehaviorSubject, SCLazy, SCSectionBasedCollectionViewUpdater, UICollectionView;
...
- (id)initWithSectionDataProvider:(id)arg1 displayDateObservable:(id)arg2 actionHandler:(id)arg3 quickAddLogger:(id)arg4;
