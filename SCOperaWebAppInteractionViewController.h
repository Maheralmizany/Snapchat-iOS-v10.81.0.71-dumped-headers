...
- (void)_handleActionsMenuAnimationWithParams:(id)arg1;
...
- (void)interactionViewDidClickActionsButton;
...
- (void)_setupViewForNonFriendsWithIsV2:(_Bool)arg1;
- (void)_setupAccessoriesForFriendsWithIsV2:(_Bool)arg1;
