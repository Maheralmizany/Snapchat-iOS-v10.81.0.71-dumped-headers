...
- (id)initWithViewFrame:(struct CGRect)arg1 isQuickSend:(_Bool)arg2 hideGiphy:(_Bool)arg3 commonLoggingParameters:(id)arg4 userSession:(id)arg5 bottomInset:(double)arg6 stickerPickerLogger:(id)arg7 previewLogger:(id)arg8 menuDelegate:(id)arg9 menuDataSource:(id)arg10 bloopsPreviewsViewOutput:(id)arg11 bloopsPreviewsEmptyCellDelegate:(id)arg12 bloopsStickersPreviewsViewOutput:(id)arg13 bloopsStickersOnboardingCellDelegate:(id)arg14;
