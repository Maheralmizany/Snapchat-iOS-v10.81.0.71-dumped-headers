...
@class NSString, SCCameraDeepLinkViewController, SCDisposableObserver, SCUserSession, UIView;
@protocol SCCameraTooltipPriorityResolving, SCFeatureContainerView, SCFeatureLensCarousel, SCFeatureToggleCamera, SCPreviewPresenter, SCUserTooltipProviding;
...
@interface SCFeatureSnapKitImpl : SCFeature <SCManagedCapturerListener, SCFeatureSnapKit, SCCameraGestureResponder>
{
    ...
    id <SCFeatureLensCarousel> _lensCarousel;
...
- (void)_lensResetandDisposeObservers;
- (void)_onLensChanged:(id)arg1;
- (void)didUpdateCarouselVisibility:(_Bool)arg1;
- (void)startToObserveCarouselChange;
- (void)startToObserveLensChange;
- (id)getLensId;
- (void)lensReset;
- (void)reset;
- (id)metadata;
...
- (void)dealloc;
- (id)initWithCapturer:(id)arg1 userSession:(id)arg2 toggleCamera:(id)arg3 lensCarousel:(id)arg4;
