...
- (void)onFetchAndSyncFeedComplete:(id)arg1 multiRecipientFeedEntries:(id)arg2 feedEntriesDeleted:(id)arg3 hasMoreEntries:(_Bool)arg4 resetFeed:(_Bool)arg5 metadata:(id)arg6;
