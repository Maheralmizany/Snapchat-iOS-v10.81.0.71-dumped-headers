...
@class NSAttributedString, NSString, SCActionModel, SCAppStorySendToLoggingMetadata, SCAvatarViewModel, SCCornerRadii, SCNetworkImage, SCSearchActionButtonViewModel, SCSendToScrollLabelModel, UIColor;
...
@interface SCSendToRecipientViewModel : NSObject <NSCopying>
{
    ...
    SCSearchActionButtonViewModel *_accessoryButtonViewModel;
    SCAppStorySendToLoggingMetadata *_appStoryMetadata;
}

@property(readonly, copy, nonatomic) SCAppStorySendToLoggingMetadata *appStoryMetadata; // @synthesize appStoryMetadata=_appStoryMetadata;
@property(readonly, copy, nonatomic) SCSearchActionButtonViewModel *accessoryButtonViewModel; // @synthesize accessoryButtonViewModel=_accessoryButtonViewModel;
