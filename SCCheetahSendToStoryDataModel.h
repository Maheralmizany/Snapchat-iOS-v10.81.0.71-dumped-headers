...
- (id)initWithLabelText:(id)arg1 subtext:(id)arg2 isOfficial:(_Bool)arg3 officialFriendmoji:(id)arg4 itemType:(long long)arg5 itemId:(id)arg6 mischiefId:(id)arg7 unselectedImage:(id)arg8 timestamp:(id)arg9 isAppStoryAuthorized:(_Bool)arg10;
