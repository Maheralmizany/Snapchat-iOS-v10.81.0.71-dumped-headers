...
@class NSArray, NSData, NSDictionary, NSNumber, NSString, SCChatMediaContent, SCChatMessageV3, SCExperimentManager, SCLazy, SCSessionRequestManager;

@protocol SCChatRequestManager <NSObject>
- (void)toggleNotificationStatusForFriend:(NSString *)arg1 enabled:(_Bool)arg2 source:(long long)arg3 successBlock:(void (^)(NSHTTPURLResponse *, id))arg4 failureBlock:(void (^)(NSHTTPURLResponse *, NSError *))arg5;
- (void)uploadReplyMediaWithStoryId:(NSString *)arg1 key:(NSString *)arg2 iv:(NSString *)arg3 type:(long long)arg4 successBlock:(void (^)(NSHTTPURLResponse *, id))arg5 failureBlock:(void (^)(NSHTTPURLResponse *, NSError *))arg6 uploadId:(NSString *)arg7;
...
- (void)uploadMediaContent:(SCChatMediaContent *)arg1 dataToUpload:(NSData *)arg2 inMessage:(SCChatMessageV3 *)arg3 completionHandler:(void (^)(unsigned long long, SOJUMediaUrl *))arg4;
