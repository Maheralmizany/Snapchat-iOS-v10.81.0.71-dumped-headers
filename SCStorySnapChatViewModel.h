...
@property(retain, nonatomic) SCStorySnapMetadata *storySnapMetadata; // @synthesize storySnapMetadata=_storySnapMetadata;
@property(retain, nonatomic) SCStorySnapMediaContent *storySnapMediaContent; // @synthesize storySnapMediaContent=_storySnapMediaContent;
