...
@class NSArray, SCCloudSyncTriggerUserContext, SCQueuePerformer, SCUserSession, UIViewController;
...
- (void).cxx_destruct;
- (void)_segmentAsset:(id)arg1 completion:(CDUnknownBlockType)arg2;
