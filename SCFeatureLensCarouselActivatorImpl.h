...
@interface SCFeatureLensCarouselActivatorImpl : SCFeature <SCFeatureLensCarouselActivator>
{
    ...
    NSUUID *_uuid;
    long long _lensCarouselType;
}

@property(readonly, nonatomic) long long lensCarouselType; // @synthesize lensCarouselType=_lensCarouselType;
...
- (void)_activate;
- (id)initWithCameraViewType:(long long)arg1 lensCarouselType:(long long)arg2 arBarItem:(id)arg3;
