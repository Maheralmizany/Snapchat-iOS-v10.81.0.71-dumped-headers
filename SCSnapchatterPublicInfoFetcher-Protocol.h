...
- (void)localAndRemoteSnapchattersWithUserIds:(NSArray *)arg1 requestSource:(long long)arg2 completionQueue:(NSObject<OS_dispatch_queue> *)arg3 completionHandler:(void (^)(NSArray *, NSError *))arg4;
