...
@class NSString, SCFriendsFeedStatusConverter, SCLazy, SCQueuePerformer;
...
@interface SCComposerFriendsFeedStatusHandler : NSObject <SCCFriendsFeedStatusHandling>
{
    ...
    SCFriendsFeedStatusConverter *_friendsFeedStatusConverter;
...
- (id)initWithMatcher:(CDUnknownBlockType)arg1 friendsFeedDataCoordinator:(id)arg2 feedStatusConverter:(id)arg3;
