...
@class SCUserSession;
@protocol NavigationPageState, SCGalleryViewControlling;

@interface SCCameraToGalleryPresentationController : SCSwipePresentationController
{
    id <SCGalleryViewControlling> _galleryViewController;
...
@property(nonatomic) __weak id <SCGalleryViewControlling> galleryViewController; // @synthesize galleryViewController=_galleryViewController;
- (void).cxx_destruct;
