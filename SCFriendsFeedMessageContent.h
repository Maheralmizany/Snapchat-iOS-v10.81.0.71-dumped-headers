...
@class SCFriendsFeedCall, SCFriendsFeedChatMessage, SCFriendsFeedCognacContent, SCFriendsFeedMediaSaveMessage, SCFriendsFeedMultiRecipientContent, SCFriendsFeedSavedSnapMessage, SCFriendsFeedScreenshotMessage, SCFriendsFeedSnapMessage;
...
- (void).cxx_destruct;
- (void)matchSnap:(CDUnknownBlockType)arg1 call:(CDUnknownBlockType)arg2 screenshot:(CDUnknownBlockType)arg3 mediaSave:(CDUnknownBlockType)arg4 chat:(CDUnknownBlockType)arg5 multiRecipient:(CDUnknownBlockType)arg6 savedSnap:(CDUnknownBlockType)arg7 cognac:(CDUnknownBlockType)arg8;
