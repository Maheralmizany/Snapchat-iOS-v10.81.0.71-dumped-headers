...
@class SCSCORERequestMetadata, SCSCOREUUID;

@interface UpdateCustomStoryGroupMembershipRequest : GPBMessage
{
}
...
@property(nonatomic) int updateMembershipType; // @dynamic updateMembershipType;
