...
@class NSString, SCMTGetSearchCardsResponse, SCMapSearchSession, SCSearchNavigationCoordinator, SCSearchQuery;

@interface SCMapSearchQueryCoordinator : NSObject <SCSearchQueryCoordinating>
{
