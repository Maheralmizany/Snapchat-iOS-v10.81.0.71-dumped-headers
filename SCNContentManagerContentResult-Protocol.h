...
@protocol SCNContentManagerReadStream, SCNContentManagerTaskCompletionCallback, SCNContentManagerWriteStream, SCNNetworkManagerNetworkStats;

@protocol SCNContentManagerContentResult
- (void)addDownloadCompletionListener:(id <SCNContentManagerTaskCompletionCallback>)arg1;
