...
@class NSArray, NSDictionary, NSError, NSMutableDictionary, NSMutableSet, NSString, NSTimer, SCGallerySendItemsCounter, SCGallerySmartSharing, SCProgressOverlayView, SCQueuePerformer, SCScopedAccess, SCUserSession, UIViewController;
@protocol SCNContentManagerContentResult, SCProgressReporting><SCCanceling;
...
- (void)_startProgressSimulationTimer;
- (_Bool)_moveToCloudFSForSnap:(id)arg1 encryptedMediaBlob:(id)arg2 encryptedOverlayBlob:(id)arg3;
- (void)_moveToCloudFS:(id)arg1 key:(id)arg2 iv:(id)arg3 data:(id)arg4;
- (void)_downloadSnapMediaFromContentManagerIfRegistered:(id)arg1 index:(unsigned long long)arg2 completionQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_log;
