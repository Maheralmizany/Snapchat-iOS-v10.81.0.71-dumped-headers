...
@property(readonly, copy, nonatomic) NSDate *creationTimestamp; // @synthesize creationTimestamp=_creationTimestamp;
...
- (id)initWithGroupId:(id)arg1 groupName:(id)arg2 title:(id)arg3 subtitle:(id)arg4 lastSenderUserIds:(id)arg5 orderedParticipants:(id)arg6 lastInteractionTimestamp:(id)arg7 creationTimestamp:(id)arg8;
