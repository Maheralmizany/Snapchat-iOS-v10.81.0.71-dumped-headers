...
@class Friend, NSArray, NSString, SCAlertGear, SCLazy, SCMiniProfileChatOptionsSectionController, SCMiniProfileFriendIdentitySectionController, SCMiniProfileFriendOptionsSectionController, SCMiniProfileSettingsController, SCMiniProfileSnapchatterIdentitySectionController, SCMiniProfileStoryRelatedSnapchattersSectionController, SCOperaPresenter, SCScopedAccess, SCSnapchatter, SCTempSnapchatter, SCUserSession;
@protocol SCMiniProfileViewControllerDelegate;

@interface SCMiniProfileViewController : SCMiniProfileBaseViewController <SCS2RStackDebuggable, SCAlertGearDelegate, SCMiniProfileFriendOptionsSectionControllerDelegate, SCMiniProfileFriendIdentitySectionControllerDelegate, SCShareFriendViewControllerDelegate, SCOperaPresenterDelegate, SCMiniProfileStoryOptionsSectionControllerDelegate, SCReportPageViewControllerDelegate, SCMiniProfileChatOptionsSectionControllerDelegate, SCMiniProfileRelatedSnapchattersSectionControllerDelegate, SCSnapchattersDataRequestListener, SCPageNameLogging>
{
