...
+ (id)updatePlaybackStateToViewingForSnap:(id)arg1 withOpenTimestamp:(id)arg2 stackId:(id)arg3 isFirstSnapInStack:(_Bool)arg4;
...
+ (id)createSDKParcelMessageWithContent:(id)arg1 conversation:(id)arg2 type:(id)arg3 media:(id)arg4 tag:(id)arg5 tagVersion:(id)arg6 fromSender:(id)arg7 messageId:(id)arg8;
+ (id)conversation:(id)arg1 createStickerMessage:(id)arg2 fromSender:(id)arg3 messageId:(id)arg4;
+ (id)conversation:(id)arg1 createCallMessageForType:(long long)arg2 sender:(id)arg3 messageId:(id)arg4;
+ (id)conversation:(id)arg1 createScreenCaptureMessageWithType:(long long)arg2 withSource:(long long)arg3 fromSender:(id)arg4 messageId:(id)arg5;
+ (id)conversation:(id)arg1 createStatusMessageWithBodyType:(long long)arg2 fromSender:(id)arg3 messageId:(id)arg4;
+ (id)conversation:(id)arg1 createCameraRollSaveWithMessageId:(id)arg2 messageSender:(id)arg3 messageBodyType:(long long)arg4 mediaList:(id)arg5 username:(id)arg6 messageId:(id)arg7;
+ (id)conversation:(id)arg1 createTextMessage:(id)arg2 fromSender:(id)arg3 withAttributes:(id)arg4 customMediaCardAttributes:(id)arg5 messageId:(id)arg6;
+ (id)conversation:(id)arg1 newMessageBuilderFromSender:(id)arg2 messageId:(id)arg3;
+ (id)conversation:(id)arg1 newMessageBuilderFromSender:(id)arg2 messageTimestamp:(id)arg3 messageId:(id)arg4;
