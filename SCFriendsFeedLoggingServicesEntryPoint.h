...
@class SCAppUserLifecycleEventHandler, SCEntryPointCleanup, SCFeatureSettingsServices, SCGrapheneServices, SCLazy, SCServicesExposer, SCShakeToReportServices, SCSystemScope, SCUserSessionScope, SCUserStorageServices;
