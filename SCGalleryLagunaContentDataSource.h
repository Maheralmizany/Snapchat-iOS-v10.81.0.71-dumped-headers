...
@class NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSSet, NSString, SCDataObjectContext, SCGallerySpectaclesMetadataProvider, SCQueuePerformer, SCSentinel, SCSpectaclesServices, SCUserSession;
@protocol OS_dispatch_semaphore, SCGalleryLagunaContentDataSourceDelegate, SCUserPreferenceTimeProvider;

@interface SCGalleryLagunaContentDataSource : NSObject <SCCloudSyncStatusListener, SCSpectaclesEventListener, SCTraceEnabled, SCUserSessionScoped>
{
    _Bool _isSetup;
    ...
    SCGallerySpectaclesMetadataProvider *_spectaclesMetadataProvider;
...
- (void).cxx_destruct;
- (void)_initializeSpectaclesMetadataProviderIfNeeded;
- (id)_spectaclesMetadataProvider;
...
- (void)setupIfNeeded;
- (id)initWithUserSession:(id)arg1 spectaclesServices:(id)arg2 userPreferenceTimeProvider:(id)arg3;
