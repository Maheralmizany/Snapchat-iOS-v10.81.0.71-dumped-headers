...
@class FBKVOController, NSString, SCDisposableObserver, SCEmailManager, SCFeatureSettingsService, SCLazy, SCReauthenticationManager, SCTextView, SCUserSession, UIActivityIndicatorView, UIButton, UILabel, UISwitch, UIView;
...
- (void)loadView;
- (id)initWithUserSession:(id)arg1 emailInfoProvider:(id)arg2 emailMutator:(id)arg3 reauthenticationManager:(id)arg4 emailManager:(id)arg5 fromFeedTopPrompt:(_Bool)arg6;
- (id)initWithUserSession:(id)arg1 emailInfoProvider:(id)arg2 emailMutator:(id)arg3 reauthenticationManager:(id)arg4 emailManager:(id)arg5;
- (id)pageViewName;
