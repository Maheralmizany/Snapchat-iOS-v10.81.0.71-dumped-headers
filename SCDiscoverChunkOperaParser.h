...
+ (id)_loadingPagePropertiesForChunk:(id)arg1 pageProperties:(id)arg2 needsToCreateAttachmentViewModel:(_Bool)arg3 isInPlaylistMode:(_Bool)arg4;
...
+ (id)pagesPropertiesForChunk:(id)arg1 needsToCreateAttachmentViewModel:(_Bool)arg2 isInPlaylistMode:(_Bool)arg3 userSession:(id)arg4 mediaManager:(id)arg5 streamingURLProvider:(id)arg6 navigationDelegate:(id)arg7 operaNavigationStyle:(long long)arg8;
