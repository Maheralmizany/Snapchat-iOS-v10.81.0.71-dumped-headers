...
- (void)logCameraSnapCreateStepWithCaptureSessionId:(id)arg1 stepName:(id)arg2 stepDescription:(id)arg3 isFingerDownCapture:(_Bool)arg4 isBatchCapture:(_Bool)arg5;
