...
@interface SCSearchResultFriendsSection : NSObject <SCSectionKitCollectionViewViewMoreActionableDelegate, SCDataCoordinatorListener, SCActionHandling, SCSnapchattersDataRequestListener, SCCollectionViewSection, SCEventAnnouncing, SCActionable>
{
