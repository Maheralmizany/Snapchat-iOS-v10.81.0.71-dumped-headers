...
@protocol SOJUAdRemoteWebpageImpressionTrack <SCSojuMessage>
...
@property(readonly, nonatomic) NSNumber *deepLinkAppCount;
@property(readonly, nonatomic) NSNumber *visibleLoadTime;
