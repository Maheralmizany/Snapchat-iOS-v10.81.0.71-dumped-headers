...
@class NSString, SCChatSDKActionContext, SCCognacScoreShareMessageCardViewModel;
...
- (id)initWithScoreShare:(id)arg1 messageId:(id)arg2 senderUsername:(id)arg3 conversationId:(id)arg4 isGroupConversation:(_Bool)arg5;
- (id)initWithScoreShareMessage:(id)arg1 senderUsername:(id)arg2 conversationId:(id)arg3 isGroupConversation:(_Bool)arg4;
