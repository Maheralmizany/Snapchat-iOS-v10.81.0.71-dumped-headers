...
@interface SCSnapDocServicesEntryPoint : SCEntryPoint
{
    SCLazy *_lazySnapDocConfigurer;
    SCUserSessionScope *_userSessionScope;
    SCCircumstanceEngineServices *_circumstanceEngineServices;
    SCServicesExposer *_snapDocServicesExposer;
}

@property(retain, nonatomic) SCServicesExposer *snapDocServicesExposer; // @synthesize snapDocServicesExposer=_snapDocServicesExposer;
