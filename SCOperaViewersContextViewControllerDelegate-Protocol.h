...
@class NSString, SCOperaViewersCellBaseViewModel, SCOperaViewersContextViewController, UIScrollView, UIView;

@protocol SCOperaViewersContextViewControllerDelegate <NSObject>
- (void)viewersContextViewController:(SCOperaViewersContextViewController *)arg1 didTapTopSectionModel:(SCOperaViewersCellBaseViewModel *)arg2;
