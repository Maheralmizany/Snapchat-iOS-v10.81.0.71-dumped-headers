...
@protocol NSObject, SCChatGroup, SCChatMessageViewModel, SCChatRenderingConversation;

@protocol SCChatConversationViewModel <NSObject>
@property(readonly, nonatomic) id <SCChatRenderingConversation> debugConversation;
@property(readonly, nonatomic) NSString *debugDisplayPrefix;
