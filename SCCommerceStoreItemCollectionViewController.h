...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithStoreCategory:(id)arg1 commerceStoreCategorySession:(id)arg2 userSession:(id)arg3 imageDownloader:(id)arg4 catalogPagingDataCoordinator:(id)arg5 paginationProvider:(id)arg6 actionHandler:(id)arg7;
