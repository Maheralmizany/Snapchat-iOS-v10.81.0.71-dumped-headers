...
- (void).cxx_destruct;
- (void)_handleFetchedAllMyStories:(id)arg1;
- (void)_refreshAvatarViewForStoryUpdates;
- (void)_refreshAvatarViewForStoryUpdatesWithLogIdentifier:(id)arg1;
- (void)_handleMyStoriesDataUpdateRequest:(id)arg1 currentSnapConsistentId:(id)arg2;
- (void)dataCoordinatorDidUpdateWithIdentifier:(id)arg1 dataRequest:(id)arg2;
- (void)storiesModelDidUpdateWithParams:(id)arg1;
- (_Bool)willHandleDisplayedStoryUploadSuccess;
