...
- (void)getCondensedHandlerForUsersWithIds:(id)arg1 callback:(CDUnknownBlockType)arg2;
- (void)getHandlerForUsersWithIds:(id)arg1 callback:(CDUnknownBlockType)arg2;
- (void)getHandlerForUsersWithIds:(id)arg1 feedStatusConverter:(id)arg2 callback:(CDUnknownBlockType)arg3;
