...
@interface SCOperaViewModelsManager : NSObject <SCTraceEnabled>
{
    ...
    NSDictionary *_dimensionToLoadedViewModels;
...
- (void)_updateLoadedViewModelsForViewModelsToPreload:(id)arg1;
- (void)_updateLoadedViewModelsForAllDimensions:(id)arg1;
- (id)_loadedViewModelsForDimension:(long long)arg1 direction:(long long)arg2;
- (id)_loadedViewModelsForDimension:(long long)arg1;
- (void)_updateLoadedViewModelsBasedOnCurrentViewModel;
- (id)loadedViewModelsForDimension:(long long)arg1;
