...
@class NSArray, NSString, SCCognacAppLeaderboardInfo, SCCognacAppShareInfo, SCCognacContentUpdateInfo, SCOperaWebAppImageResources;
...
@interface SCCognacOperaPlayerItem : NSObject
{
    ...
    SCCognacAppShareInfo *_shareInfo;
}

@property(readonly, nonatomic) SCCognacAppShareInfo *shareInfo; // @synthesize shareInfo=_shareInfo;
