...
@property(retain, nonatomic) NSMutableSet *adRequestClientIdsForAdsStartedAsUnSkippable; // @synthesize adRequestClientIdsForAdsStartedAsUnSkippable=_adRequestClientIdsForAdsStartedAsUnSkippable;
@property(retain, nonatomic) NSMutableDictionary *adRequestClientIdToMediaInfoMap; // @synthesize adRequestClientIdToMediaInfoMap=_adRequestClientIdToMediaInfoMap;
@property(retain, nonatomic) NSMutableSet *skippableAdRequestIds; // @synthesize skippableAdRequestIds=_skippableAdRequestIds;
- (void).cxx_destruct;
