...
@class GPBBoolValue, GPBInt64Value, NSMutableArray, SCAdsAdFlagData, SCAdsAdToCallImpressionTrack, SCAdsAdToLensImpressionTrack, SCAdsAdToMessageImpressionTrack, SCAdsAppInstallImpressionTrack, SCAdsCognacMetadata, SCAdsCollectionImpressionTrack, SCAdsDeepLinkImpressionTrack, SCAdsFilterCarouselImpressionTrack, SCAdsFilterImpressionTrack, SCAdsLensCarouselImpressionTrack, SCAdsLensExplorerImpressionTrack, SCAdsLensImpressionTrack, SCAdsLocalWebpageImpressionTrack, SCAdsLongformVideoImpressionTrack, SCAdsRemoteWebpageImpressionTrack, SCAdsStoryImpressionTrack, SCAdsSubscribeImpressionTrack, SCAdsThreeVImpressionTrack, SCAdsUnlockableViewImpressionTrack, SCAdsViewContext;
...
@property(retain, nonatomic) SCAdsAdToCallImpressionTrack *adToCall; // @dynamic adToCall;
@property(retain, nonatomic) SCAdsAdToLensImpressionTrack *adToLens; // @dynamic adToLens;
@property(retain, nonatomic) SCAdsAdToMessageImpressionTrack *adToMessage; // @dynamic adToMessage;
...
@property(retain, nonatomic) SCAdsLensExplorerImpressionTrack *lensExplorer; // @dynamic lensExplorer;
...
@property(retain, nonatomic) NSMutableArray *thirdPartyClickUrlsArray; // @dynamic thirdPartyClickUrlsArray;
@property(readonly, nonatomic) unsigned long long thirdPartyClickUrlsArray_Count; // @dynamic thirdPartyClickUrlsArray_Count;
@property(retain, nonatomic) NSMutableArray *thirdPartyImpressionUrlsArray; // @dynamic thirdPartyImpressionUrlsArray;
@property(readonly, nonatomic) unsigned long long thirdPartyImpressionUrlsArray_Count; // @dynamic thirdPartyImpressionUrlsArray_Count;
