...
- (void)_updateEntriesFromNetworker:(id)arg1 dataObjectContext:(id)arg2 queue:(id)arg3 logger:(id)arg4 snapsUploadInfo:(id)arg5 failureHandler:(CDUnknownBlockType)arg6 successHandler:(CDUnknownBlockType)arg7;
...
- (id)initWithEntryId:(id)arg1 deleteSnapId:(id)arg2 deleteSharedSnapForAll:(_Bool)arg3 allowSingleSnapStory:(_Bool)arg4 profile:(id)arg5 userContext:(id)arg6;
