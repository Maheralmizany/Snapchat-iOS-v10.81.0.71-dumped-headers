...
@class SCFeatureSettingsServices, SCScopeExposer, SCSystemScope, SCUserSessionScope, SCUserSessionSubScopesRouter, SCUserSessionWorkflow, SCUserStorageServices;
