...
#import "SIGTextFieldRightViewDelegate-Protocol.h"
...
@interface SIGTextField : UITextField <SIGTextFieldPillScrollViewObserver, UIScrollViewDelegate, SIGTextFieldRightViewDelegate>
{
...
- (void)rightViewModeShouldUpdateTo:(long long)arg1;
...
- (id)_rightView_direction_safe;
- (id)_leftView_direction_safe;
- (void)removePill:(id)arg1;
- (void)addPills:(id)arg1;
