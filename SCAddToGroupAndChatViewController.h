...
@class NSString, SCChatMainViewController, SCInvalidFriendAlertView, SCLazy, SCNewGroupViewController, SCSendToDocObjectRecipientDataSource, SCSendToNewGroupDataRepository, SCUserSession, UITapGestureRecognizer;
@protocol NavigationDelegate, SCActionHandling, SCStartChatDelegate, SwipeView;
