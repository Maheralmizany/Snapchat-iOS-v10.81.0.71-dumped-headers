...
@property(copy, nonatomic) NSString *initGatewayHostAndPathV1; // @dynamic initGatewayHostAndPathV1;
...
@property(copy, nonatomic) NSData *pixelToken; // @dynamic pixelToken;
@property(copy, nonatomic) NSData *sceid; // @dynamic sceid;
...
@property(nonatomic) _Bool shouldInitializePetra; // @dynamic shouldInitializePetra;
