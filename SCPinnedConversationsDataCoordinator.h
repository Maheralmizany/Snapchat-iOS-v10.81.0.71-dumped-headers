...
- (void).cxx_destruct;
- (void)_logChatConversationPinWithIdentifier:(id)arg1 isGroupConversation:(_Bool)arg2 pinRank:(long long)arg3;
...
- (void)removePinnedConversationWithId:(id)arg1 isGroupConversation:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)addPinnedConversationWithId:(id)arg1 isGroupConversation:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
