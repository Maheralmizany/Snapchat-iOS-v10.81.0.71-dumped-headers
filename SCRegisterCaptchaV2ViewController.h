...
@class NSString, SCFeatureSettingsService, SCRegisterCaptchaV2View, SCScopedAccess, SCUnauthenticatedCaptchaService, SCUnauthenticatedPhoneManager, SCUserSession;
