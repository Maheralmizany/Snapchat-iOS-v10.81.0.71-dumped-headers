...
@class NSDictionary, NSString, SCCognacSectionHeaderViewModel;
@protocol SCCollectionViewSectionSupplementaryViewProviderDelegate;

@interface SCCognacSectionHeaderSupplementaryViewProvider : NSObject <SCCollectionViewSectionSupplementaryViewProviding, SCCollectionViewSupplementaryViewModelsConfigurable>
{
    SCCognacSectionHeaderViewModel *_headerViewModel;
