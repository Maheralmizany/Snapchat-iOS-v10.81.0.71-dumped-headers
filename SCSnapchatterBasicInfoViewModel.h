...
- (id)initWithPrimaryLabelAttributedText:(id)arg1 primaryLabelTwoLineEnabled:(_Bool)arg2 secondaryLabelAttributedText:(id)arg3 tertiaryLabelAttributedText:(id)arg4 contentInsets:(struct UIEdgeInsets)arg5 primarySecondaryLabelPadding:(double)arg6 secondaryTertiaryLabelPadding:(double)arg7 badgeViewModel:(id)arg8;
