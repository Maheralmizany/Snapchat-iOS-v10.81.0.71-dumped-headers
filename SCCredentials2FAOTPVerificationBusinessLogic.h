...
- (id)viewModel;
- (void)begin;
- (id)initWithDelegate:(id)arg1 logInService:(id)arg2 usernameOrEmail:(id)arg3 smsEnabled:(_Bool)arg4 phoneNumber:(id)arg5 twoFAPreAuthToken:(id)arg6 unauthenticatedTwoFAService:(id)arg7 verificationCodeLength:(unsigned long long)arg8 transitionMomentLogger:(id)arg9 loginLogger:(id)arg10;
