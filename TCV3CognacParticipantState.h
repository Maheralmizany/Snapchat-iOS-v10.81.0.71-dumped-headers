...
+ (id)CognacParticipantStateWithPresent:(_Bool)arg1 speaking:(_Bool)arg2 publishedMedia:(long long)arg3 userId:(id)arg4;
...
- (void).cxx_destruct;
- (id)description;
- (id)initWithPresent:(_Bool)arg1 speaking:(_Bool)arg2 publishedMedia:(long long)arg3 userId:(id)arg4;
