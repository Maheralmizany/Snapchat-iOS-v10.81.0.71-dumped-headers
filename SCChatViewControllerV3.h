...
#import "SCSnapReplayControllerProvider-Protocol.h"
...
@interface SCChatViewControllerV3 : SCChatBaseViewController <SCActionMenuViewControllerDelegate, SCGroupsDataRequestListener, SCSnapReplayControllerDelegate, SCChatEraseMessageControllerDelegate, SCCommerceOperaPresenterDelegate, SCSnapchattersDataRequestListener, SCSavableItemChatTableViewCellDelegate, SCChatInputViewControllerDelegate, SCChatInputSnapParameterProvider, SCChatInputSnapAccessoryDelegate, SCChatStickerFavoritesDelegate, SCChatInputStateListener, SCChatInputTextViewListener, SCGroupProfilePageActionHandlerDelegate, SCFriendProfilePageActionHandlerDelegate, SCBitmojiAvatarBuilderRouterDelegate, SCChatTapActionHandlerDataProviding, SCChatInputMediaAccessoryDelegate, SCCaptureWorkflowResultDelegate, SCChatInputStickerAudioDelegate, SCChatAddToGroupViewPresenting, SCChatFullscreenMediaChatTableCellDelegate, SCChatCellGestureDelegate, SCSnapReplayControllerProvider, UIScrollViewDelegate, SCHeaderDelegate, SCTraceEnabled, UIGestureRecognizerDelegate, SCChatDrawerSender, SCBlockedExceptionAlertControllerDelegate, UINavigationControllerDelegate, SCChatTableViewV3PresenterDelegate, SCTPresencePillTapListener, SCActionable, SCSnapReplayViewCellDelegate, SCChatConversationUpdaterListener, SCS2RStackDebuggable, SCChatViewHeaderDataSource, SCShakeToReportDelegate, SCPageNameLogging>
{
    ...
    id <SCBloopsOnboardingController> _bloopsOnboardingController;
...
- (void)_switchToGroupChatWithGroupId:(id)arg1 deepLinkURL:(id)arg2 chatPageSource:(long long)arg3;
...
- (void)_updateFriendmojiWithLastParticipant:(id)arg1 bitmojiUsersForPicker:(id)arg2;
- (void)_updateGroupFriendmoji;
- (void)_updateOneOnOneFriendmoji;
- (void)_updateFriendmoji;
- (void)_requestGroupFriendmojiUpdateOnStickerAccessoryActivation;
- (void)_updateFriendmojiOnStickerAccessoryActivation;
...
- (void)sendBloop:(id)arg1 fromCategory:(id)arg2 fromPosition:(unsigned long long)arg3 fromFullscreen:(_Bool)arg4 fromSource:(long long)arg5 viewTimeInMilliseconds:(unsigned long long)arg6 sentBloopFeatures:(id)arg7 notSentBloopFeatures:(id)arg8;
...
- (id)_chatSendAnalyticsDataModelWithDrawerMetricInfo:(id)arg1 memoriesMetricsInfo:(id)arg2;
- (id)chatSendAnalyticsDataModelWithDefaultSetup;
...
- (void)didInitialConversationFetchFailForChatIdentifier:(id)arg1;
...
- (void)setActiveConversationById:(id)arg1 deeplinkType:(unsigned long long)arg2 conversationSource:(long long)arg3 chatViewOptions:(id)arg4;
