...
@class NSString, SCFeatureSettingsService, SCScopedAccess;
...
- (void)registerDidCreateAccountWithResponse:(id)arg1 tempIdentity:(id)arg2 directUserSession:(id)arg3;
