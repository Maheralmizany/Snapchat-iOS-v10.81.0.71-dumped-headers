...
@class NSString, SCEventListenerAnnouncer, SCUnifiedActionMenuViewController, UINavigationController, UIView, UIViewController;
@protocol SCActionHandling, SCImageDownloading, SCSwipeTransitionCoordinator, SCUnifiedActionMenuDataProvider, SCUnifiedActionMenuPresenterDelegate;
...
@interface SCUnifiedActionMenuPresenter_OLD : NSObject <SCSwipeTransitionCoordinatorDelegate, SCSwipeTransitionCoordinatorDataSource, SCUnifiedActionMenuViewControllerDelegate, SCActionMenuPresenting>
{
    ...
    id <SCSwipeTransitionCoordinator> _menuTransitionCoordinator;
