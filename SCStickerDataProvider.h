...
@class NSArray, NSMutableArray, NSString, SCEmojiSet, SCInfoStickerDataProvider, SCUserSession, User;
@protocol SCBitmojiAvatarBuilderRouterDelegate, SCStickerPickerLayoutSource, SCStickerRecommendationDataProviding;
...
@property(readonly, nonatomic) NSArray *customStickers; // @synthesize customStickers=_customStickers;
...
- (id)_bloopStickerSuperCategoryWithSuperCategory:(id)arg1;
...
- (id)_chatHometabSuperCategory:(id)arg1 stickersDataSource:(id)arg2;
- (id)_previewHometabSuperCategory:(id)arg1 stickersDataSource:(id)arg2;
- (id)_hometabSuperCategory:(id)arg1 stickersDataSource:(id)arg2;
- (void)_addStickersWithStickerManager:(id)arg1 user:(id)arg2 bloopsSuperCategory:(id)arg3 homeTabPageDataSource:(id)arg4;
- (id)updateBloopsSuperCategory:(id)arg1;
...
- (id)updateHomeTabPageDataSource:(id)arg1;
- (id)updateRecentPageDataSource:(id)arg1;
- (id)_recentsSuperCategoryWithStickersDataSource:(id)arg1;
- (id)updateHomeTabWithStickerMananger:(id)arg1 homeTabPageDataSource:(id)arg2;
...
- (id)initForChatWithUser:(id)arg1 recentPageDataSource:(id)arg2 searchPageDataSource:(id)arg3 homeTabPageDataSource:(id)arg4 shouldEnableHometab:(_Bool)arg5 recentsCategoryBackfillMax:(long long)arg6 hometabCategoryBackfillMax:(long long)arg7 isHometabHorizontalScrolling:(_Bool)arg8 bloopsSuperCategory:(id)arg9 chatStickerManager:(id)arg10 customStickers:(id)arg11 userSession:(id)arg12 bitmojiAvatarBuilderRouterDelegate:(id)arg13;
- (id)initForTarget:(long long)arg1 withUser:(id)arg2 chatStickerManager:(id)arg3 userSession:(id)arg4 infoStickerDataProvider:(id)arg5 stickerRecommendationDataProvider:(id)arg6 hideAnimatedStickers:(_Bool)arg7 bitmojiAvatarBuilderRouterDelegate:(id)arg8 bloopsSuperCategory:(id)arg9 homeTabPageDataSource:(id)arg10;
