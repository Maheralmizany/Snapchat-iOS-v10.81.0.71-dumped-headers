...
@class NSString, SCAlertTitleView, SCExperimentManager, SCLoadingIndicatorView, SCPreferences, SCScanCardButton, SCScanCardDeepLinkData, SCSessionRequestManager, UIActivityIndicatorView, UIButton, UIColor, UIImageView, UILabel, UIView;
...
- (id)initWithDeepLinkActionData:(id)arg1 scanData:(id)arg2 scannableId:(id)arg3 version:(int)arg4 requestManager:(id)arg5 experimentManager:(id)arg6 userPreferences:(id)arg7;
