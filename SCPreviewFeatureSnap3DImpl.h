...
- (_Bool)_shouldShow3DLensInSwipeFilterCarousel;
- (id)_defaultLensIdFromCurrentContext;
- (void)configureWithView:(id)arg1;
- (id)initWithConfiguration:(id)arg1 userSession:(id)arg2 lensUsageNotifier:(id)arg3 lensDataProviderFactory:(id)arg4 swipeFilters:(id)arg5 filterArranger:(id)arg6 previewLogger:(id)arg7 imageProcessLensCommandFactory:(id)arg8;
