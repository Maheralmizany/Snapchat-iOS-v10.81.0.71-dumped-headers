...
@property(retain, nonatomic) SCAdLensCarouselViewingStatus *currentAdLensCarouselViewingStatus; // @synthesize currentAdLensCarouselViewingStatus=_currentAdLensCarouselViewingStatus;
@property(retain, nonatomic) NSMutableDictionary *adIdentifierToLenCarouselMap; // @synthesize adIdentifierToLenCarouselMap=_adIdentifierToLenCarouselMap;
- (void).cxx_destruct;
- (void)invalidate;
