...
@class NSString, PKPushRegistry, SCAppDelegateWorkflow, SCStartupCaptureHardwareWarmer, UINavigationController, UIWindow;
...
- (_Bool)_synchronouslyUpdateVersionUsingSession:(id)arg1;
