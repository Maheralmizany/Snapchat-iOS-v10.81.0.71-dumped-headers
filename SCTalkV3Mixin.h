...
@class NSString, SCChatInputViewController, SCTAvatarServices, SCTV3ChatServices, SCTalkV3Manager;
@protocol SCTAudioServices, SCTV3ClientDependenciesProvider, SCTV3LensesServices, SCTalkSession;
...
- (void)setActiveTalkSessionWithConversationId:(id)arg1 conversationMetadata:(id)arg2 presenceEnabled:(_Bool)arg3;
- (id)activeConvoId;
