...
@class CAMetalLayer, FBKVOController, NSMutableSet, NSString, SCCameraHealthMonitor, SCCoreCameraOpenLogger, SCManagedCapturePreviewView, SCQueuePerformer, UIView;
