...
@class NSString, SCClearFeedTableView, SCLazy;
@protocol SCChatConversationManager, SCClearFeedViewControllerDelegate, SCNativeMessagingFeedManaging;
...
@interface SCClearFeedViewController : SCGenericSettingsViewController <SCUpdateListener, SCPageNameLogging>
{
    ...
    SCLazy *_lazyArroyoConversationIdsManager;
    id <SCNativeMessagingFeedManaging> _nativeMessagingFeedManager;
    id <SCClearFeedViewControllerDelegate> _delegate;
}
...
- (void)loadView;
- (void)dealloc;
- (id)initWithUsername:(id)arg1 friendsFeedDataCoordinator:(id)arg2 friendsFeedLoadingStatusManager:(id)arg3 conversationManager:(id)arg4 arroyoConversationIdsManager:(id)arg5 nativeMessagingFeedManager:(id)arg6 delegate:(id)arg7;
