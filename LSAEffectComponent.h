...
@class LSAAudioPlayerBridge, LSACompositeEffectManager, LSAEffectComponentListenerAnnouncer, NSMutableDictionary, NSString;
@protocol NSObject;
...
@interface LSAEffectComponent : LSABaseComponent <LSAEffectHintDelegate, LSAEffectHapticFeedbackDelegate, LSAEffectClientInterfaceDelegate, LSAEffectPersistenceDelegate, LSAEffectLifeCycleDelegate, LSAClientInterfaceProtocol, LSACompositeEffectManager>
{
    ...
    NSMutableDictionary *_applyDelayStartTime;
...
- (void)setEffectRectangles:(id)arg1 rectanglesTransform:(struct CGAffineTransform)arg2 completion:(CDUnknownBlockType)arg3;
