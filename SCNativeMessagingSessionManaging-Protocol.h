...
@class SCNMessagingConversationManager, SCNMessagingSession, SCNativeFeedManager, SCObservable;
@protocol SCArroyoConversationDataUpdateAnnouncer, SCNativeMessagingSnapManaging;

@protocol SCNativeMessagingSessionManaging
- (SCObservable *)dataWiped;
