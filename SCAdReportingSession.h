...
@class NSString, SCAdLogger, SCCompositeAdDataSource, SCNavigationController, SCOperaPlaylistItem, SCOperaViewController, SCUserSession;
@protocol SCOperaPlaylistItemController, SCSwipeTransitionCoordinator;
