...
@protocol SCCognacCypressProxy, SCTCognacSession, SCTalkManager;
...
- (void)_updateWithPresentUsers:(id)arg1;
- (void)_fetchPublicSnapchattersWithUserIds:(id)arg1 snapchatterService:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)_fetchSnapchattersMetadata:(id)arg1 localUsername:(id)arg2 conversationId:(id)arg3 isGroupConversation:(_Bool)arg4 snapchatterService:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;
...
- (CDUnknownBlockType)_getStreamStatusCypressHandler;
