...
@class NSMutableArray, NSMutableDictionary, NSString, SCCameraOverlayView, SCCameraToolbarButton, SCCameraToolbarNGSBackgroundView, SCCameraVerticalToolbarSplitter, SCDisposableObserverLifecycle, SCFeatureReference, SCFeatureSettingsService, SCLazy, SCNavigationBarButtonItem, SCUserSession, UIView;
...
@interface SCCameraVerticalToolbar : SCFeature <SCManagedCapturerListener, SCCameraToolbarButtonDelegate, SCFeatureCameraToolbar, SCCameraGestureResponder, SCCaptureWorkflowTransitionAnimatableFeature>
{
    ...
    SCLazy *_toolbarBackgroundOverlayView;
    SCLazy *_toolbarView;
    SCCameraToolbarNGSBackgroundView *_toolbarBackgroundView;
...
- (double)_toolBarViewRightMargin;
