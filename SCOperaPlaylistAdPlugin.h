...
- (id)initWithUserSession:(id)arg1 viewLocation:(long long)arg2 storySessionId:(id)arg3 cognacSessionId:(id)arg4 navigationDelegate:(id)arg5 deepLinkId:(id)arg6 appInfoLogParams:(id)arg7 groupAdDataSource:(id)arg8 pendingPromotedStory:(id)arg9 navigationStyle:(long long)arg10;
...
- (id)initWithUserSession:(id)arg1 viewLocation:(long long)arg2 storySessionId:(id)arg3 pendingPromotedStory:(id)arg4 navigationStyle:(long long)arg5;
