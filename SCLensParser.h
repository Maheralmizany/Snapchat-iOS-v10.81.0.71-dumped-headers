...
+ (_Bool)_isValidLNSAssetStorageOption:(id)arg1;
+ (id)_assetStorageOptionsWithManifestItemStorageOptions:(id)arg1 assetId:(id)arg2 assetURL:(id)arg3 assetSignature:(id)arg4;
