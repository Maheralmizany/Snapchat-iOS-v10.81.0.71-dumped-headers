...
@class NSString, SCContextOperaPlaylistPlugin, SCLazy, SCOperaInlinePrefetcherPlugin, SCOperaPlaylistPlugin, SCOperaPresenter, SCUserSession, UIViewController;
...
@interface SCSearchV2StoryPresenter : NSObject <SCOperaPresenterDelegate, SCSearchV2StoryPresenting>
{
    ...
    SCLazy *_storiesPlaybackDataProviding;
