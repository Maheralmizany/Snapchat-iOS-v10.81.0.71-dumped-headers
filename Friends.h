...
@property(copy) NSDictionary *actionProcessingDict; // @synthesize actionProcessingDict=_actionProcessingDict;
...
- (id)allSuggestedFriendsFor:(unsigned long long)arg1;
