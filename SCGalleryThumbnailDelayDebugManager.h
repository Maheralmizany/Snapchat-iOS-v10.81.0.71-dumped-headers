...
#import "SCMemoriesFeaturedStoryDataLogging-Protocol.h"
...
@interface SCGalleryThumbnailDelayDebugManager : NSObject <SCRefreshableDebugViewDelegate, SCMemoriesFeaturedStoryDataLogging>
{
    NSString *_userId;
    NSString *_username;
