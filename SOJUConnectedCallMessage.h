...
@interface SOJUConnectedCallMessage : SCSojuMessage <SOJUConnectedCallMessage>
{
}
...
@property(readonly, nonatomic) NSString *callType; // @dynamic callType;
@property(readonly, nonatomic) NSNumber *connectedTimestamp; // @dynamic connectedTimestamp;
