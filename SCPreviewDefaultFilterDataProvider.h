...
@protocol SCPreviewFeatureContextImageClassifier, SCPreviewFilterDataProviderDelegate, SCUcoDataStore, SCUnifiedCameraObjectDataFetching;
...
- (void)_didUpdateWeather;
- (void)_updateWeatherWithResponse:(id)arg1;
...
- (void)clear;
- (id)initWithSnapSource:(long long)arg1 streakCount:(long long)arg2 userSession:(id)arg3 fullScreenImageFuture:(id)arg4 mediaOrientation:(long long)arg5 filterContextData:(id)arg6;
- (id)initWithSnapSource:(long long)arg1 userSession:(id)arg2;
