...
@class NSDictionary, NSMutableDictionary, NSMutableSet, NSString, SCChatMediaReferenceManager, SCChatMediaRequestManager, SCChatMetadataStoreListenerAnnouncer, SCDataCoordinatorListenerAnnouncer, SCDisposableObserverLifecycle, SCLazy, SCPreferences, SCQueuePerformer;
...
- (void)_downloadMetadataForUrls:(id)arg1 messageId:(id)arg2 conversationId:(id)arg3 needSpamCheck:(_Bool)arg4 downloadSuccess:(CDUnknownBlockType)arg5;
...
- (void)_clearMetadataStoreForEvent:(id)arg1;
- (void)_subscribeToDataWipes:(id)arg1;
- (id)initWithUserSession:(id)arg1 mediaReferenceManager:(id)arg2 logger:(id)arg3 feedClearDataManager:(id)arg4 autoShakeToReporter:(id)arg5 dataWiped:(id)arg6 performer:(id)arg7 announcer:(id)arg8;
- (id)initWithUserSession:(id)arg1 mediaReferenceManager:(id)arg2 logger:(id)arg3 feedClearDataManager:(id)arg4 autoShakeToReporter:(id)arg5 dataWiped:(id)arg6;
