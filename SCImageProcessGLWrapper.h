...
- (void)retrieveRenderBufferPixelHeight:(int *)arg1;
- (void)retrieveRenderBufferPixelWidth:(int *)arg1;
...
- (void)deleteTextures:(const unsigned int *)arg1 size:(int)arg2;
- (void)deleteRenderbuffers:(const unsigned int *)arg1 size:(int)arg2;
- (void)deleteFramebuffers:(const unsigned int *)arg1 size:(int)arg2;
- (void)generateRenderbuffers:(unsigned int *)arg1 size:(int)arg2;
- (void)generateFramebuffers:(unsigned int *)arg1 size:(int)arg2;
