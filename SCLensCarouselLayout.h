...
@property(readonly, nonatomic) double feedButtonExtraBottomIPhoneXReplyModeOffset;
@property(readonly, nonatomic) double extraBottomOffsetNGSNoReplyNoARBar;
...
- (double)_cameraTimerVisualWidth;
- (double)_cameraTimerBorderWidth;
...
@property(readonly, nonatomic) double sponsoredSlugVerticalMargin;
