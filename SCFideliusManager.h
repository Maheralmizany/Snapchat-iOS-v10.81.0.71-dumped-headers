...
#import "SCFideliusBetaSyncDelegate-Protocol.h"
...
@class NSMutableSet, NSString, SCEllipticCurveCrypto, SCFideliusDeviceGraphManager, SCFideliusLogger, SCFideliusServiceProvider, SCFideliusUserDatabaseFetcher, SCFideliusUserDatabaseManager, SCFideliusUserIdentity, SCLazy, SCUserSession;
@protocol SCPerforming;

@interface SCFideliusManager : NSObject <SCNMessagingKeyProvider, SCFideliusDataProvider, SCUserSessionScoped, SCTraceEnabled, SCFideliusProtocol, SCFideliusBetaSyncDelegate>
{
    ...
    SCFideliusUserDatabaseFetcher *_userDatabaseFetcher;
...
- (void)resyncBetaIfNecessary:(id)arg1;
