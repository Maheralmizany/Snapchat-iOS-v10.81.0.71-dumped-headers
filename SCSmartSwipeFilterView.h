...
@class NSArray, NSMutableDictionary, NSString, SCBehaviorSubject, SCFilterCarouselLoggingParameters, SCFilterView, SCImageProcessLensCommand, SCLazy, SCObservable, SCPreviewFilterItem, SCSmartCarouselFilterArranger, SCSnapCommonLoggingParameters, SCSpectaclesRectificationConfiguration, SCUnlockableGeoFilterTracker, SCUserSession, UICollectionView, UILongPressGestureRecognizer, UIPanGestureRecognizer;
...
@interface SCSmartSwipeFilterView : UIView <SCFilterViewGenerator, SCGeoFilterViewDelegate, SCAltitudeFilterViewDelegate, SCWeatherFilterViewDelegate, SCVenueFilterViewDelegate, SCSmartSwipeFilterViewLogger, UICollectionViewDataSource, UIGestureRecognizerDelegate, UICollectionViewDelegate, SCSmartCarouselFilterArrangerDelegate, SCSmartCarouselFilterArrangerSwipeStateDataSource, SCPreviewGestureResponder>
{
    ...
    SCBehaviorSubject *_didSwipeFilterViewObservable;
    _Bool _isVideoSnap;
    _Bool _isSnap3D;
    ...
    long long _state;
    SCSpectaclesRectificationConfiguration *_rectificationConfig;
...
@property(retain, nonatomic) SCSpectaclesRectificationConfiguration *rectificationConfig; // @synthesize rectificationConfig=_rectificationConfig;
...
@property(readonly, nonatomic) SCObservable *didSwipeFilterViewObservable; // @synthesize didSwipeFilterViewObservable=_didSwipeFilterViewObservable;
...
@property(nonatomic) _Bool isInteractiveSnap; // @synthesize isInteractiveSnap=_isInteractiveSnap;
...
- (id)initWithFrame:(struct CGRect)arg1 filterArranger:(id)arg2 commonLoggingParameters:(id)arg3 geofilterLogger:(id)arg4 isLagunaMedia:(_Bool)arg5 rectificationConfig:(id)arg6 userSession:(id)arg7 imageProcessCommandProvider:(id)arg8 cropBackgroundAnimationImages:(id)arg9 cropBackgroundAnimationColors:(id)arg10 focusLocationDelegate:(id)arg11 venueFilterTooltipProvider:(id)arg12 isFromGallery:(_Bool)arg13;
...
- (long long)_fiterSwipeCameraType;
...
- (id)_ucoLogger;
- (void)_logUcoSwipeEvent:(id)arg1 atIndex:(long long)arg2 metadata:(id)arg3;
