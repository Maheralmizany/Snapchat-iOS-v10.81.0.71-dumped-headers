...
@class NSSet, NSString, SCMapBitmojiLayerController, UIView;

@protocol SCMapBitmojiLayerControllerDelegate <NSObject>
- (void)mapBitmojiLayerController:(SCMapBitmojiLayerController *)arg1 playStoryForUserId:(NSString *)arg2 baseView:(UIView *)arg3;
...
- (void)mapBitmojiLayerController:(SCMapBitmojiLayerController *)arg1 wantsToSelectUserId:(NSString *)arg2 isCluster:(_Bool)arg3;
