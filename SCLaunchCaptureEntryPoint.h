...
@interface SCLaunchCaptureEntryPoint : SCEntryPoint
{
    ...
    SCMultiScopeExposer *_captureScopeExposer;
}

@property(retain, nonatomic) SCMultiScopeExposer *captureScopeExposer; // @synthesize captureScopeExposer=_captureScopeExposer;
