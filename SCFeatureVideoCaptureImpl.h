...
@class NSString, SCAudioConfiguration, SCCoreCameraLogger, SCFrameProcessLatencyReporter, SCFuture, SCHapticsManager, SCManagedCapturerState, SCManagedVideoNoSoundLogger, SCRecordingFileManager, SCUserSession, SCVideoCaptureConfiguration, UIView;
...
- (_Bool)_shouldPreventVideoRecordingFor3DSnap;
