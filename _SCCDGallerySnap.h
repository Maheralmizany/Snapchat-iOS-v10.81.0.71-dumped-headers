...
@class NSArray, NSDate, NSNumber, NSString, SCCDGalleryEntry, SCCDGalleryProfile, SCCDGallerySnapDetail, SCCDGallerySnapID, SCCDGallerySnapMiniThumbnail, SOJUGalleryServletSensorBlob, SOJUStoryFrame;
...
@property(retain, nonatomic) NSArray *snapAssets; // @dynamic snapAssets;
...
@property(retain, nonatomic) NSArray *sojuSnapAssets; // @dynamic sojuSnapAssets;
