...
@interface SCOperaConfiguration : NSObject
{
    ...
    _Bool _fixProgressiveDownloadSpinner;
    _Bool _usePlayForProgressiveDownload;
    _Bool _useCurrentTimeToFixProgressiveDownloadSpinner;
    _Bool _loadValuesOfVideoAssetOnceFixEnabled;
    _Bool _fixProgressiveDownloadRetry;
    _Bool _swipesOnAdsInShowsPlayer;
    _Bool _tooLongInitialSeekInHLSVideoInterruptionEnabled;
    ...
    double _initialSeekInHLSVideoToleranceDurationSec;
    double _initialSeekThresholdSec;
...
@property(readonly, nonatomic) long long preferredPeakBitRate; // @synthesize preferredPeakBitRate=_preferredPeakBitRate;
...
@property(retain, nonatomic) id <SCLegacyPageViewLogger> pageViewLogger; // @synthesize pageViewLogger=_pageViewLogger;
...
@property(readonly, nonatomic) double initialSeekThresholdSec; // @synthesize initialSeekThresholdSec=_initialSeekThresholdSec;
@property(readonly, nonatomic) double initialSeekInHLSVideoToleranceDurationSec; // @synthesize initialSeekInHLSVideoToleranceDurationSec=_initialSeekInHLSVideoToleranceDurationSec;
@property(readonly, nonatomic) _Bool tooLongInitialSeekInHLSVideoInterruptionEnabled; // @synthesize tooLongInitialSeekInHLSVideoInterruptionEnabled=_tooLongInitialSeekInHLSVideoInterruptionEnabled;
@property(readonly, nonatomic) _Bool swipesOnAdsInShowsPlayer; // @synthesize swipesOnAdsInShowsPlayer=_swipesOnAdsInShowsPlayer;
...
@property(nonatomic) _Bool loadValuesOfVideoAssetOnceFixEnabled; // @synthesize loadValuesOfVideoAssetOnceFixEnabled=_loadValuesOfVideoAssetOnceFixEnabled;
@property(nonatomic) _Bool useCurrentTimeToFixProgressiveDownloadSpinner; // @synthesize useCurrentTimeToFixProgressiveDownloadSpinner=_useCurrentTimeToFixProgressiveDownloadSpinner;
@property(nonatomic) _Bool usePlayForProgressiveDownload; // @synthesize usePlayForProgressiveDownload=_usePlayForProgressiveDownload;
@property(nonatomic) _Bool fixProgressiveDownloadSpinner; // @synthesize fixProgressiveDownloadSpinner=_fixProgressiveDownloadSpinner;
