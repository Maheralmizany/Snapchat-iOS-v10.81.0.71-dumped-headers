...
@interface SCSnapKitPhoneVerifyDeepLinkProcessor : NSObject <SCDeepLinkProcessor>
{
    id <NavigationDelegate> _navigationDelegate;
}

+ (id)viewControllerForDeepLink:(id)arg1 userSession:(id)arg2;
- (void).cxx_destruct;
- (_Bool)_validateClientDeepLinkRequest:(id)arg1;
