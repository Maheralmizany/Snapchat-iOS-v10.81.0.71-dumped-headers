...
@class NSString, SCCropOverlayView, SCCroppingState, SCPreviewConfiguration, SCPreviewView, SCUserSession;
...
- (id)identityCroppingState;
- (id)createAndSetIdentityCroppingState:(struct CGSize)arg1 containerView:(id)arg2 contentScaleFactor:(double)arg3;
