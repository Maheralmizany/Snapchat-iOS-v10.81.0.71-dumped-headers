...
@class SCImpalaBusinessProfileManager, SCSendToDocObjectRecipientDataSource;
...
- (id)initWithRecipientDataSource:(id)arg1 storiesDataSource:(id)arg2 businessProfileManager:(id)arg3 selecteRecipientsConfiguration:(id)arg4;
