...
@class LSAComponentManager, NSLock, NSString, SCCaptureResource, SCLens, SCLensCorePersistentStore, SCLensEffectActivator, SCManagedCapturerState, SCManagedLensesProcessor, SCQueuePerformer;
...
@interface SCLensProcessingCore : NSObject <SCCrashedLensIdProvider, LSAEffectComponentListener, SCLensProcessingCore, SCManagedCapturerListener>
{
    ...
    SCQueuePerformer *_persistenceStorePerformer;
    SCManagedCapturerState *_managedCapturerState;
    SCLensCorePersistentStore *_lensCorePersistenceStore;
}

+ (CDUnknownBlockType)unwrappedActivatingCompletion:(CDUnknownBlockType)arg1;
@property(retain, nonatomic) SCLensCorePersistentStore *lensCorePersistenceStore; // @synthesize lensCorePersistenceStore=_lensCorePersistenceStore;
@property(retain) SCManagedCapturerState *managedCapturerState; // @synthesize managedCapturerState=_managedCapturerState;
- (void).cxx_destruct;
- (id)_persistenceDataForLensId:(id)arg1;
...
- (void)addFrameRateListener:(id)arg1;
