...
@class SCCORECompositeStoryId, SCSCOREResponseStatus, SCSSMStoryCard;
...
@property(retain, nonatomic) SCSCOREResponseStatus *responseStatus; // @dynamic responseStatus;
