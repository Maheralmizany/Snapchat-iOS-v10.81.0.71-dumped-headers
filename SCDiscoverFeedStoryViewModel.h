...
@class NSString, SCActionModel, SCDiscoverFeedDebugViewModel, SCDiscoverFeedDynamicReplayOverlayViewModel, SCDiscoverFeedLabelOverlayViewModel, SCDiscoverFeedLogoOverlayViewModel, SCDiscoverFeedPublisherStoryLabelOverlayViewModel, SCDiscoverFeedStoryLoggingInfo, SCNetworkImage, SCNetworkVideo, UIColor;
...
@property(readonly, copy, nonatomic) SCNetworkVideo *videoThumbnail; // @synthesize videoThumbnail=_videoThumbnail;
