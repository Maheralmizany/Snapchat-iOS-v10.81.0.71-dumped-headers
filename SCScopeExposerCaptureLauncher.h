...
#import "SCUserFeatureMultiLauncher.h"
...
@interface SCScopeExposerCaptureLauncher : SCUserFeatureMultiLauncher <SCCaptureWorkflowDelegate, SCCaptureLauncher>
{
}

- (void)didDismissCaptureFlow:(id)arg1;
