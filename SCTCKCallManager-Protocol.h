...
- (void)reportGhostCallAndTearDownForNotification:(SCAppNotification *)arg1 convoId:(NSString *)arg2 withCompletionHandler:(void (^)(void))arg3;
- (void)reportIncomingCallNotification:(SCAppNotification *)arg1 convoId:(NSString *)arg2 isVideo:(_Bool)arg3 shouldIncludeInRecent:(_Bool)arg4 withCompletionHandler:(void (^)(void))arg5;
@end
