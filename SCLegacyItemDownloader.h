...
- (void)_dataLoadedForKey:(id)arg1 decryptedData:(id)arg2 handler:(id)arg3 skipDedup:(_Bool)arg4;
- (void)_loadItemRemotely:(id)arg1 remoteDownloader:(id)arg2 handler:(id)arg3 skipDedup:(_Bool)arg4;
- (void)_loadItem:(id)arg1 remoteDownloader:(id)arg2 handler:(id)arg3 skipDedup:(_Bool)arg4;
...
- (void)resetCache;
- (id)loadItem:(id)arg1 itemRemoteDownloader:(id)arg2 completion:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4 callbackQueue:(id)arg5 skipDedup:(_Bool)arg6;
