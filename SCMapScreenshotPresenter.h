...
@class NSString, NSURL, PreviewViewController, SCLegacySendToUIContainer, SCMapAttributionInformation, SCOperaViewController, SCSendToTransitionProvider, SCUserFeatureLauncher, SCUserSession, UIImage, UIViewController;
