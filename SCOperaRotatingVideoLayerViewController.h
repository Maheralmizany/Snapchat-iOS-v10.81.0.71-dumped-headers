...
@class AVAsset, AVPlayerItemTrack, CADisplayLink, FBKVOController, NSError, NSNotificationCenter, NSString, NSTimer, SCAVPlayerVolumeController, SCFrameableContainerView, SCOperaRotatingLayerPinchController, SCOperaRotatingVideoLayerView, SCOperaRotatingViewTransformManipulator, SCOperaVideoStallTracker, SCStopwatch, UIGestureRecognizer, UIView, UIVisualEffectView;
