...
@class ARFrame, LSAPointAnchor, LSAPortraitEffectsMatteWrapper, LSATrackingComponent;

@protocol LSATrackingComponentDelegate <NSObject>
- (void)deleteTrackedPoint:(LSAPointAnchor *)arg1;
-     // Error parsing type: @"LSAPointAnchor"80@0:8{?=[4]}16, name: createTrackedPoint:
...
@optional
- (_Bool)trackingComponent:(LSATrackingComponent *)arg1 beginTrackingWithRequirements:(unsigned long long)arg2;
