...
@class NSMutableArray, NSMutableDictionary, NSSet, NSString, NSTimer, NSURL, NSURLRequest, SCBrowserLocationBarView, SCOperaWebView, SCSafeBrowsingWarningView, SCUserSession, UIButton, UIView, WKWebView;
...
@property(retain, nonatomic) WKWebView *textWebView; // @synthesize textWebView=_textWebView;
