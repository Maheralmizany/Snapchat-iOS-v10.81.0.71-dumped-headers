...
@class NSString, SCPreviewTooltipBalloon, SCScannableInfo, SCSnapcodeDetailMixinView, SCSnapcodeDotAnimationView, SCSnapcodeImageContainerView, SCSnapcodeShareView, SCSnapcodeWebTabCardView, SCUserSession, SCWebImageScraperClient, SVGDocumentView, UIButton, UIScrollView, UITableView, UIView;
@protocol NavigationDelegate, SCSnapcodeServicesControllerDelegate;

@interface SCSnapcodeServicesController : SCGenericSettingsViewController <UITableViewDataSource, UITableViewDelegate, SCSnapcodeTabCardViewViewDelegate, UIScrollViewDelegate, SCWebImageScraperClientDelegate, TTTAttributedLabelDelegate, SCSnapcodeDetailMixinViewDelegate, SCSnapcodeImageEditControllerDelegate, SCPageNameLogging>
{
    id <NavigationDelegate> _navigationDelegate;
    SCUserSession *_userSession;
    id <SCSnapcodeServicesControllerDelegate> _delegate;
...
- (id)getTitle;
- (void)dealloc;
- (id)initWithNavigationDelegate:(id)arg1 userSession:(id)arg2 delegate:(id)arg3;
