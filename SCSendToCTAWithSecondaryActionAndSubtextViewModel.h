...
@interface SCSendToCTAWithSecondaryActionAndSubtextViewModel : NSObject <NSCopying>
{
    NSAttributedString *_labelText;
    NSAttributedString *_labelSubtext;
    UIImage *_leftImage;
    UIImage *_rightImage;
...
@property(readonly, copy, nonatomic) NSAttributedString *labelSubtext; // @synthesize labelSubtext=_labelSubtext;
@property(readonly, copy, nonatomic) NSAttributedString *labelText; // @synthesize labelText=_labelText;
- (void).cxx_destruct;
- (_Bool)isEqual:(id)arg1;
- (unsigned long long)hash;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (id)initWithLabelText:(id)arg1 labelSubtext:(id)arg2 leftImage:(id)arg3 rightImage:(id)arg4 primaryTapActionModel:(id)arg5 secondaryTapActionModel:(id)arg6 cellHeight:(double)arg7;
