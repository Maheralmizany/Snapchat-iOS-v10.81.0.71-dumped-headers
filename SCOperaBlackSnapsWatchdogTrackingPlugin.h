...
@interface SCOperaBlackSnapsWatchdogTrackingPlugin : SCOperaPlaylistEventTrackerPlugin
{
    ...
    CDUnknownBlockType _didDetectMissingContextProperties;
}

@property(copy, nonatomic) CDUnknownBlockType didDetectMissingContextProperties; // @synthesize didDetectMissingContextProperties=_didDetectMissingContextProperties;
...
- (void)_validateContextAndTriggerAlertIfNeeded;
