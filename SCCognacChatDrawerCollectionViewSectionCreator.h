...
@class NSString, SCCognacChatDrawerCollectionViewSectionActionHandler, SCCognacChatDrawerCollectionViewSectionDataProvider, SCExperimentManager, SCPreferences;
...
- (id)initWithActionHandler:(id)arg1 dataProvider:(id)arg2 preferences:(id)arg3 sectionEventListener:(id)arg4 experimentManager:(id)arg5;
