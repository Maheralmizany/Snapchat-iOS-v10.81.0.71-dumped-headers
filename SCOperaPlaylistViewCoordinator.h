...
@interface SCOperaPlaylistViewCoordinator : NSObject <SCOperaSession, SCOperaPlaylistItemController>
{
    ...
    NSString *_itemIdWithMultipleViewsPrepared;
    NSMutableSet *_groupIdsToUpdate;
    SCOperaEventListenerAnnouncer *_eventAnnouncer;
    SCOperaPlaylistItem *_initialItemToDisplay;
    ...
    NSString *_firstViewedPlaylistItemGroupId;
    unsigned long long _lastViewedPlaylistItemGroupIndex;
...
- (long long)_indexOfLastPlaylistItemGroup;
- (long long)_indexOfFirstViewedPlaylistItemGroup;
- (long long)_lastPlaylistItemGroupIndexToBuild;
- (long long)_firstPlaylistItemGroupIndexToBuild;
...
- (id)initialPlaylistItemToDisplay;
