...
@protocol SCLensProcessingCore <SCManagedLensProcessor, SCLensEffectActivationListening, SCLensEffectActivationStateManager, SCLensProcessingCoreActivationManager>
@end
