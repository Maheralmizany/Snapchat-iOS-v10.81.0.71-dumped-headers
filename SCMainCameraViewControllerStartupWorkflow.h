...
@protocol SCCameraUserStatus, SCLegacyIdentityModuleAdapter;
...
@interface SCMainCameraViewControllerStartupWorkflow : SCCameraViewControllerStartupWorkflow
{
    ...
    id <SCLegacyIdentityModuleAdapter> _legacyIdentityModuleAdapter;
}
...
- (id)initWithUserStatus:(id)arg1 legacyIdentityModuleAdapter:(id)arg2;
