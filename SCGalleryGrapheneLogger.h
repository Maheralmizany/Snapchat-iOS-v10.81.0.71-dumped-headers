...
+ (void)firebBackgroundPrefetchDidFinishWithFetchResult:(unsigned long long)arg1 fetchedMediaCount:(long long)arg2;
+ (void)fireGallerySnapBackgroundUploadFinished;
+ (void)fireGallerySnapBackgroundUploadScheduled;
+ (void)fireGalleryOperationTotalTimeMetricWithQueueLength:(long long)arg1 durationInSec:(double)arg2 operationType:(id)arg3;
...
+ (void)fireGalleryFetchCollections:(unsigned long long)arg1;
+ (void)fireGalleryOperaFailToPresent:(id)arg1;
...
+ (void)fireGalleryExportLowDiskSpace;
...
+ (void)fireGalleryBrowseCacheHit:(_Bool)arg1 isUsingCM:(_Bool)arg2;
...
+ (void)fireGallerySaveToCamerarollCompleted;
+ (void)fireGallerySaveToCamerarollFinishTranscoding;
+ (void)fireGallerySaveToCamerarollStart;
+ (void)fireGallerySaveToCameraroll:(id)arg1;
+ (void)fireGallerySaveToMemories:(id)arg1;
