...
@class NSData, NSDate, NSString, SCULUserExperiments;
...
- (id)_scopedExperimentManager;
- (_Bool)shouldSendEncryptedUnlockablesDirectPayloadToGTQ;
- (_Bool)shouldSendSnapadsIdToGTQ;
@property(readonly, nonatomic) NSString *snapadsId;
