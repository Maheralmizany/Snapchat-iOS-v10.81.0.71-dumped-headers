...
@interface SCCognacActionsMenuQueryCoordinator : NSObject <SCSearchQueryCoordinating>
{
    _Bool _isLoading;
...
- (void).cxx_destruct;
- (id)_makeListSectionDescriptorWithIdentifier:(id)arg1;
- (id)_makeSectionExpansionModelWithIdentifier:(id)arg1;
