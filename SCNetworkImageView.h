...
- (void)_applyAndRescaleImageIfNecessary:(id)arg1 image:(id)arg2 completion:(CDUnknownBlockType)arg3 imageSetCompletion:(CDUnknownBlockType)arg4;
- (void)_setPendingImageIfPossibleWithPendingImageBlock:(CDUnknownBlockType)arg1;
- (void)_syncDisplayedImageIfNecessaryWithImageSetCompletion:(CDUnknownBlockType)arg1;
- (void)_setLoadingImage;
- (void)_setSuccessImageWithNetworkImage:(id)arg1 image:(id)arg2 imageSetCompletion:(CDUnknownBlockType)arg3;
- (void)_updateFailureWithNetworkImage:(id)arg1;
- (void)_recordConsumeContentIfNecessary:(id)arg1;
- (void)_updateSuccessWithNetworkImage:(id)arg1 image:(id)arg2 animated:(_Bool)arg3 imageSetCompletion:(id)arg4;
- (void)_handleImageLoaderFailureHandlerWithRequestedImage:(id)arg1 error:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_handleImageLoaderCompletionHandlerWithRequestedImage:(id)arg1 resultImage:(id)arg2 downloadLatency:(double)arg3 completion:(CDUnknownBlockType)arg4 isFromCache:(_Bool)arg5 imageSetCompletion:(CDUnknownBlockType)arg6;
- (void)_loadNetworkImage:(id)arg1 imageProcessingBlock:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3 imageSetCompletion:(CDUnknownBlockType)arg4;
- (void)_cancelImageDownloading;
...
- (void)setNetworkImage:(id)arg1 imageProcessingBlock:(CDUnknownBlockType)arg2 downloadCompletion:(CDUnknownBlockType)arg3 imageSetCompletion:(CDUnknownBlockType)arg4;
- (id)displayedImage;
- (void)layoutSubviews;
