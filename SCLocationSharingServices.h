...
@interface SCLocationSharingServices : NSObject
{
    ...
    SCLazy *_upsellService;
}

@property(readonly, nonatomic) SCLazy *upsellService; // @synthesize upsellService=_upsellService;
...
- (void).cxx_destruct;
- (id)initWithPreferencesMutator:(id)arg1 preferencesProvider:(id)arg2 sharingService:(id)arg3 upsellService:(id)arg4;
