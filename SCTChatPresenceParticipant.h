...
- (id)initWithUsername:(id)arg1 displayName:(id)arg2 uniqueLabel:(id)arg3 presenceColor:(id)arg4 bitmojiAvatarId:(id)arg5 pill:(id)arg6 speechActivityAnnouncer:(id)arg7 useMetalRenderer:(_Bool)arg8 rendererController:(id)arg9;
