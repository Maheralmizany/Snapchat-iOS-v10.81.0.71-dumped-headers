...
@property(readonly, nonatomic) double fadeInDelay; // @synthesize fadeInDelay=_fadeInDelay;
@property(readonly, nonatomic) _Bool fadeInEnabled; // @synthesize fadeInEnabled=_fadeInEnabled;
