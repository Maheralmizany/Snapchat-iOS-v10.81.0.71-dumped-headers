...
@protocol SCLensExplorerDependencyProviderProtocol, SCLensExplorerLensItemQueryProvider, SCLensExplorerPerformanceLogging, SCLensExplorerQueryFactoryProtocol, SCLensExplorerRouting, SCLensExplorerSectionProtocol, SCLensExplorerSectionsMediation;
...
- (id <SCLensExplorerSectionProtocol>)lensSectionWithIdentifier:(NSString *)arg1 mediator:(id <SCLensExplorerSectionsMediation>)arg2;
