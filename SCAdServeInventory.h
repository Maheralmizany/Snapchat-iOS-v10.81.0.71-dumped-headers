...
{
    _Bool _isAdPositionSensitive;
    NSArray *_adIdentifiers;
    SCAdTargetingParameters *_targetingParameters;
    NSString *_publisherSlotId;
}

@property(readonly, nonatomic) _Bool isAdPositionSensitive; // @synthesize isAdPositionSensitive=_isAdPositionSensitive;
...
- (id)initWithAdIdentifiers:(id)arg1 targetingParameters:(id)arg2 publisherSlotId:(id)arg3 isAdPositionSensitive:(_Bool)arg4;
