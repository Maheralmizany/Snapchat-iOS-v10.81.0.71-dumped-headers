...
- (void)_convertToMp4WithAsset:(id)arg1 outputURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_getAVAsset:(unsigned long long)arg1 attemptIdx:(long long)arg2 completion:(CDUnknownBlockType)arg3;
