...
@class NSString, SCUserInfoServices, SCUserSession, UILabel, UITableView;
...
- (id)getTitle;
- (id)initWithPageViewName:(id)arg1 title:(id)arg2 leftSwipeEnabled:(_Bool)arg3 userSession:(id)arg4 userInfoServices:(id)arg5;
