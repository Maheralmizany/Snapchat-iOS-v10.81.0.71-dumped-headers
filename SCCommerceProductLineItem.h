...
@class NSNumber, NSString, SCCommerceBitmojiLineItemInfo, SCCommerceCurrency, SCCompositeNetworkImageModel;
...
@interface SCCommerceProductLineItem : NSObject <NSCopying>
{
    ...
    SCCommerceBitmojiLineItemInfo *_bitmojiProductInfo;
    NSString *_unlockableUrl;
}

@property(readonly, copy, nonatomic) NSString *unlockableUrl; // @synthesize unlockableUrl=_unlockableUrl;
@property(readonly, copy, nonatomic) SCCommerceBitmojiLineItemInfo *bitmojiProductInfo; // @synthesize bitmojiProductInfo=_bitmojiProductInfo;
...
- (id)initWithProductId:(id)arg1 variantId:(id)arg2 quantity:(id)arg3 title:(id)arg4 unitPrice:(id)arg5 linePrice:(id)arg6 strikethroughUnitPrice:(id)arg7 strikethroughLinePrice:(id)arg8 type:(id)arg9 thumbnailImageModel:(id)arg10 taxable:(_Bool)arg11 requiresShipping:(_Bool)arg12 bitmojiProductInfo:(id)arg13 unlockableUrl:(id)arg14;
