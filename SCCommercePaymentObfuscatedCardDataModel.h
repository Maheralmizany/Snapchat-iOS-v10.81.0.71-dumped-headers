...
- (id)initWithIdentifier:(id)arg1 billingAddress:(id)arg2 lastFourDigits:(id)arg3 expiryMonth:(id)arg4 expiryYear:(id)arg5 brandname:(id)arg6 isAuthorized:(_Bool)arg7;
