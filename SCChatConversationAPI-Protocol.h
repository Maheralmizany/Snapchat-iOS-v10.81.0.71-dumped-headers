...
- (SCRequest *)updateCognacNotificationStatus:(_Bool)arg1 conversationId:(NSString *)arg2 isGroup:(_Bool)arg3 successBlock:(void (^)(NSHTTPURLResponse *, id))arg4 failureBlock:(void (^)(NSHTTPURLResponse *, NSError *))arg5 callbackQueue:(NSObject<OS_dispatch_queue> *)arg6;
