...
@property(readonly, nonatomic) NSDate *persistedTimestamp; // @synthesize persistedTimestamp=_persistedTimestamp;
...
- (id)initWithGroups:(id)arg1 selfUsername:(id)arg2 persistedTimestamp:(id)arg3;
