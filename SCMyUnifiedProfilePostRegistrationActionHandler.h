...
@class NSString, SCContactSyncWorkFlow, SCFeatureSettingsService, SCMyUnifiedProfilePostRegistrationStateManager, SCOpenUrlOperaViewPresenter, SCSendToDocObjectRecipientDataSource, SCSendToNewGroupDataRepository, SCSendToOpenMiniProfileActionHandler, SCUserSession, UIViewController;
