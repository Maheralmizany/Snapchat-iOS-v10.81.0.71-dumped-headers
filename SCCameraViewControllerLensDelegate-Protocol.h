...
@class NSSet, NSString, SCCameraLensesUIController, SCLens, SCLensUIUpdateListenerAnnouncer, SCLensesUIAppearanceConfiguration, SCLensesUIControllerState, SCLongPressGestureRecognizer, SCManagedCapturerState, UIGestureRecognizer, UITapGestureRecognizer, UIView, UIViewController;
@protocol LSASnapRecordingComponentListener, SCCameraLensesUIControlling, SCLensCameraScreenDataProviderProtocol, SCLensCameraUpdatingStrategy, SCLensProcessingCore;
...
- (UIViewController *)cameraRootViewController;
...
- (SCLensUIUpdateListenerAnnouncer *)lensesUIUpdateAnnouncer;
- (SCCameraLensesUIController *)lensesUIController;
- (id <SCCameraLensesUIControlling>)cameraLensesUIController;
...
- (id <SCLensCameraScreenDataProviderProtocol>)createLensDataProvider;
