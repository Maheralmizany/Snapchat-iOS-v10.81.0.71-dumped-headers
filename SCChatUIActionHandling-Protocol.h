...
@class NSSet, NSString, SCChatMessageOperationDataModel, SCPlatformAnalyticsDataModel;

@protocol SCChatUIActionHandling
- (void)retryFailedMessageInConversationId:(NSString *)arg1 messageId:(NSString *)arg2 analyticsDataModel:(SCPlatformAnalyticsDataModel *)arg3;
