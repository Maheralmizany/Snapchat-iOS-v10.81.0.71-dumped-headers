...
- (id)initWithSnapchattersDataFetcher:(id)arg1 snapchattersDataMutator:(id)arg2 snapchattersDataTracker:(id)arg3 userInfoProvider:(id)arg4 storyPrivacySettingManager:(id)arg5 imageDownloader:(id)arg6 discoverFeedEventsAnnouncer:(id)arg7 userSession:(id)arg8;
