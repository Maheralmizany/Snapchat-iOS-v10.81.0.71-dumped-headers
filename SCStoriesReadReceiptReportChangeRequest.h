...
- (id)initWithRowid:(long long)arg1 receiptId:(id)arg2 flushableStorySnapId:(id)arg3 storySnapServerId:(id)arg4 state:(long long)arg5 viewedTimestamp:(double)arg6 viewedAction:(long long)arg7 isPublic:(_Bool)arg8 isOfficial:(_Bool)arg9 isFriend:(_Bool)arg10 expirationDate:(double)arg11 isSubscribed:(_Bool)arg12;
