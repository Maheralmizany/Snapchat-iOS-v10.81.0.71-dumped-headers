...
@interface SCMockMetalDevice : NSObject <MTLDevice>
{
    ...
    unsigned long long _sparseTileSizeInBytes;
    CDStruct_da2e99ad _maxThreadsPerThreadgroup;
}

@property(readonly) unsigned long long sparseTileSizeInBytes; // @synthesize sparseTileSizeInBytes=_sparseTileSizeInBytes;
@property(readonly) _Bool hasUnifiedMemory; // @synthesize hasUnifiedMemory=_hasUnifiedMemory;
