...
@protocol SOJUAdLocalWebpageImpressionTrack <SCSojuMessage>
...
@property(readonly, nonatomic) NSNumber *pageCurrentOffset;
@property(readonly, nonatomic) NSNumber *pageHeightSeen;
@property(readonly, nonatomic) NSNumber *pageHeight;
