...
@protocol SCKeyValuePersisting, SCMediaDataPackageManaging, SCSendFlowLogging, SCUploadMediaDataManaging;
...
- (void)_createPackageAndStartOrchestrationWithWithId:(id)arg1 mediaData:(id)arg2 overlayData:(id)arg3 encryptionKey:(id)arg4 encryptionIv:(id)arg5;
...
- (void)_initialLoadSessionInfoStore;
- (id)initWithPerformer:(id)arg1 keyValueStore:(id)arg2 mediaDataPackageManaging:(id)arg3 uploadMediaDataManaging:(id)arg4 sendFlowLogger:(id)arg5 grapheneLazy:(id)arg6;
