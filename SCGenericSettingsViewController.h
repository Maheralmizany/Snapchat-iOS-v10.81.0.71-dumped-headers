...
@interface SCGenericSettingsViewController : SCLeftSwipableViewController <SCHeaderDataSource, SCHeaderDelegate>
{
    ...
    id <SCSettingsDelegate> _settingsDelegate;
}
...
@property(nonatomic) __weak id <SCSettingsDelegate> settingsDelegate; // @synthesize settingsDelegate=_settingsDelegate;
