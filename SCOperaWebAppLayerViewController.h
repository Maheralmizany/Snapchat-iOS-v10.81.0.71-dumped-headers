...
@class NSString, SCOperaWebAppConversationViewController, SCOperaWebAppInteractionViewController, SCOperaWebAppLayerView;
@protocol SCOperaWebAppPresenceFrameProvider;

@interface SCOperaWebAppLayerViewController : SCOperaLayerViewController <WKNavigationDelegate, WKUIDelegate, SCOperaWebAppLayerViewDelegate, SCOperaWebAppPresenceFrameProvider>
{
...
- (void)initializeWebViewWithLayer:(id)arg1;
