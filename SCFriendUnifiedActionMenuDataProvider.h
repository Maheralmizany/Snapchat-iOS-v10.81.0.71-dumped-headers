...
@class NSString, SCFeatureSettingsService, SCFriendUnifiedProfileDataSource, SCUnifiedProfileOpenFriendActionMenuActionData;
...
- (id)initWithUnifiedProfileOpenFriendActionData:(id)arg1 featureSettingsService:(id)arg2 dataSource:(id)arg3;
