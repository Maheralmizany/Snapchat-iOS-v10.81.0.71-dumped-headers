...
@class NSLayoutConstraint, NSMutableDictionary, NSString, SIGLoadingIndicatorView, UIBarButtonItem, UITableView, UIView;
...
{
    SIGLoadingIndicatorView *_progressIndicator;
...
@property(readonly) UIView *topBar; // @synthesize topBar=_topBar;
@property(readonly) UITableView *tableView; // @synthesize tableView=_tableView;
@property(readonly) id <SCLensDiscoveryUIProviderProtocol> uiProvider; // @synthesize uiProvider=_uiProvider;
@property(readonly) id <SCLensDiscoveryDataProvider> dataProvider; // @synthesize dataProvider=_dataProvider;
- (void).cxx_destruct;
