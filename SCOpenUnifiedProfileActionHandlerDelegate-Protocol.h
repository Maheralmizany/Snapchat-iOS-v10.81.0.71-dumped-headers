...
- (void)openUnifiedProfileActionHandler:(SCOpenUnifiedProfileActionHandler *)arg1 navigateToChatWithUsername:(NSString *)arg2 userId:(NSString *)arg3 deepLinkURL:(SCDeepLinkURL *)arg4;
