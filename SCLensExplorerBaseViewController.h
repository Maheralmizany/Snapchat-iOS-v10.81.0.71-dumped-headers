...
@interface SCLensExplorerBaseViewController : UIViewController <SCScrollToEndDetectorDelegate, SCSearchQueryResultControllerDelegate, UICollectionViewDelegate, SCShakeToReportDelegate>
{
