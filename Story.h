...
@class IMPBusinessProfile, NSArray, NSDate, NSDictionary, NSError, NSMutableArray, NSNumber, NSString, NSURL, SCAdToLens, SCEncryptedCache, SCImageToVideoWriter, SCImpalaHighlightStoryInfo, SCImpalaStoryPlaybackInfo, SCMapStoryInfo, SCSearchStoryInfo, SCSearchStreamingLoggingInfo, SCSearchStreamingMediaInfo, SCSnapActionsConfiguration, SCSnapVideoFilterState, SCStoryMediaStateListenerAnnouncer, SOJUAudioStitch, SOJUBroadcastAttribution, SOJUStoryFrame;
...
@property _Bool shouldPostStoryAfterMediaUploaded; // @synthesize shouldPostStoryAfterMediaUploaded=_shouldPostStoryAfterMediaUploaded;
...
@property _Bool isPetraBrandSafe; // @synthesize isPetraBrandSafe=_isPetraBrandSafe;
...
- (_Bool)_shouldLetPostMasterUploadMedia;
