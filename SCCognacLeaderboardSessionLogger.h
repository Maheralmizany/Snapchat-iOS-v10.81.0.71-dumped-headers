...
- (id)initWithCognacEventLoggingController:(id)arg1 appDataModel:(id)arg2 leaderboard:(id)arg3 cognacSessionId:(id)arg4 leaderboardSourceType:(long long)arg5 appType:(unsigned long long)arg6;
