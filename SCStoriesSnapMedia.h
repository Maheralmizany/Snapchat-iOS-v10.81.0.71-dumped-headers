...
@class NSString, SCStoriesBoltContentObjects;
...
- (id)initWithId:(id)arg1 key:(id)arg2 iv:(id)arg3 type:(long long)arg4 needsAuth:(_Bool)arg5 appUrl:(id)arg6 directToStorageUrl:(id)arg7 isZipped:(_Bool)arg8 boltContentObjects:(id)arg9;
