...
@class NSArray, NSString, SCFriendmojiDataCoordinator, SCFriendmojiService, SCUserSession;

@interface SCFriendmojiFeatureManager : NSObject
{
    SCFriendmojiService *_friendmojiService;
    SCFriendmojiDataCoordinator *_friendmojiDataCoordinator;
...
- (id)initWithFriendmojiService:(id)arg1 friendmojiDataCoordinator:(id)arg2 userSession:(id)arg3;
