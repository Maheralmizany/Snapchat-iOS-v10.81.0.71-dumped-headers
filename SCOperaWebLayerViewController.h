...
@class NSMutableArray, NSMutableDictionary, NSString, SCOperaInlineVideo, SCOperaInlineVideoTransitioningDelegate, SCOperaRemoteVideoViewProvider, UILongPressGestureRecognizer, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
...
- (_Bool)shouldDisableTransitioningDelegate;
