...
@class SCNNetworkApiNetworkApi, SCNativeRetryABConfigProvider;
...
@interface SCNetworkApiRouter : NSObject
{
    ...
    _Bool _isNativeNMEnabled;
    SCNativeRetryABConfigProvider *_retryConfigProvider;
...
- (void).cxx_destruct;
- (id)generateRetryConfig:(id)arg1;
...
- (id)uploadInMemoryDataProviderFromRequest:(id)arg1;
