...
#import "SCTAudioRouteMenuPresenterDelegate-Protocol.h"
...
@class NSString, SCTAudioRouteMenuPresenter, SCTCallButtons, SCTCallCard, SCTLocalMediaView, SCTV3CameraManager, SCTV3ExpandedLocalMediaController, SCTV3LocalPreview, SCTV3WaveformView, TCV3CallingManager, UITapGestureRecognizer, UIView;
@protocol SCTAudioManager, SCTCallingControllerDelegate, SCTFullscreenStateProvider, SCTIdentityServices, SCTV3ChatServices, SCTV3LensesServices, SCTV3TooltipServices, SCTalkUIController;

@interface SCTCallingController : NSObject <SCTActiveCallCardDelegate, SCTAudioRouteMenuPresenterDelegate, SCTLocalMediaViewDelegate, SCTV3ExpandedLocalMediaControllerDelegate, SCTV3LensesServicesListener, SCTCallingController, SCTV3CallPromptsAnimationsProvider, SCTPhoneCallListener, SCTFullscreenCallingServices>
{
    NSString *_convoId;
    ...
    SCTAudioRouteMenuPresenter *_audioRouteMenuPresenter;
...
- (id)_callCardModeWithCallingState:(long long)arg1 publishingMedia:(_Bool)arg2 shouldDisplayMessage:(_Bool)arg3;
...
- (void)flipCamera;
- (void)audioRoutingButtonPressed:(id)arg1;
...
- (void)_showOrHideAudioRouteOptionsMenu:(id)arg1;
- (void)menuDismissedWithSelectedRoute:(id)arg1;
- (_Bool)isFullscreen;
...
- (id)initWithConvoId:(id)arg1 delegate:(id)arg2 talkUIContoller:(id)arg3 callingManager:(id)arg4 cameraManager:(id)arg5 audioManager:(id)arg6 identityServices:(id)arg7 callButtons:(id)arg8 audioRoutingEnabled:(_Bool)arg9 dependencies:(id)arg10;
