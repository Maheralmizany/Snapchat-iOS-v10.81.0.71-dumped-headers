...
@property(readonly, nonatomic) float timerSec; // @synthesize timerSec=_timerSec;
...
- (id)initWithMediaContentType:(long long)arg1 mediaId:(id)arg2 mediaKey:(id)arg3 mediaIv:(id)arg4 thumbnailUrl:(id)arg5 miniThumbnailData:(id)arg6 isCustomSticker:(_Bool)arg7 lensMetadata:(id)arg8 timerSec:(float)arg9;
