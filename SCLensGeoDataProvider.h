...
- (void)updateGeoDataAsyncWithWeatherService;
- (id)getWeatherData;
- (void)_updateWeatherDataWithLocation:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)_startUpdatingWeatherDataWithCompletion:(CDUnknownBlockType)arg1;
