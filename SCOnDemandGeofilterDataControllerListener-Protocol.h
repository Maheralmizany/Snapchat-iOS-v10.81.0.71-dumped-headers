...
@class NSArray, NSString, SCOnDemandGeofilterDataController, SOJUUnlockablesOndemandAssetDraftList, SOJUUnlockablesOndemandAuthorizationFailure, SOJUUnlockablesOndemandInputValidationErrors, SOJUUnlockablesOndemandLineItem, SOJUUnlockablesOndemandOfferedInventory, SOJUUnlockablesOndemandPreRenderingAssetsStructuredResponse, SOJUUnlockablesOndemandStylizedTextList, SOJUUnlockablesOndemandTemplateCategoryList, SOJUUnlockablesOndemandUser;
