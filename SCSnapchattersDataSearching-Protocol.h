...
- (NSArray *)searchedSnapchatterForUserIds:(NSArray *)arg1;
- (void)searchRemoteSnapchattersWithQueryText:(NSString *)arg1 completionQueue:(NSObject<OS_dispatch_queue> *)arg2 completionHandler:(void (^)(NSArray *, NSError *))arg3;
