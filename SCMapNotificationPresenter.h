...
@interface SCMapNotificationPresenter : NSObject <SCMapNotificationPresenting>
{
    ...
    id <SCAppNotificationProviding> _notificationProvider;
}
...
- (id)initWithBitmojiAvatarProvider:(id)arg1 bitmojiImageFetcher:(id)arg2 notificationManager:(id)arg3 notificationProvider:(id)arg4;
