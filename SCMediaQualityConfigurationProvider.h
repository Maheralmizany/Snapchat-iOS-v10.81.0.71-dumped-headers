...
@interface SCMediaQualityConfigurationProvider : NSObject
{
...
- (void).cxx_destruct;
- (id)_burstCaptureDeblurConfigurationKey;
- (void)getBurstCaptureDeblurConfiguration:(CDUnknownBlockType)arg1;
