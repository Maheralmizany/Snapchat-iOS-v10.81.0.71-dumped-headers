...
@class NSArray, NSSet, NSString, SCMemoriesSelectionSnap, UILongPressGestureRecognizer, UIView, UIViewController;
@protocol SCGalleryEntry, SCGalleryItem, SCGalleryTabController, SCPageNameLogging;

@protocol SCGalleryTabControllerDelegate <NSObject>
- (void)tabController:(id <SCGalleryTabController>)arg1 didTapEditStory:(id <SCGalleryEntry>)arg2 fromView:(UIView *)arg3;
...
- (void)tabController:(id <SCGalleryTabController>)arg1 didChangeSelected:(_Bool)arg2 forGallerySnapItem:(SCMemoriesSelectionSnap *)arg3;
...
- (_Bool)tabControllerIsPresentingOpera:(id <SCGalleryTabController>)arg1;
- (void)tabController:(id <SCGalleryTabController>)arg1 browseSelected:(long long)arg2 initialSnapId:(NSString *)arg3 items:(NSArray *)arg4 fromView:(UIView *)arg5;

@optional
- (void)tabControllerDidTapOverSelectionLimit:(id <SCGalleryTabController>)arg1 dialogBody:(NSString *)arg2;
@end
