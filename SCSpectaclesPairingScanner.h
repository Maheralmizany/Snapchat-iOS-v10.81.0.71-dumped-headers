...
@class CBPeripheral, NSArray, NSMutableDictionary, NSMutableSet, NSString, SCSpectaclesCBCentralManager, SCSpectaclesPairingCandidateCode;
@protocol SCPerforming, SCSpectaclesPairingScannerDelegate, SCSpectaclesTweaksConfigProvider;
