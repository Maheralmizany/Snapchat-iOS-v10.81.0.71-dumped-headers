...
@class NSDictionary, NSString, SCAdLogger, SCCompositeAdDataSource, SCDiscoverShareController, SCOperaPlaylistItem, SCOperaViewController, SCUserSession;
...
- (void)_prepareSharingWithContext:(id)arg1 params:(id)arg2;
...
- (id)initWithUserSession:(id)arg1 adDataSource:(id)arg2 viewLocation:(long long)arg3 adBlizzardLogger:(id)arg4;
