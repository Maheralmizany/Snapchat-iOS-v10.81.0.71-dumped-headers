...
@property(readonly, nonatomic) int snapsViewed;
...
@property(readonly, nonatomic) _Bool seenInCarousel;
...
@property(readonly, copy, nonatomic) NSDate *latestSnapCaptureTimeUtc;
