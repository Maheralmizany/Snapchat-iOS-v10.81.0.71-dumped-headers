...
@class NSString, SCExperimentManager, SCFeatureSettingsService, SCLazy, SCUserSession, UICollectionView;
...
- (id)initWithUserSession:(id)arg1 parentView:(id)arg2 friendStoriesDataCoordinator:(id)arg3 experimentManager:(id)arg4;
