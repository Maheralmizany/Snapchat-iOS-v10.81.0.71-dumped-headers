...
@class NSString, SCEventListenerAnnouncer, SCFeatureSettingsService, SCGroupUnifiedActionMenuSettingsActionHandler, SCGroupUnifiedProfileDataSource, SCUnifiedActionMenuPresenter, SCUnifiedProfileLoggingService;
