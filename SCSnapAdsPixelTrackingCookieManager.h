...
@protocol SCSnapAdsConfigAdapter, SCSnapAdsNetworkUserAgentAdapter, SCSnapAdsOperationMetricsAdapter;
...
- (void)_requestPixelCookieWithPixelToken:(id)arg1;
- (void)updatePixelCookieIfNecessaryWithPixelToken:(id)arg1;
- (id)initWithNetworkManager:(id)arg1 userAgentAdapter:(id)arg2 configAdapter:(id)arg3 metricsManager:(id)arg4;
