...
@class CALayer, NSArray, NSString, NSTimer, SCEffectViewportFragment, SCGrowingButton, SCLongPressAnimationView, SCLongPressGestureRecognizer, SCLongPressParticleAnimationView, SCNavigationBarButtonItem, SCNavigationItemView, SCPreviewTooltipBalloon, UILabel, UIPanGestureRecognizer, UIPinchGestureRecognizer, UISwipeGestureRecognizer, UITapGestureRecognizer;
@protocol SCCameraOverlayDelegate><UIGestureRecognizerDelegate, SCCameraOverlayDelegateWithLensDelegate><UIGestureRecognizerDelegate, SCCameraTimer, SCFeatureCameraToolbar;
...
@interface SCCameraOverlayView : UIView <SCTraceEnabled, SCLensUserInterfaceDelegate, SCFeatureContainerView, SCLensGestureViewProvider>
{
    ...
    _Bool _forceEnableCameraTimerBottomOffset;
...
- (void).cxx_destruct;
- (void)presentLensController:(id)arg1 animated:(_Bool)arg2;
...
- (void)didAnimateDismissalTransition;
- (void)willAnimateDismissalTransition;
...
- (id)cameraTimerCopy;
- (void)enableAccessibilityForCameraTimer;
