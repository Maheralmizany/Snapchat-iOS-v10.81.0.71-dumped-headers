...
@class NSString, SCCaptionState, SCQuickCaptionManager, SCUserSession, UIView;
...
@interface SCFeatureCaptionImpl : SCFeature <SCChatQuickCaptionDelegate, SCFeatureCaption, SCCameraGestureResponder>
{
    ...
    SCQuickCaptionManager *_captionManager;
...
@property(retain, nonatomic) SCQuickCaptionManager *captionManager; // @synthesize captionManager=_captionManager;
