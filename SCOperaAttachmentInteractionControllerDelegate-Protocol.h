...
- (void)attachmentInteractionControllerDidDismissAttachment:(SCOperaAttachmentInteractionController *)arg1 swipeDirection:(long long)arg2;
- (_Bool)attachmentInteractionController:(SCOperaAttachmentInteractionController *)arg1 shouldBeginWithSwipeDirection:(long long)arg2 gestureRecognizer:(UIGestureRecognizer *)arg3;
@end
