...
- (id)initWithParentView:(id)arg1 lensContainer:(id)arg2 lensLogger:(id)arg3 presetsComponent:(id)arg4 presetImageProvider:(id)arg5 externalImageComponent:(id)arg6 photoFaceImageProvider:(id)arg7 additionalMargins:(struct UIEdgeInsets)arg8 lensCrashLogger:(id)arg9;
