...
- (id)initWithReceiptId:(id)arg1 flushableStorySnapId:(id)arg2 storySnapServerId:(id)arg3 state:(long long)arg4 viewedTimestamp:(double)arg5 viewedAction:(long long)arg6 isPublic:(_Bool)arg7 isOfficial:(_Bool)arg8 isFriend:(_Bool)arg9 expirationDate:(double)arg10 isSubscribed:(_Bool)arg11;
