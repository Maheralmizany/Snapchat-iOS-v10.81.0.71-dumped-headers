...
- (void)removeCountDownTimerForAllSnapsInConvo:(id)arg1 enforceMessageExists:(_Bool)arg2;
- (void)removeCountDownTimerForSnap:(id)arg1 conversationId:(id)arg2 enforceMessageExists:(_Bool)arg3;
