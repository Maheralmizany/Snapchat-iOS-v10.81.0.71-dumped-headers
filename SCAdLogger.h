...
@class ASIdentifierManager, NSString, SCSnapchatPetraEligibilityEvaluator;
...
- (void)_logStoryAdSkip:(id)arg1;
- (void)_logAdStorySkip:(id)arg1 params:(id)arg2 isPetraEligible:(_Bool)arg3;
- (void)_logAdStorySkip:(id)arg1;
- (void)logAdSkip:(id)arg1;
...
- (void)_logStoryAdView:(id)arg1 params:(id)arg2 isPetraEligible:(_Bool)arg3;
...
- (id)initWithPetraEligibilityEvaluator:(id)arg1;
