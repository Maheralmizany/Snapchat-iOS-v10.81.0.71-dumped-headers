...
@class NSError, NSString, SCQueuePerformer;
...
@interface SCManagedVideoNoSoundLogger : NSObject
{
    ...
    id <SCIncidentTicketCreator> _ticketCreator;
...
@property(retain, nonatomic) id <SCIncidentTicketCreator> ticketCreator; // @synthesize ticketCreator=_ticketCreator;
...
- (void)_reportNoAudioIfNeeded:(id)arg1;
