...
@protocol SCLensIconInMemoryCache, SCLensUsageTrackerProtocol, SCPerforming;
...
- (id)initWithLogger:(id)arg1 lensUsageTracker:(id)arg2 performer:(id)arg3 lensIconInMemoryCache:(id)arg4;
