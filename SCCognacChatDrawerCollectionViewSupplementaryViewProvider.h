...
@class NSDictionary, NSString, SCCognacAppListSectionHeaderView, SCCognacAppListSectionHeaderViewModel, SCExperimentManager, SCPreferences, SCQueuePerformer;
...
- (id)initWithHeaderViewModel:(id)arg1 preferences:(id)arg2 experimentManager:(id)arg3;
