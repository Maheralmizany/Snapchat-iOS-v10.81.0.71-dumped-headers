...
#import "SCClearConversationsDelegate-Protocol.h"
...
#import "SCShazamSettingsDelegate-Protocol.h"
#import "SCSnapcodeSettingsDelegate-Protocol.h"
#import "SCStoryPrivacySettingsDelegate-Protocol.h"
#import "SCVoiceScanSettingsDelegate-Protocol.h"
#import "UINavigationControllerDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class FBKVOController, NSArray, NSString, SCCommerceOperaPresenter, SCDisposableObserver, SCDisposableObserverLifecycle, SCHeader, SCLazy, SCOptionalScopeExposer, SCReauthenticationManager, SCScopeExposer, SCSearchHistoryRequestService, SCSettingHeaderPromptView, SCUserInfoServices, SCUserSession, UILabel, UILongPressGestureRecognizer, UITableView, UIVisualEffectView;
@protocol NavigationDelegate, SCCanceling, SCSettingsUserActionDelegate, SCStartChatDelegate, SCUserSessionWorkflowDelegate;

@interface SettingsViewController : SCLeftSwipableViewController <SCHeaderDataSource, SCHeaderDelegate, UINavigationControllerDelegate, SCShareUsernameControllerDelegate, SCSettingHeaderPromptViewDelegate, SCScanResultViewControllerDelegate, SCCommerceOperaPresenterDelegate, SCBloopsAPIListener, SCFriendBloopsPolicySettingsViewControllerDelegate, SCShazamSettingsDelegate, SCSnapcodeSettingsDelegate, SCVoiceScanSettingsDelegate, SCClearConversationsDelegate, SCStoryPrivacySettingsDelegate, UITableViewDataSource, UITableViewDelegate, SCPageNameLogging>
{
    ...
    SCDisposableObserver *_isEmailVerifiedObserver;
    long long _exitType;
    ...
    SCDisposableObserverLifecycle *_lifecycleForPrivacy;
...
- (void).cxx_destruct;
- (void)snapcodeSettingsScopeDidDismiss:(id)arg1;
- (void)snapcodeSettingsScopeWantsDismiss:(id)arg1;
- (void)clearConversationsScopeDidDismiss:(id)arg1;
- (void)clearConversationsScopeWantsDismiss:(id)arg1;
...
- (void)voiceScanSettingsScopeDidDismiss:(id)arg1;
- (void)voiceScanSettingsScopeWantsDismiss:(id)arg1;
...
- (void)storyPrivacySettingsScopeDidDismiss:(id)arg1;
- (void)storyPrivacySettingsScopeWillDismiss:(id)arg1;
- (void)shazamSettingsScopeDidDismiss:(id)arg1;
- (void)shazamSettingsScopeWantsDismiss:(id)arg1;
...
- (_Bool)_hasDisplayNameSettingsError;
- (_Bool)_hasMobileSettingsError;
- (_Bool)_hasEmailSettingsError;
...
- (void)_observeQuickAddPrivacyChange;
- (void)addPrivacyObservers;
- (void)_emailInfoChange:(id)arg1;
...
- (void)initHeader;
- (void)loadView;
- (id)initWithUserSession:(id)arg1 userSessionDelegate:(id)arg2 userInfoServices:(id)arg3 friendmojiService:(id)arg4 userActionDelegate:(id)arg5 navigationDelegate:(id)arg6 startChatDelegate:(id)arg7 locationSharingPreferences:(id)arg8 clearConversationsScopeExposer:(id)arg9 shazamSettingsScopeExposer:(id)arg10 snapchattersDataFetcher:(id)arg11 snapchattersDataMutator:(id)arg12 snapchattersDataTracker:(id)arg13 blockedSnapchatterFetcher:(id)arg14 snapcodeSettingsScopeExposer:(id)arg15 snapProProfileIdProvider:(id)arg16 bloopsAPI:(id)arg17 shakeToReportPresenter:(id)arg18 bloopsTargetService:(id)arg19 friendBloopsPolicyTitleProvider:(id)arg20 oneTapLoginLogger:(id)arg21 changeLanguageInSettingsActionRecorder:(id)arg22 voiceScanSettingsScopeExposer:(id)arg23 storyPrivacySettingsScopeExposer:(id)arg24;
- (id)pageViewName;
