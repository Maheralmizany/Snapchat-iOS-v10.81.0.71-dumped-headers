...
@class CLLocation, EphemeralMediaDelegateAnnouncer, Media, NSArray, NSData, NSDate, NSMutableDictionary, NSString, NSURL, SCCameraDeepLinkMetadata, SCContextContextHint, SCMEAddCheckinRequest, SCR2StorySnapClientMetadata, SCSnapCommonLoggingParameters, SCSnapVideoFilterState, SOJUMultiSnapMetadata, SnapVideoFilter;
...
- (id)initWithClientId;
- (void)setStoryInviteWithPublicationId:(id)arg1 inviteId:(id)arg2 storyName:(id)arg3;
- (void)_populateTappableElements:(id)arg1 fromStickersState:(id)arg2;
- (void)setTappableElementsFromStickerContainer:(id)arg1 captionFeature:(id)arg2 userSession:(id)arg3;
