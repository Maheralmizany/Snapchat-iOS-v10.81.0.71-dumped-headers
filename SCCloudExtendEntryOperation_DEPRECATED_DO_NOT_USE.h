...
- (void)_updateEntriesFromNetworker:(id)arg1 dataObjectContext:(id)arg2 queue:(id)arg3 snapsUploadInfo:(id)arg4 failureHandler:(CDUnknownBlockType)arg5 successHandler:(CDUnknownBlockType)arg6;
