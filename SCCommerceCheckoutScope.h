...
@protocol SCCommerceCheckoutDelegate, SCCommerceEventLogger, SCUIContainer;
...
@property(readonly, nonatomic) __weak id <SCCommerceEventLogger> eventLogger; // @synthesize eventLogger=_eventLogger;
...
- (void).cxx_destruct;
- (id)initWithStore:(id)arg1 uiContainer:(id)arg2 eventLogger:(id)arg3 delegate:(id)arg4;
