...
- (void)processDataFetcherResponseForResource:(id)arg1 contentPath:(id)arg2 resourceType:(long long)arg3 cached:(_Bool)arg4 cacheKey:(id)arg5 downloadSize:(unsigned long long)arg6 inputSettings:(id)arg7 error:(id)arg8;
