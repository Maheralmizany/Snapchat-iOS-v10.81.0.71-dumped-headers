...
#import "SCMemoriesStoryEditorDelegate-Protocol.h"
...
@class NSArray, NSString, SCGalleryOperaPresenter, SCGallerySelectionController, SCGalleryTabBarsController, SCGalleryTabsCollectionView, SCGalleryTabsConfiguration, SCGalleryTabsTableIndexController, SCScopeExposer, SCUserSession, UIView, UIViewController;
@protocol SCGalleryEntry, SCGallerySnap, SCGalleryTabController, SCGalleryTabsControllerDelegate, SCMemoriesActionMenuHelping, SCPageNameLogging, SCStartChatDelegate;

@interface SCGalleryTabsController : NSObject <UICollectionViewDataSource, UICollectionViewDelegate, SCGalleryTabBarsControllerDelegate, SCCloudSyncStatusListener, SCGalleryPrivateGalleryManagerListener, SCTraceEnabled, SCGalleryOperaPresenterDelegate, SCMemoriesActionMenuHelperDelegate, SCMemoriesStoryEditorDelegate, UINavigationControllerDelegate, UIViewControllerTransitioningDelegate, SCGalleryTabControllerDelegate>
{
    ...
    id <SCGalleryEntry> _lastSeenEntry;
    id <SCGallerySnap> _lastSeenSnap;
    id <SCMemoriesActionMenuHelping> _featuredStoryActionMenuHelper;
    double _cameraRollInitialLoadLatency;
    SCScopeExposer *_storyEditorScopeExposer;
    UIView *_storyEditorSourceView;
    _Bool _visible;
    _Bool _selectMode;
    _Bool _focused;
...
- (id)_updateFeaturedStoriesCarouselForOperaPresenter:(id)arg1 collectionView:(id)arg2 indexPath:(id)arg3 entry:(id)arg4;
- (id)operaPresenter:(id)arg1 didOpenViewWithItem:(id)arg2 snap:(id)arg3;
- (id)_operaPresenterWithItems:(id)arg1 selectedIndex:(long long)arg2 initialSnapId:(id)arg3 fromView:(id)arg4;
- (void)memoriesActionMenuHelperDidTapAttributionTitle:(id)arg1 attributionURL:(id)arg2;
...
- (void)memoriesActionMenuHelperIsSavingFeaturedStory:(id)arg1 item:(id)arg2;
- (void)storyEditorDidSaveFeaturedStory;
- (void)storyEditorWillDimiss;
- (void)_presentStoryEditorForEntry:(id)arg1;
...
- (void)tabControllerDidTapOverSelectionLimit:(id)arg1 dialogBody:(id)arg2;
...
- (void)dealloc;
- (id)initWithUserSession:(id)arg1 containerViewController:(id)arg2 configuration:(id)arg3 storyEditorScopeExposer:(id)arg4 spectaclesOnboardingScopeExposer:(id)arg5 spectaclesServices:(id)arg6;
