...
@interface SCWebBrowserV11Toolbar : UIView
{
    ...
    double _buttonContainerMinBottomMargin;
...
@property(nonatomic) double buttonContainerMinBottomMargin; // @synthesize buttonContainerMinBottomMargin=_buttonContainerMinBottomMargin;
...
- (id)initWithDelegate:(id)arg1 buttonContainerMargins:(struct UIEdgeInsets)arg2;
