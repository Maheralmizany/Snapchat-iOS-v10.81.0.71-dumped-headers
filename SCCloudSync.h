...
@class NSError, NSMutableDictionary, NSString, SCCloudFS, SCCloudSyncOperation, SCCloudSyncRetry, SCCloudSyncStatusListenerAnnouncer, SCDataObjectContext, SCExperimentManager, SCFeatureSettingsService, SCQueuePerformer, SCSentinel;
@protocol SCCloudSyncDataVault, SCCloudSyncLogger, SCCloudSyncSearchIndexer, SCGalleryProfile, SCMemoriesCloudSyncDataSource, SCNetworker, SCObserving;
...
@interface SCCloudSync : NSObject <SCService, SCUserSessionScoped>
{
    ...
    struct mutex _featureSettingsServiceMutex;
    CDUnknownBlockType _featureSettingsServiceBlock;
    SCFeatureSettingsService *_featureSettingsServiceLoaded;
    ...
    id <SCMemoriesCloudSyncDataSource> _galleryDataSourceLoaded;
