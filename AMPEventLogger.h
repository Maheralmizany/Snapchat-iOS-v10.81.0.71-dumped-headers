...
@interface AMPEventLogger : NSObject <AMPUploaderDelegate>
{
    ...
    unsigned long long _maxSequenceIdFromPreviousSession;
}

@property(readonly, nonatomic) unsigned long long maxSequenceIdFromPreviousSession; // @synthesize maxSequenceIdFromPreviousSession=_maxSequenceIdFromPreviousSession;
