...
- (id)initWithStoryId:(id)arg1 requestId:(id)arg2 storyKey:(unsigned long long)arg3 index:(unsigned long long)arg4 pageTypeSpecific:(id)arg5 sectionType:(id)arg6 itemType:(id)arg7 sectionIndex:(unsigned long long)arg8 roleType:(long long)arg9;
