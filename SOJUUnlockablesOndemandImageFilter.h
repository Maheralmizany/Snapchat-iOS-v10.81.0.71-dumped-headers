...
@interface SOJUUnlockablesOndemandImageFilter : SCSojuMessage <SOJUUnlockablesOndemandImageFilter>
{
}
...
@property(readonly, nonatomic) NSString *format; // @dynamic format;
