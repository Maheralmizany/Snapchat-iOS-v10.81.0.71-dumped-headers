...
@property(retain, nonatomic) NSMutableArray *snapAssetsArray; // @dynamic snapAssetsArray;
@property(readonly, nonatomic) unsigned long long snapAssetsArray_Count; // @dynamic snapAssetsArray_Count;
