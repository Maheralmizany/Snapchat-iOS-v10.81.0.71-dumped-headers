...
@class AVAssetWriter, AVAssetWriterInput, FBKVOController, NSString, NSURL, SCImageProcessAssetWriterInputPixelBufferAdaptor, SCQueuePerformer, SCVideoEncoderOutputSettings;
...
@interface SCVideoEncoder : NSObject <SCTraceEnabled>
{
    ...
    NSObject<OS_dispatch_semaphore> *_assetWriterSemaphore;
}

- (void).cxx_destruct;
- (void)_cleanupForEncoding;
...
- (void)dealloc;
- (id)initWithPerformer:(id)arg1 outputURL:(id)arg2 settings:(id)arg3 delegate:(id)arg4;
