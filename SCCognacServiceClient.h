...
- (void)launchAppInstanceWithAppId:(id)arg1 conversationId:(id)arg2 sharedId:(id)arg3 privacy:(int)arg4 completionQueue:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;
- (void)getAppWithAppId:(id)arg1 source:(int)arg2 completionQueue:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (void)getDeviceClassWithCompletionQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (void)listSearchAppsWithCompletionQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (void)listDestinationAppsWithCompletionQueue:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
