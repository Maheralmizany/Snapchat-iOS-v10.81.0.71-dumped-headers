...
- (id)createArroyoBackwardsCompatVolatileMessageForConversationId:(id)arg1 sender:(id)arg2 recipients:(id)arg3 talkCorePayload:(id)arg4 time:(id)arg5;
...
- (id)updateMessage:(id)arg1 withAuth:(id)arg2;
