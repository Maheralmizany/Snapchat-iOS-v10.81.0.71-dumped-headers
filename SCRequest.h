...
@class NSDictionary, NSString, NSURLSessionTask, SCAPIRequestInfo, SCAPIURLSession, SCDisplayContext, SCNNetworkTypesRequestResponseInfo, SCRequestInfoContainer, SCRequestSchedulingStateListenerAnnouncer, SCRequestTrackingInfo;
...
@interface SCRequest : NSObject
{
    ...
    double _enqueueTime;
    SCNNetworkTypesRequestResponseInfo *_urlRequestResponseInfo;
...
+ (unsigned long long)getDefaultRetryAttempts:(long long)arg1;
...
@property(retain, nonatomic) SCNNetworkTypesRequestResponseInfo *urlRequestResponseInfo; // @synthesize urlRequestResponseInfo=_urlRequestResponseInfo;
