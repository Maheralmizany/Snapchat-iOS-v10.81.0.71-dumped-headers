...
@class NSString, SCGeoFilterURLDataFetcher;

@interface SCSpectaclesLensInfoSectionController : IGListBindingSectionController <IGListBindingSectionControllerDataSource>
{
    SCGeoFilterURLDataFetcher *_dataFetcher;
}
