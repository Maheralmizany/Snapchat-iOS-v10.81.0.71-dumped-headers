...
@interface SCManagedVideoCapturer : NSObject <SCCapturerBufferedVideoWriterDelegate, SCAudioCaptureSessionDelegate, SCManagedVideoCapturerTimeObserverDelegate, SCManagedVideoDataSourceListener, SCManagedAudioDataSource>
{
    ...
    _Bool _frameDidDropDueToOutOfBuffers;
    // Error parsing type: Ai, name: _numberOfCopiedFrame
    struct OpaqueCMMemoryPool *_pixelBufferMemoryPool;
    _Bool _audioQueueStarted;
    _Bool _frameCopyEnabled;
    NSURL *_outputURL;
    id <SCManagedVideoCapturerDelegate> _delegate;
    long long _maxNumberOfFrameCopy;
    unsigned long long _status;
    CDStruct_1b6d18a9 _firstWrittenAudioBufferDelay;
}

@property unsigned long long status; // @synthesize status=_status;
@property(nonatomic) long long maxNumberOfFrameCopy; // @synthesize maxNumberOfFrameCopy=_maxNumberOfFrameCopy;
@property(nonatomic) _Bool frameCopyEnabled; // @synthesize frameCopyEnabled=_frameCopyEnabled;
...
- (struct opaqueCMSampleBuffer *)_copyOrRetainSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 isFrameCopied:(_Bool *)arg2;
...
- (void)_cleanupPixelBufferMemoryPool;
- (void)_cleanup;
