...
@property(readonly, nonatomic) _Bool isSuggestedFriend; // @synthesize isSuggestedFriend=_isSuggestedFriend;
...
- (id)initWithAvatarViewModel:(id)arg1 individualUsername:(id)arg2 displayName:(id)arg3 recipientId:(id)arg4 isSelected:(_Bool)arg5 isMyStory:(_Bool)arg6 isGroup:(_Bool)arg7 isSuggestedFriend:(_Bool)arg8;
