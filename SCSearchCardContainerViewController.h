...
@interface SCSearchCardContainerViewController : UIViewController <SCSearchCardContainerContentViewControllerContextDelegate, UIGestureRecognizerDelegate, SCTraceEnabled, UIScrollViewDelegate, SwipeView, SCCardStyling, SCNavigationBarActionHandler>
{
