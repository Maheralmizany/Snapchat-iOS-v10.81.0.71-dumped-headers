...
@class NSArray, NSString, SCLens, SCLensAnalyticsDataStore, SCLensFpsLogger, SCLensInitLogger, SCLensLaunchData, SCLensThumbnailLogger, SCSnapCommonLoggingParameters;
@protocol SCLensReadyLoggerProtocol, SCSnappableLensLogger, SCUnlockableLensTracking;
