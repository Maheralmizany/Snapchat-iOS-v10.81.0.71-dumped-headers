...
@property(readonly, nonatomic) SCFeature<SCFeatureScanCards> *scanCards;
...
@property(readonly, nonatomic) SCFeature<SCFeatureLensesTooltip> *lensesTooltip;
...
@property(readonly, nonatomic) SCFeature<SCFeatureAppAttachment> *gameAttachment;
...
@property(readonly, nonatomic) SCFeature *exposureDeadline;
...
@property(readonly, nonatomic) SCFeature<SCFeatureBurstCaptureDeblur> *burstCaptureDeblur;
...
@property(readonly, nonatomic) SCUserSessionContext *userSessionContext;
