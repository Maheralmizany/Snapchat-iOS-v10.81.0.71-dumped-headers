...
@class NSMutableSet, SCChatConversationManager, SCChatMediaRequestManager, SCChatV3ConversationStore, SCChatV3MediaPrefetcher, SCChatV3MessageReceiver, SCConversationPrefetchReader, SCExperimentManager, SCLazy, SCUserSession;
...
- (void)_conversation:(id)arg1 processNotification:(id)arg2 message:(id)arg3 groupVersion:(id)arg4 prefetchedConversationIds:(id)arg5 systemCompletion:(id)arg6;
