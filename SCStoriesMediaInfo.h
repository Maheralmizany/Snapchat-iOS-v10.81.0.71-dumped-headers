...
@class NSDate, NSString, SCMediaEncryptionInfo, SCStoriesBoltContentInfo;
...
- (id)initWithCacheKey:(id)arg1 mediaId:(id)arg2 encryptionInfo:(id)arg3 type:(long long)arg4 isZipped:(_Bool)arg5 needsAuth:(_Bool)arg6 appUrl:(id)arg7 directToStorageUrl:(id)arg8 expirationDate:(id)arg9 boltContentInfo:(id)arg10 isEligibleForStreaming:(_Bool)arg11 storyType:(unsigned long long)arg12;
