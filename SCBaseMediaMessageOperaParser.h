...
+ (id)_pageChromePropertiesForMessage:(id)arg1 sender:(id)arg2 senderDisplayName:(id)arg3 timestamp:(id)arg4;
...
+ (id)_basePagePropertiesForChatMediaContent:(id)arg1 mediaMetadata:(id)arg2 message:(id)arg3 shouldAutoAdvance:(_Bool)arg4 totalTimeLeft:(id)arg5 totalDuration:(id)arg6 timerShape:(id)arg7 secondsPlayed:(id)arg8 retryInProgress:(_Bool)arg9 controlsEnabled:(_Bool)arg10 thumbnailOptional:(_Bool)arg11;
+ (id)viewModelForSnapOperaContent:(id)arg1 totalTimeLeft:(id)arg2 totalDuration:(id)arg3 timerShape:(id)arg4 secondsPlayed:(id)arg5 retryInProgress:(_Bool)arg6 message:(id)arg7 senderDisplayName:(id)arg8 userSession:(id)arg9;
+ (id)viewModelForStorySnapMediaContent:(id)arg1 posterStoryId:(id)arg2 storySnapIsPublic:(_Bool)arg3 operaPageId:(id)arg4 message:(id)arg5;
