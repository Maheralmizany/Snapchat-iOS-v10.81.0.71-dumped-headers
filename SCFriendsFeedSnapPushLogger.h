...
@class NSString, SCFeatureSettingsService, SCLazy, SCNetworkConnectivityAnnouncer, SCQueuePerformer;
...
- (id)initWithGraphene:(id)arg1 docObjectContext:(id)arg2 featureSettingsService:(id)arg3 networkStatusAnnouncer:(id)arg4;
