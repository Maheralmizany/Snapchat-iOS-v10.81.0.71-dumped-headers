...
@property(retain, nonatomic) NSString *urlOpened; // @synthesize urlOpened=_urlOpened;
...
- (void)cameraCardTableViewCellDidOpenUrl:(id)arg1 url:(id)arg2;
...
- (void)_dismissCardsAnimated:(_Bool)arg1 additionalAnimations:(CDUnknownBlockType)arg2 duration:(double)arg3 dismissType:(unsigned long long)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_positionCardsBelowBottom;
- (void)_didPerformPanGesture:(id)arg1;
- (void)_cardDidRemoveWillAnimateChanges;
- (void)_dismissCardsWithDismissType:(unsigned long long)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
