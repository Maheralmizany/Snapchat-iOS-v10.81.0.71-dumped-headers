...
- (void)fetchContactsWithContactSource:(long long)arg1 shouldRecommend:(_Bool)arg2 isAllUpdate:(_Bool)arg3 isDelta:(_Bool)arg4 contactDataRequest:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)unmuteFriendStory:(id)arg1 updateRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)muteFriendStory:(id)arg1 updateRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)unblockSnapchatter:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)blockSnapchatter:(id)arg1 blockReasonId:(id)arg2 updateRequest:(id)arg3 completionQueue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)ignoreIncomingFriend:(id)arg1 updateRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)deleteFriend:(id)arg1 deleteSource:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)multiAddWithAddFriendRequests:(id)arg1 placement:(long long)arg2 isRegistration:(_Bool)arg3 completionQueue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)addFriend:(id)arg1 addSource:(long long)arg2 placement:(long long)arg3 cellIndex:(long long)arg4 updateRequest:(id)arg5 completionQueue:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
...
- (void)updateSyncEnable:(_Bool)arg1 contactDataRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)hideSuggestedSnapchatter:(id)arg1 placement:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)fetchSuggestion:(_Bool)arg1 syncVersion:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)fetchFriendsWithSource:(unsigned long long)arg1 triggerType:(long long)arg2 fetchRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;
