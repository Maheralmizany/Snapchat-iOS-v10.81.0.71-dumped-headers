...
@class NSArray, NSString, SCBloopsSearchResult, SCChatStickerFuzzySearchListenerAnnouncer, SCStickerCaptionRecommendationRanker, SCStickerTagFuzzySearch, SCUserSession;
