...
@class SCAddFriendsBadgedButton;

@interface SCLegacyAddFriendsButtonMutator : NSObject <SCAddFriendsButtonBadgeCountMutating, SCAddFriendsButtonBadgeTipsTrigger>
{
...
- (id)initWithAddFriendsBadgedButton:(id)arg1;
