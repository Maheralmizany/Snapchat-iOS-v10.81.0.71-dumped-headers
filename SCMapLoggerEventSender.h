...
- (void)shareLocationPromptClosedWithAction:(long long)arg1 sharingSetting:(long long)arg2 mapBestFriendBitmojiDisplayCount:(unsigned long long)arg3 mapBestFriendCount:(unsigned long long)arg4 mapFriendCount:(unsigned long long)arg5 promptType:(long long)arg6 viewTime:(double)arg7;
- (void)shareLocationPromptOpenedWithSharingSetting:(long long)arg1 mapBestFriendCount:(unsigned long long)arg2 mapFriendCount:(unsigned long long)arg3 promptType:(long long)arg4;
- (void)mapTapToPlayLatencyWithSource:(long long)arg1 sourcePage:(id)arg2 latencyMs:(unsigned long long)arg3 mapOpenState:(long long)arg4;
- (void)mapFriendLoadWithSource:(long long)arg1 sourcePage:(id)arg2 latencyMs:(unsigned long long)arg3 mapOpenState:(long long)arg4;
- (void)mapReadyWithSource:(long long)arg1 sourcePage:(id)arg2 type:(long long)arg3 latencyMs:(unsigned long long)arg4 mapOpenState:(long long)arg5;
...
- (void)skippableLocationPromptShownWithAccepted:(_Bool)arg1 source:(long long)arg2 type:(long long)arg3;
...
- (void)buttonTappedWithType:(long long)arg1 badgeState:(long long)arg2;
