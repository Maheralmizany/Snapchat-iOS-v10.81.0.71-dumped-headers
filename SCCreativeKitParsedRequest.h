...
@class NSData, NSString, SCACreativeKitSnapMetadata, SCCreativeKitLensState, SCSnapKitCameraViewState, SCSnapKitCaption, SCStickerState;
...
@property(retain, nonatomic) SCCreativeKitLensState *lensState; // @synthesize lensState=_lensState;
