...
+ (id)createWithAllDependencies:(id)arg1 rankedMediaVariantsProvider:(id)arg2 metricsProcessor:(id)arg3 blizzardLogger:(id)arg4 emitContentResolve:(_Bool)arg5;
