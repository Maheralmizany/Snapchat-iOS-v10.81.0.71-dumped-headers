...
@class NSString, NSTimer, SCCountryCodePickerView, SCLoadingScreen, SCPhoneNumberDefaultFormatter, SCPhoneNumberPlaceholderTextField, SCUserInfoServices, SCUserSession, SCVerificationCodeTextField, TTTAttributedLabel, UIButton, UILabel, UIScrollView, UISwitch, UITextField, UIView, UIWindow;
...
- (_Bool)_hasTentativeNumber;
- (id)_formattedMobile;
- (id)_getTentativeCountryCode;
- (id)_formattedTentativeNumber;
...
- (void)_verifyNumberSucceeded:(id)arg1;
- (void)_verifyNumberFailedWithGeneralError;
- (void)_verifyNumberFailedWithConnectionFailedOrMissingTentativePhoneNumber:(id)arg1;
- (void)_verifyNumberFailedWithReauthenticationRequired;
- (void)registerNumberDidSucceed;
- (void)registerNumberTentativeDidSucced;
...
- (id)pageViewName;
- (id)initForType:(long long)arg1 userSession:(id)arg2 userInfoServices:(id)arg3;
- (id)initWithUserSession:(id)arg1 userInfoServices:(id)arg2;
