...
@class NSCache, NSDate, NSDictionary, NSString, SCExperimentManager, SCFriendsFeedSnapReplayAnimationStateManager, SCFriendsFeedSubstituteAnimationStateManager, SCFriendsFeedTooltipManager, SCGroupInviteStore, SCLazy, SCQueuePerformer, SCScopedAccess, SCStoriesReplayManager;
...
- (id)initWithPerformer:(id)arg1 currentUsername:(id)arg2 currentUserId:(id)arg3 currentUserBirthday:(id)arg4 storiesReplayManager:(id)arg5 substituteAnimationStateManager:(id)arg6 friendmojiPresenter:(id)arg7 replayAnimationStateManager:(id)arg8 experimentManager:(id)arg9 arroyoConversationIdsManager:(id)arg10 groupInvitesStore:(id)arg11 tooltipManager:(id)arg12 conversationManager:(id)arg13;
