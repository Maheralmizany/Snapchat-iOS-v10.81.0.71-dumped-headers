...
@interface SCQueuePerformer : NSObject <SCPerforming>
{
    ...
    _Bool _useInheritedPriority;
    _Bool _requireFixQos;
    _Bool _requireDefaultPriority;
    _Bool _requireUserInitiatedPriority;
    _Bool _requireNonThrottledQueue;
    _Bool _skipG2S;
    _Bool _expectedQoSAssertionEnabled;
    unsigned int _expectedQoS;
}
...
+ (id)impalaPerformer;
@property(readonly, nonatomic) unsigned int expectedQoS; // @synthesize expectedQoS=_expectedQoS;
@property(readonly, nonatomic) _Bool expectedQoSAssertionEnabled; // @synthesize expectedQoSAssertionEnabled=_expectedQoSAssertionEnabled;
- (void).cxx_destruct;
- (_Bool)_shouldInheritQoS;
- (void)_performBlock:(CDUnknownBlockType)arg1;
- (void)_setNewQueueWithFixedQoS:(unsigned int)arg1;
- (void)assertQoS:(unsigned int)arg1;
- (id)queue;
...
- (void)performWithEnforcedBlockQoS:(CDUnknownBlockType)arg1;
- (void)performWithEnforcedInheritedQoS:(CDUnknownBlockType)arg1;
