...
@class GPBInt32ObjectDictionary, NSMutableArray, NSString;
...
@property(retain, nonatomic) GPBInt32ObjectDictionary *scoredPublisherScc; // @dynamic scoredPublisherScc;
@property(readonly, nonatomic) unsigned long long scoredPublisherScc_Count; // @dynamic scoredPublisherScc_Count;
