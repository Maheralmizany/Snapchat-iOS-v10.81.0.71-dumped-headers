...
@class SCHeaderStatusView, SCSenderLineView, UILabel, UIView;
...
@property(retain, nonatomic) SCSenderLineView *senderLine; // @synthesize senderLine=_senderLine;
