...
@class SCMessagingDiscoverShare, SCMessagingGameScoreShare, SCMessagingLegacyDiscoverShare, SCMessagingLegacyShazamShare, SCMessagingMapShare, SCMessagingMapShareStory, SCMessagingMemoriesStory, SCMessagingSearchShare, SCMessagingSearchShareSnap, SCMessagingShazamShare, SCMessagingSnapProProfileShare, SCMessagingSnapProSnapShare, SCMessagingStoryShare, SCMessagingUserShare;
...
@property(retain, nonatomic) SCMessagingGameScoreShare *gameScore; // @dynamic gameScore;
...
@property(retain, nonatomic) SCMessagingSnapProProfileShare *snapProProfile; // @dynamic snapProProfile;
@property(retain, nonatomic) SCMessagingSnapProSnapShare *snapProSnap; // @dynamic snapProSnap;
