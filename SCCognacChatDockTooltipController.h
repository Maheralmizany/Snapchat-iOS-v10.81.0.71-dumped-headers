...
@class NSString, SCCognacBlizzardEventLoggingController, SCCognacChatDockAppView, SCFeatureSettingsService, SCLazy;
...
- (void)clear;
- (id)initWithTargetView:(id)arg1 featureSettingsService:(id)arg2 eventLoggingController:(id)arg3;
