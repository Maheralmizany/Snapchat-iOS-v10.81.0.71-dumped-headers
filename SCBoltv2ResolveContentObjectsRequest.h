...
@class NSMutableArray, SCBoltv2Circumstance;

@interface SCBoltv2ResolveContentObjectsRequest : GPBMessage
{
}
...
@property(retain, nonatomic) SCBoltv2Circumstance *circumstance; // @dynamic circumstance;
