...
- (void).cxx_destruct;
- (void)_createLoggersWithPageTypeSpecific:(id)arg1;
...
- (void)logShortImpressions:(id)arg1 streamIdentifier:(id)arg2;
- (void)logLongImpressions:(id)arg1 streamIdentifier:(id)arg2;
