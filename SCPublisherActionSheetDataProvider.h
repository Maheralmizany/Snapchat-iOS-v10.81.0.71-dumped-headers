...
@class NSString, SCDiscoverFeedActionSheetNotificationStatusManager, SCDiscoverFeedSubscribeStatusManager, SCExperimentManager, SCPremiumPublisher, SCPublisherShowMetadata;
...
@interface SCPublisherActionSheetDataProvider : NSObject <SCEventListener, SCUnifiedActionMenuDataProvider>
{
    ...
    _Bool _isHappeningNowNewsStory;
