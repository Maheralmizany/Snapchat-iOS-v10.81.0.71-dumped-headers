...
@interface SOJUSnapstreakMetadata : SCSojuMessage <SOJUSnapstreakMetadata>
{
}
...
@property(readonly, nonatomic) NSNumber *snapstreakExpiryTime; // @dynamic snapstreakExpiryTime;
