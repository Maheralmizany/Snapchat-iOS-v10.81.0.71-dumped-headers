...
@class AVAsset, AVAudioMix, AVMutableComposition, AVMutableCompositionTrack, AVPlayer, AVPlayerItem, AVPlayerItemVideoOutput, CADisplayLink, FBKVOController, NSArray, NSDictionary, NSString, SCImageProcessCommand, SCImageProcessQueue, SCImageProcessVideoPlaybackRequest, SCImageProcessVideoPlaybackSessionListenerAnnouncer;
@protocol OS_dispatch_semaphore, SCImageProcessFrameSkipProviding, SCImageProcessPipelineOutputRendering, SCImageProcessVideoPlaybackLogging;
...
@interface SCImageProcessVideoPlaybackSession : NSObject <AVPlayerItemOutputPullDelegate, SCAudioSessionListener>
{
    ...
    long long _failedToReadFrameCount;
    id <SCImageProcessVideoPlaybackLogging> _videoPlaybackLogger;
...
- (void)prepareToPlay;
- (void)dealloc;
- (id)initWithQueue:(id)arg1 player:(id)arg2 asset:(id)arg3 layer:(id)arg4 orientation:(long long)arg5 outputCommands:(id)arg6 midOutputCommands:(id)arg7 useHighFrameRate:(_Bool)arg8 isPlaybackBufferMonitoringEnabled:(_Bool)arg9 useSeparateAudioPlayer:(_Bool)arg10 videoInfoForLogging:(id)arg11 videoPlaybackLogger:(id)arg12;
