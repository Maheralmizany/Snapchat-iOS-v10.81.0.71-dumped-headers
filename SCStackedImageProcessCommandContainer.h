...
- (id)initWithStackedCommands:(id)arg1 stackedCommandPosition:(unsigned long long)arg2 leftSwipedCommand:(id)arg3 rightSwipedCommand:(id)arg4 dualCommandSwipingOffset:(float)arg5 viewPortTransform:(struct CGAffineTransform)arg6;
- (id)initWithStackedCommands:(id)arg1 leftSwipedCommands:(id)arg2 rightSwipedCommands:(id)arg3 dualCommandSwipingOffset:(float)arg4 viewPortTransform:(struct CGAffineTransform)arg5;
