...
@class NSDictionary, NSSet, NSString, SCExperimentManager, SCMapBitmojiSticker, SCXBitmojiLayerModelProviderListenerAnnouncer;
...
@interface SCMapBitmojiLayerController : NSObject <SCMapPersonLocationsListener, SCMapPersonLocationStringsListener, SCMapStatusViewedStateListener, SCMapPeopleFriendsListener, SCXBitmojiLayerInteractionDelegate, SCXBitmojiLayerModelProvider>
{
    ...
    _Bool _ignoreFriendLocationChanges;
    _Bool _showsCallouts;
    _Bool _showingGhostModeAvatarForCurrentUser;
    _Bool _showingProps;
    _Bool _currentUserHidden;
...
@property(nonatomic) _Bool currentUserHidden; // @synthesize currentUserHidden=_currentUserHidden;
...
@property(readonly, nonatomic) _Bool showsCallouts; // @synthesize showsCallouts=_showsCallouts;
...
@property(nonatomic) _Bool ignoreFriendLocationChanges; // @synthesize ignoreFriendLocationChanges=_ignoreFriendLocationChanges;
- (void).cxx_destruct;
...
- (id)_thumbnailInfoForUserId:(id)arg1;
- (void)_updateModelsWithDuration:(double)arg1;
- (void)updateThumbnailInfoForUserIds:(id)arg1;
...
- (void)setSelectedUserId:(id)arg1 selectionStyle:(long long)arg2 showsCallouts:(_Bool)arg3 duration:(double)arg4;
- (void)setSelectedUserId:(id)arg1 selectionStyle:(long long)arg2 showsCallouts:(_Bool)arg3 animated:(_Bool)arg4;
...
- (void)bitmojiLayer:(id)arg1 wantsToPlayStoryForUserId:(id)arg2 baseView:(id)arg3;
...
- (id)initWithClustersProvider:(id)arg1 delegate:(id)arg2 peopleFriendsProvider:(id)arg3 statusViewedStateProvider:(id)arg4 stringsProvider:(id)arg5 userId:(id)arg6 experimentManager:(id)arg7;
