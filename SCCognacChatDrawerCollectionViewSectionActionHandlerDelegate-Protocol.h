...
@class NSString, SCCognacAppShareInfo, SCCognacChatDrawerCollectionViewSectionActionHandler;
...
- (void)cognacChatDrawerCollectionViewSectionActionHandler:(SCCognacChatDrawerCollectionViewSectionActionHandler *)arg1 didLaunchAppInstanceSucceedWithAppId:(NSString *)arg2 conversationId:(NSString *)arg3 context:(unsigned long long)arg4 shareInfo:(SCCognacAppShareInfo *)arg5;
@end
