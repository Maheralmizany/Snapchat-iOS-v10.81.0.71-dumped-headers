...
@class NSArray, NSString, SCCFSOAuthParamsRequestCoordinator, SCSnapKitLogger, SCUserSession, SIGLoadingIndicatorView;
@protocol SCOAuth2ApprovalViewControllerDelegate;
...
@interface SCOAuth2ApprovalViewController : UIViewController <SCOAuth2ContentViewDelegate>
{
    ...
    id <SCOAuth2ApprovalViewControllerDelegate> _delegate;
}

@property(nonatomic) __weak id <SCOAuth2ApprovalViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)_goToOAuth2ClientAppOrDismissWithRedirectUrl:(id)arg1 authCode:(id)arg2 state:(id)arg3 isSuccess:(_Bool)arg4;
- (void)_dismissViewControllerWithDelegation;
- (void)_sendScanToAuthDataToRedirectUrl:(id)arg1 success:(CDUnknownBlockType)arg2;
