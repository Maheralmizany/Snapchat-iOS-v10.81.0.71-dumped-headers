...
@class NSDate, NSString, SCChatLoggerPlatformAnalyticsStore, SCScopedAccess;
...
@interface SCChatLogger : NSObject <SCChatLogger, SCCPSessionLogger, SCEventListener>
{
    ...
    SCChatLoggerPlatformAnalyticsStore *_analyticsStore;
    NSString *_drawerSessionId;
    NSDate *_drawerFirstOpenDate;
}
...
+ (void)logDrawerTabLatencyOnStickerPickerMenuSourceType:(unsigned long long)arg1 sourceTab:(long long)arg2 stickerPickerTabSection:(long long)arg3 timeToFirstAsset:(double)arg4 avgTimeToRenderVisibleAssets:(double)arg5;
...
- (void)_addStickerDrawerFieldsToChatChatEvent:(id)arg1;
- (id)_addChatChatSendCommonFieldsForMessage:(id)arg1 sendEvent:(id)arg2 analyticsDataModel:(id)arg3;
...
- (long long)_scaMediaTypeForMessageBodyType:(long long)arg1 mediaCardAttributes:(id)arg2 messageMediaType:(long long)arg3 storyShareMediaType:(id)arg4 nycShare:(id)arg5;
- (long long)_scaMediaTypeForMediaCardAttributes:(id)arg1;
- (long long)_scaMessageTypeForMessageBodyType:(long long)arg1 parcelType:(id)arg2 mediaIsCustomSticker:(_Bool)arg3 nycSharePoiIdLength:(unsigned long long)arg4;
- (long long)_scaMessageTypeForParcelType:(id)arg1;
- (void)_addStickerDrawerFieldsToChatDrawerEvent:(id)arg1 drawerType:(long long)arg2 actionType:(long long)arg3 bitmojiTabVisible:(_Bool)arg4;
...
- (void)logSCAChatDirectSnapViewForMemoryStoryWithMessage:(id)arg1 mediaViewInfo:(id)arg2;
...
- (void)logSCAChatSnapViewWithMessage:(id)arg1 mediaViewInfo:(id)arg2;
- (void)_logSCAChatSnapViewWithMessageType:(long long)arg1 mediaType:(long long)arg2 ackTimeSec:(double)arg3 source:(long long)arg4 isLaguna:(_Bool)arg5 withUserTag:(_Bool)arg6 rollMinDegree:(double)arg7 rollMaxDegree:(double)arg8 pinchToZoomMillis:(double)arg9 mischiefId:(id)arg10 conversationId:(id)arg11 chatId:(id)arg12 recipientForOneOnOneChat:(id)arg13;
- (void)logSCAChatViewForMessage:(id)arg1 releaseTimestamp:(id)arg2;
- (void)logSCAChatSend:(id)arg1 platformAnalytics:(id)arg2;
- (void)logSCAChatSend:(id)arg1 platformAnalyticsContainer:(id)arg2;
...
- (void)_logCommonSCAChatChatCreate:(id)arg1 conversationId:(id)arg2 navigationAction:(long long)arg3 subpageName:(id)arg4 source:(long long)arg5 previewSize:(unsigned long long)arg6 cellState:(long long)arg7 cellViewPosition:(long long)arg8;
- (void)logSCAChatCreateGroupWithMischiefId:(id)arg1 navigationAction:(long long)arg2 subpageName:(id)arg3 source:(long long)arg4 previewSize:(unsigned long long)arg5 cellState:(long long)arg6;
- (void)logSCAChatCreateOneOnOneWithSource:(long long)arg1 conversationId:(id)arg2 recipientUsername:(id)arg3 navigationAction:(long long)arg4 subpageName:(id)arg5 previewSize:(unsigned long long)arg6 cellState:(long long)arg7;
- (void)_logSCAChatPageViewWithEvent:(id)arg1 viewTime:(double)arg2 cellViewPosition:(long long)arg3;
...
- (void)registerPlatformAnalyticsBatchTaskUUID:(id)arg1;
- (id)init;
