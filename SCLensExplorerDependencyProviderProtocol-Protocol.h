...
@class NSData, NSString, SCCacheSizePolicy, SCObservable, SCPreferences, SCQueuePerformer, UIView, UIViewController;
@protocol SCCache, SCImageDownloading, SCLensExplorerBitmojiImageFetcherProtocol, SCLensExplorerInfoCardPresenterProtocol, SCLensExplorerLensUnlockerProtocol, SCLensExplorerLoggerProtocol, SCLensExplorerPerformanceLogging, SCLensExplorerProfilePresenterProtocol, SCLensExplorerSearchPresenterProtocol, SCLensExplorerSearchViewControllerProtocol, SCLensExplorerStudySettingsProviderProtocol, SCLensExplorerUnlockActionProviderProtocol, SCLensLiveLensPreviewCameraPresenterProtocol, SCLensUnlockerProtocol, SCLensUserProvider, SCRequestManager, SCSnapTokenProvider, SCUnlockableLensDataStoreFilterProtocol;

@protocol SCLensExplorerDependencyProviderProtocol <NSObject>
@property(readonly, nonatomic) SCObservable *activeLensOrderObservable;
...
- (id <SCLensExplorerInfoCardPresenterProtocol>)infoCardPresenter;
- (id <SCSnapTokenProvider>)snapTokenProvider;
...
- (UIViewController<SCLensExplorerSearchViewControllerProtocol> *)searchV1Controller;
- (id <SCLensExplorerSearchPresenterProtocol>)createSearchViewPresenterWithLensExplorerUnlocker:(id <SCLensExplorerLensUnlockerProtocol>)arg1 parentView:(UIView *)arg2 performanceLogger:(id <SCLensExplorerPerformanceLogging>)arg3;
