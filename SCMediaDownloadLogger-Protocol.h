...
- (void)mediaDownloadRedirectRequestCompelte:(_Bool)arg1 canceled:(_Bool)arg2 snapId:(NSString *)arg3 assetType:(long long)arg4 statusCode:(long long)arg5 latency:(double)arg6 urlPath:(NSString *)arg7 contentLengthInByte:(unsigned long long)arg8 error:(NSError *)arg9 assetDescriptor:(NSString *)arg10;
