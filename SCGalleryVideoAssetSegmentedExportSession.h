...
@class NSMutableArray, NSURL, PHAsset, PHImageManager, SCProgressOverlayView, SCQueuePerformer, UIViewController;
...
@interface SCGalleryVideoAssetSegmentedExportSession : NSObject
{
    ...
    UIViewController *_progressContainerViewController;
}

@property(nonatomic) __weak UIViewController *progressContainerViewController; // @synthesize progressContainerViewController=_progressContainerViewController;
