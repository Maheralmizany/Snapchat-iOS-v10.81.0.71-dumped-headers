...
@protocol SCCBitmojiAvatarBuilderPresenter, SCCBlizzardLogging, SCCStoryPlayerPlaying, SCCSubscriptionStore, SCComposerFoundationApplicationProtocol, SCComposerNetworkingClientProtocol, SCImpalaCommerceActionHandling, SCImpalaPresentationControlling, SCImpalaUrlActionHandling, SCImpalaWatchedStateCaching;
