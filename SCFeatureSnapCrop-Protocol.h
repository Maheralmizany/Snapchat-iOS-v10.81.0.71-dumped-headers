...
- (SCCroppingState *)identityCroppingState;
- (SCCroppingState *)createAndSetIdentityCroppingState:(struct CGSize)arg1 containerView:(UIView *)arg2 contentScaleFactor:(double)arg3;
