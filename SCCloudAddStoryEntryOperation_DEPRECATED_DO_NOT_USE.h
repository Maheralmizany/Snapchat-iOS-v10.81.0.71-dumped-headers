...
- (void).cxx_destruct;
- (void)_updateEntryFromCloudFS:(id)arg1 networker:(id)arg2 dataObjectContext:(id)arg3 snapsUploadInfo:(id)arg4 queue:(id)arg5 failureHandler:(CDUnknownBlockType)arg6 successHandler:(CDUnknownBlockType)arg7;
