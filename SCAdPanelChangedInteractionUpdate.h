...
@property(readonly, nonatomic) long long attachmentTriggerType; // @synthesize attachmentTriggerType=_attachmentTriggerType;
...
- (id)initWithAdIdentifier:(id)arg1 snapIndex:(long long)arg2 fromPanel:(long long)arg3 isPixelCookieAvailable:(_Bool)arg4 viewContext:(id)arg5 attachmentTriggerType:(long long)arg6;
