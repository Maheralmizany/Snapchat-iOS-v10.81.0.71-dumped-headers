...
@protocol SCCurrentPageTracker, SCLegacyPageViewLogger, SCMapPeopleFriendsProvider, SCMapPersonLocationsProviding, SCMapStatusViewedStateProvider, SCMapTrayMetadataProvider, SCMapViewLoggerTooltipState, SCMapViewport;
...
@interface SCMapViewLogger : NSObject <SCMapPersonLocationsListener>
{
    ...
    id <SCMapTrayMetadataProvider> _mapTrayMetadataProvider;
    _Bool _loggedColdMapReady;
...
- (void)mapLoadedFirstFriendBitmoji:(id)arg1 infoProvider:(id)arg2;
- (void)mapDidBecomeInteractive:(id)arg1 loggingInfoProvider:(id)arg2;
