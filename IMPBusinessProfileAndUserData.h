...
@class IMPBusinessProfile, IMPBusinessProfileFeatures, IMPBusinessProfileSettings, IMPBusinessProfileUserData, IMPBusinessStory, NSMutableArray;
...
@property(retain, nonatomic) IMPBusinessProfileSettings *businessProfileSettings; // @dynamic businessProfileSettings;
...
@property(nonatomic) _Bool hasBusinessProfileSettings; // @dynamic hasBusinessProfileSettings;
