...
@class NSString;
@protocol SCMapConfiguration, SCMapCustomGLRenderer, SCMapFeatureProvider, SCMapGestures, SCMapLoadingState, SCMapScreenshotProvider, SCMapViewport;

@protocol SCMapInstance <NSObject>
@property(readonly, nonatomic) id <SCMapFeatureProvider> mapFeatureProvider;
