...
- (id)initWithUserSession:(id)arg1 viewLocation:(long long)arg2 deepLinkId:(id)arg3 operaSessionId:(id)arg4 adTrackerHelper:(id)arg5 unskippableAdManager:(id)arg6 groupAdDataSource:(id)arg7 pendingPromotedStory:(id)arg8 adBlizzardLogger:(id)arg9 petraEligibilityEvaluator:(id)arg10;
