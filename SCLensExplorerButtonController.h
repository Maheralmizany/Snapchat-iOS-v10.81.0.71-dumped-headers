...
@protocol SCLensExplorerButtonDelegate, SCLensExplorerButtonLayoutProviderProtocol, SCLensExplorerStudySettingsProviderProtocol;
...
@interface SCLensExplorerButtonController : NSObject
{
    ...
    id <SCLensExplorerButtonLayoutProviderProtocol> _layoutProvider;
...
- (void)dealloc;
- (id)initWithParentView:(id)arg1 studySettingProvider:(id)arg2 userPreferences:(id)arg3 layoutProvider:(id)arg4 delegate:(id)arg5;
