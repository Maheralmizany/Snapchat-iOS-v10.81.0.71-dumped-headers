...
@class NSMutableArray, NSString, SCCommerceSession, SCCommerceStoreOperaLayer, SCCommerceStoreView, SCOperaLoadingLayerView, SCQueuePerformer, SCUserSession, SIGButton, SOJUCommerceStoreInfo;
...
@interface SCCommerceStoreViewController : SCOperaLayerViewController <SCCommerceStoreViewDelegate, SCOperaLoadingLayerViewDelegate, SCCommerceLoggerPageMetricsDataSource>
{
    ...
    SIGButton *_externalLinkButton;
}

@property(retain, nonatomic) SIGButton *externalLinkButton; // @synthesize externalLinkButton=_externalLinkButton;
