...
#import "SCChatViewableSnapsUpdateListener-Protocol.h"

@class NSDate, NSString, SCChatOperaViewModelGraph;
@protocol SCBaseMediaMessageOperaDataSourceDelegate, SCChatViewableSnapsUpdateProvider, SCOperaGifProvider><SCOperaImageProvider;

@interface SCChatSnapsV3OperaDataSource : SCChatBaseSnapOperaDataSource <SCChatOperaViewModelGraphDelegate, SCChatViewableSnapsUpdateListener>
{
    NSDate *_lastMessageTimestamp;
    SCChatOperaViewModelGraph *_operaViewModelGraph;
    id <SCChatViewableSnapsUpdateProvider> _viewableSnapsProvider;
...
- (id)conversationId;
- (void).cxx_destruct;
- (void)viewableSnapsUpdated:(id)arg1 metadata:(id)arg2;
...
- (void)_handleViewableSnapsUpdate:(id)arg1 metadata:(id)arg2 senderDisplayNames:(id)arg3;
- (void)_addContent:(id)arg1 sentTimestamp:(id)arg2 message:(id)arg3 senderDisplayName:(id)arg4;
...
- (id)initWithConversationId:(id)arg1 isGroupConversation:(_Bool)arg2 performer:(id)arg3 userSession:(id)arg4 viewableSnapsProvider:(id)arg5;
