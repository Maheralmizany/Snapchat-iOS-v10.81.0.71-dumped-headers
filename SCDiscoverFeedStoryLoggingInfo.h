...
- (id)initWithItemId:(id)arg1 itemType:(long long)arg2 itemTypeSpecific:(id)arg3 storyTypeSpecific:(long long)arg4 itemLayout:(long long)arg5 isFullyViewed:(_Bool)arg6 tileId:(id)arg7 snapInfo:(id)arg8 totalNumSnaps:(long long)arg9 itemPos:(id)arg10 rankingStoryInfo:(id)arg11 isUpNextRecommendedStory:(_Bool)arg12 triggeringItemId:(id)arg13;
