...
- (id)initWithCreativeId:(id)arg1 snapIndex:(long long)arg2 deltaBetweenReceiveAndRenderInMillis:(double)arg3 topSnapTimeViewedInMillis:(long long)arg4 topSnapMediaDurationInMillis:(long long)arg5 topSnapUncappedMaxUnobstructedViewTimeInMillis:(double)arg6 topSnapUncappedTotalUnobstructedAudibleViewTimeInMillis:(double)arg7 maxMediaVolumeForMediaPlayback:(id)arg8 swipeCount:(long long)arg9 longformMaxViewedDurationInMillis:(double)arg10 exitEvent:(id)arg11 shouldReportThirdPartyMetrics:(_Bool)arg12 thirdPartyTrackInfo:(id)arg13;
