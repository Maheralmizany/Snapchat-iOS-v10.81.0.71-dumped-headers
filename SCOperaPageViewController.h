...
@class FBKVOController, NSDictionary, NSHashTable, NSMutableArray, NSNumber, NSString, NSTimer, SCOperaConfiguration, SCOperaEventListenerAnnouncer, SCOperaPage, SCOperaPageActionBarContentView, SCOperaPageBackdropView, SCOperaSharedResourceManager, SCStopwatch, UILongPressGestureRecognizer, UIScrollView, UIView;
...
- (struct UIEdgeInsets)fromView:(id)arg1 edgeInsetsForPointToPageViewBounds:(struct CGPoint)arg2;
- (struct CGPoint)fromView:(id)arg1 convertPointToContainerView:(struct CGPoint)arg2;
...
- (id)_actionBarContentViewsForLayerVCsForConfiguration:(struct SCOperaActionBarContentConfiguration)arg1;
- (void)_updateActionBarContentViews;
- (id)actionBarContentViewForConfiguration:(struct SCOperaActionBarContentConfiguration)arg1;
