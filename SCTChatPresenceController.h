...
@protocol SCTPresencePillTapListener, SCTV3ChatServices, SCTalkUIController, TCRendererController;
...
- (id)initWithAvatarServices:(id)arg1 chatServices:(id)arg2 talkUIController:(id)arg3 speechActivityAnnouncer:(id)arg4 useMetalRenderer:(_Bool)arg5 rendererController:(id)arg6;
