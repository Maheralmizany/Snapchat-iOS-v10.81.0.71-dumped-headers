...
- (void)presentLocalityStoryOnViewController:(id)arg1 baseView:(id)arg2 localityStoryManifest:(id)arg3 verrazanoId:(id)arg4 storiesInfo:(id)arg5 renderLayer:(id)arg6 sourceType:(long long)arg7;
