...
@interface SCViewControllerDismissalAnimator : NSObject <UIGestureRecognizerDelegate>
{
    ...
    _Bool _slideToDismissDidBegin;
    long long _slideDismissSwipeDirection;
...
- (void)_animateSlideToDismissWithContainerMaskView:(id)arg1 useDismissalMask:(_Bool)arg2;
- (void)_animateDismissWithContainerMaskView:(id)arg1 useDismissalMask:(_Bool)arg2;
...
- (void)_handlePanChangeForSlideToDismissWithGesture:(id)arg1;
- (void)_handlePanChangeWithGesture:(id)arg1;
