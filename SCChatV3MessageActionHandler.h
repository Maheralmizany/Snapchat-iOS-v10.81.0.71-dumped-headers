...
@protocol SCChatActionResetDelegate, SCChatConversationAPI, SCChatLogger, SCChatStoryLoader, SCFideliusUnwrapProtocol, SCMediaSendTaskManager, SCSnapLogger, SCUserHelperProtocol;
...
- (id)sendFlowLogger;
- (void)_logMediaViewForMessage:(id)arg1 mediaViewInfo:(id)arg2;
...
- (void)_fetchNotificationStatusForConversation:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_conversationId:(id)arg1 uploadMedia:(id)arg2 dataToUpload:(id)arg3 inMessage:(id)arg4 withProvider:(id)arg5 completion:(CDUnknownBlockType)arg6;
- (id)conversation:(id)arg1 sendMessage:(id)arg2 analyticsContainer:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)_retryUploadMediasForConversation:(id)arg1 message:(id)arg2 messageMetadata:(id)arg3 analyticsContainer:(id)arg4;
- (void)_uploadMediasForConversation:(id)arg1 message:(id)arg2 messageMetadata:(id)arg3 success:(_Bool)arg4 analyticsContainer:(id)arg5;
- (void)_handleRetryUploadFailureWithMessage:(id)arg1 conversation:(id)arg2 response:(id)arg3 uploadId:(id)arg4;
- (void)_handleRetryUploadReplyMediaSuccessWithMessage:(id)arg1 conversation:(id)arg2 responseDictionary:(id)arg3 uploadId:(id)arg4 analyticsContainer:(id)arg5;
- (void)_handleRetryUploadReplyMediaSuccessWithMessage:(id)arg1 conversation:(id)arg2 responseDictionary:(id)arg3 uploadId:(id)arg4 messageMetadata:(id)arg5 analyticsContainer:(id)arg6;
- (id)_retryUploadReplyMediasForMessage:(id)arg1 conversation:(id)arg2 analyticsContainer:(id)arg3;
- (id)_retryFailedMessage:(id)arg1 forConversation:(id)arg2 platformAnalytics:(id)arg3 messageMetadata:(id)arg4 isAutoRetry:(_Bool)arg5;
- (void)_logFatalMediaTaskUpload:(id)arg1 startTimestamp:(double)arg2;
- (id)_retryFailedBlockMessage:(id)arg1 forConversation:(id)arg2 platformAnalytics:(id)arg3 messageMetadata:(id)arg4 blockInfo:(id)arg5 isAutoRetry:(_Bool)arg6;
- (void)retryFailedBlockMessageId:(id)arg1 forConversationId:(id)arg2 analyticsDataModel:(id)arg3 isAutoRetry:(_Bool)arg4;
...
- (void)_retryFailedBlockMessageId:(id)arg1 forConversationId:(id)arg2 platformAnalytics:(id)arg3 messageMetadata:(id)arg4 blockInfo:(id)arg5 isAutoRetry:(_Bool)arg6;
- (void)_retryFailedBlockMessageId:(id)arg1 forConversationId:(id)arg2 platformAnalytics:(id)arg3 messageMetadata:(id)arg4 isAutoRetry:(_Bool)arg5;
...
- (void)_conversationId:(id)arg1 messageId:(id)arg2 didUploadMediaId:(id)arg3 success:(_Bool)arg4 analyticsContainer:(id)arg5;
- (void)_conversationId:(id)arg1 messageId:(id)arg2 didUploadMediaId:(id)arg3 success:(_Bool)arg4 messageMetadata:(id)arg5 analyticsContainer:(id)arg6;
- (void)_conversationId:(id)arg1 message:(id)arg2 dataDidPrepareForMedia:(id)arg3 withMediaProvider:(id)arg4 dataToUpload:(id)arg5 success:(_Bool)arg6 analyticsContainer:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)_logRetryPreSendUpdate:(id)arg1 failedMessageIds:(id)arg2 isAutoRetry:(_Bool)arg3 startTimestamp:(double)arg4;
- (void)_logSendMessageDiscreteStepStart:(long long)arg1 timestamp:(double)arg2 messageId:(id)arg3 message:(id)arg4 conversation:(id)arg5 mediaType:(long long)arg6 batchTaskId:(id)arg7 destinationInfo:(id)arg8;
- (void)_conversationId:(id)arg1 sendMediaMessageWithType:(long long)arg2 withMediaProviders:(id)arg3 withMessageMetadata:(id)arg4 analyticsDataModel:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)_handleReplyMedia:(id)arg1 forMessage:(id)arg2 uploadedWithId:(id)arg3 withResponse:(id)arg4 sendOnSuccess:(_Bool)arg5 analyticsContainer:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;
- (void)_uploadReplyMediaForMessage:(id)arg1 sendOnSuccess:(_Bool)arg2 analyticsContainer:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (void)_uploadStory:(id)arg1 conversationId:(id)arg2 clientMessageId:(id)arg3 sendOnSuccess:(_Bool)arg4 sendMessageStartTimestamp:(double)arg5 analyticsContainer:(id)arg6 messageCreationBlock:(CDUnknownBlockType)arg7 completionBlock:(CDUnknownBlockType)arg8;
...
- (void)_conversationId:(id)arg1 sendApiMesage:(id)arg2 type:(id)arg3 additionalText:(id)arg4 analyticsContainer:(id)arg5 textAnalyticsContainer:(id)arg6 completion:(CDUnknownBlockType)arg7;
...
- (unsigned long long)_numberOfRecipientsForRecipients:(id)arg1;
...
- (id)initWithUsername:(id)arg1 conversationStore:(id)arg2 metadataStore:(id)arg3 sender:(id)arg4 conversationAPI:(id)arg5 mediaRequestManager:(id)arg6 mediaStateManager:(id)arg7 mediaReferenceManager:(id)arg8 snapViewVerifier:(id)arg9 messageStateHandler:(id)arg10 logger:(id)arg11 conversationManager:(id)arg12 userHelper:(id)arg13 storyLoader:(id)arg14 snapLogger:(id)arg15 fideliusManager:(id)arg16 lazyCustomStickerManager:(id)arg17 blockAssigner:(id)arg18 autoShakeToReporter:(id)arg19 mediaSendTaskManager:(id)arg20 usernameSnapchatterFetcher:(id)arg21 batchFetcher:(id)arg22 mediaExtensionCacheHandler:(id)arg23 sendFlowLogger:(id)arg24 groupDataFetcher:(id)arg25 chatResetDelegate:(id)arg26 conversationIdResolver:(id)arg27;
