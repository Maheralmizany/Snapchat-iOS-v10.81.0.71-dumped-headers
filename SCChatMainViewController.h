...
@protocol NavigationDelegate, SCChatMainViewControllerStateDelegate, SCStartChatDelegate, SCSwipeViewParentDelegate, SCTalkManager;
...
- (id)_stackedVCForChatIdentifier:(id)arg1;
...
- (_Bool)canBeShown;
- (void)warmup;
- (void)setConversationByChatIdentifier:(id)arg1 deeplinkType:(unsigned long long)arg2 stateDelegate:(id)arg3 isFromNotification:(_Bool)arg4 chatPageSource:(long long)arg5 navigationAction:(long long)arg6 chatSubpageName:(id)arg7 chatViewOptions:(id)arg8;
