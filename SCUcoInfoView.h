...
@class NSLayoutConstraint, NSString, SIGLoadingIndicatorView, UIImageView, UILabel;
...
@interface SCUcoInfoView : UIView <SCUcoStateListener, SCTraceEnabled, SCUcoInfoView>
{
    ...
    SIGLoadingIndicatorView *_iconLoadingIndicatorView;
...
- (void)_resizeAndSetIconImage:(id)arg1 shouldTint:(_Bool)arg2;
- (void)_updateUcoIconWithTint:(_Bool)arg1;
