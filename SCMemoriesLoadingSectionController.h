...
@class NSString, SCMemoriesLoadingSectionViewModel;

@interface SCMemoriesLoadingSectionController : IGListSectionController <IGListSupplementaryViewSource>
{
    SCMemoriesLoadingSectionViewModel *_viewModel;
}
