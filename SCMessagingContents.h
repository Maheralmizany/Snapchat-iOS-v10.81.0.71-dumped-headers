...
@class SCMessagingCanvasApp, SCMessagingExternalMedia, SCMessagingLocation, SCMessagingNote, SCMessagingShare, SCMessagingSnap, SCMessagingSnapReply, SCMessagingSnapdocWrapper, SCMessagingStatusMessage, SCMessagingSticker, SCMessagingText, SDMSnapDoc;
...
@property(retain, nonatomic) SCMessagingCanvasApp *canvasApp; // @dynamic canvasApp;
...
@property(retain, nonatomic) SCMessagingSnapdocWrapper *snapdocWrapper; // @dynamic snapdocWrapper;
