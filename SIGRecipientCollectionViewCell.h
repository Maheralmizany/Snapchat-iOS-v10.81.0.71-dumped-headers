...
@class NSString, SCLazy, SIGButton;
...
@interface SIGRecipientCollectionViewCell : SIGCollectionViewCell <UIGestureRecognizerDelegate, SCActionHandlingDelegate, SCViewModelConfigurable, SCActionable>
{
    ...
    SIGButton *_trailingButtonView;
    id <SIGAccessoryViewProviding> _trailingButtonViewProvider;
    id _viewModel;
...
- (void)_updateButtonWithViewModel:(id)arg1;
- (void)_updateEmojiWithViewModel:(id)arg1;
- (void)_updateAttributedWithTitle:(id)arg1 detailText:(id)arg2;
- (void)_updateBasicWithViewModel:(id)arg1 displayStarBadge:(_Bool)arg2;
- (void)_updateLeadingAccessoryWithImage:(id)arg1;
