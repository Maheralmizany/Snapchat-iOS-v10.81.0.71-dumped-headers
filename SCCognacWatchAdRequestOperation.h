...
@class NSString, SCCognacAdItem, SCCognacAdStatusManager, SCCognacAdsPersistenceService, SCCognacAppViewLifeCycleListenerAnnouncer, SCCognacOperaDataSource, SCCognacWatchAdRequestBody, SCOperaViewController;
@protocol NavigationDelegate, SCCognacCypressProxy;

@interface SCCognacWatchAdRequestOperation : SCCognacCypressRequestOperation <SCCognacAdsManagerDelegate>
{
