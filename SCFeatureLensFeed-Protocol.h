...
@protocol SCFeatureLensExplorerSwipeUpDelegate, SCFeatureLensFeedDelegate, SCFeatureLensFeedTooltipDelegate, SCLensExplorerNavigationProviderProtocol, SCLensExplorerStudySettingsProviderProtocol;
...
- (void)presentLensFeedFromInfoCardWithViewController:(UIViewController *)arg1;
- (void)presentLensFeedFromViewController:(UIViewController *)arg1 entryPoint:(long long)arg2 isInteractiveTransitioning:(_Bool)arg3;
...
- (id <SCLensExplorerNavigationProviderProtocol>)lensExplorerNavigationProvider;
- (id)init;
@end
