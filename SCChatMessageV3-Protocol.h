...
@property(readonly, copy, nonatomic) SOJUSnapProStoryReplyInfo *snapProStoryReplyInfo;
...
@property(readonly, copy, nonatomic) NSString *mediaSendTaskClientMessageId;
