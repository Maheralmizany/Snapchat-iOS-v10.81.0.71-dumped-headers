...
@class NSString, SCApplicationLoginLogger, SCPhoneNumber;
...
- (void)showRecoverPasswordAlertWithDelegate:(id <SCRecoverPasswordAlertDelegate>)arg1 usernameOrEmail:(NSString *)arg2 logger:(SCApplicationLoginLogger *)arg3;
@end
