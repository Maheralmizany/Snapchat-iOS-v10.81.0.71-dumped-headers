...
- (void)registerBatchTaskId:(NSString *)arg1;
...
- (void)updateMetadataWithMessageId:(NSString *)arg1 sendToFriendCount:(long long)arg2 sendToFsnGroupConversationIds:(NSSet *)arg3 sendToArroyoGroupConversationIds:(NSSet *)arg4 sendToStoryCount:(long long)arg5;
...
- (void)updateMetadataWithMessageId:(NSString *)arg1 captureId:(NSString *)arg2 messageBodyType:(long long)arg3 mediaType:(long long)arg4 batchTaskId:(NSString *)arg5;
