...
@class NSMutableOrderedSet, NSSet, NSString, SCCloudFS, SCCloudSync, SCDataObjectContext, SCGalleryDataMutator, SCGalleryEncryptedDatabase, SCQueuePerformer, SCSentinel;
@protocol SCEncryptedContentManaging;
