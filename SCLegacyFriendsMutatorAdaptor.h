...
- (void)updateContactSync:(_Bool)arg1 requestManager:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)findFriendsWithContactSource:(long long)arg1 shouldRecommend:(_Bool)arg2 isAllUpdate:(_Bool)arg3 isDelta:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
...
- (id)initWithUser:(id)arg1 friends:(id)arg2 userInfoProvider:(id)arg3 sessionRequestManager:(id)arg4;
