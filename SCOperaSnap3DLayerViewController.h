...
@interface SCOperaSnap3DLayerViewController : SCOperaLayerViewController <LSAEffectComponentListener, SCLensDataFetcherListener, SCTraceEnabled, SCOperaRotatingLayerPinchControllerDelegate, SCOperaEventListener, SCOperaPinchGestureCompatibleViewController, SCOperaFadeTransitionCompatibleViewController>
{
    ...
    SCLensSbSnappableMessage *_snappableMessageOperaProperty;
    _Bool _didFinishReadingAssetsFromMediaCache;
    _Bool _attemptedToReadFromMediaCache;
    _Bool _didReceiveViewWillFullyAppear;
    UIView *_pinchGestureTarget;
}

+ (id)_registeredEventsForOperaSession;
@property(nonatomic) _Bool didReceiveViewWillFullyAppear; // @synthesize didReceiveViewWillFullyAppear=_didReceiveViewWillFullyAppear;
@property _Bool attemptedToReadFromMediaCache; // @synthesize attemptedToReadFromMediaCache=_attemptedToReadFromMediaCache;
@property _Bool didFinishReadingAssetsFromMediaCache; // @synthesize didFinishReadingAssetsFromMediaCache=_didFinishReadingAssetsFromMediaCache;
...
- (void)_initializePropertiesFromOpera;
