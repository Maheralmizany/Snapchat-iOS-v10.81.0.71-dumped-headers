...
@class NSArray, NSMutableArray, NSMutableSet, NSString, PHCachingImageManager, SCGalleryPhotoLibraryFetcher, SCLoadingIndicatorView, SCScannableInfo, SCSnapcodeCollectionCell, SCSnapcodeMenuButton, SCUserSession, SCWebImageScraperClient, SVGDocumentView, SVGRenderer, UIButton, UICollectionView, UIImage, UIImageView, UILabel, UIView;
