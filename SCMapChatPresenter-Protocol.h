...
- (_Bool)viewControllerIsChat:(UIViewController *)arg1;
...
- (void)presentChatOnViewController:(UIViewController *)arg1 username:(NSString *)arg2 userId:(NSString *)arg3 deeplinkURL:(SCDeepLinkURL *)arg4 notification:(SCAppNotification *)arg5 source:(long long)arg6 subpageName:(NSString *)arg7;
@end
