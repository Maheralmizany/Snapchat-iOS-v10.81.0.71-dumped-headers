...
@property(nonatomic) __weak id <UIViewControllerInteractiveTransitioning> customInteractiveTransitioningDismissalAnimator;
@property(nonatomic) __weak id <UIViewControllerInteractiveTransitioning> customInteractiveTransitioningPresentationAnimator;
@property(nonatomic) __weak id <UIViewControllerAnimatedTransitioning> customAnimatedTransitioningDismissalAnimator;
@property(nonatomic) __weak id <UIViewControllerAnimatedTransitioning> customAnimatedTransitioningPresentationAnimator;
