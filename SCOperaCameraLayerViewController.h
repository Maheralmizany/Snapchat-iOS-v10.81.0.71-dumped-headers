...
@interface SCOperaCameraLayerViewController : SCOperaLayerViewController <SCCaptureWorkflowResultDelegate, SCPageNameLogging>
{
...
+ (id)unavailableLensWithNonNilLensIdWithLensIconInMemoryCache:(id)arg1;
