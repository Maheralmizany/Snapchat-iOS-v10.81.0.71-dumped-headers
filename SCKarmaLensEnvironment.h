...
@property(readonly, nonatomic) NSString *lensModelPath;
...
- (id)initWithWithLensId:(id)arg1 lensLink:(id)arg2 lensSignature:(id)arg3 lensIconLink:(id)arg4 lensDescriptor:(id)arg5 lensModelPath:(id)arg6;
