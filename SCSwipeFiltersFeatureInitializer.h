...
@protocol SCFeatureSnapCrop, SCGeoFilterLogger, SCImageProcessCommandMapping, SCImageProcessCommandProvider, SCLensLoggerConsumptionTrackingProviding, SCPreviewFeatureDrawing, SCPreviewFeatureStickerContainer, SCPreviewLogging, SCSmartSwipeFilterFocusLocationChangeDelegate, SCSwipeFilterHelpProvider, SCVenueFilterTooltipProvider;
