...
@class NSError, NSString, SCCommerceCheckoutDataModel, SOJUCommerceOrder;
...
@property(nonatomic) _Bool isCheckoutOnboarding;
...
@property(retain, nonatomic) NSString *productSetId;
...
- (void)logShippingMethodEventWithCheckout:(SCCommerceCheckoutDataModel *)arg1 actionType:(long long)arg2 success:(_Bool)arg3 error:(NSError *)arg4;
- (void)logCompletedCheckoutOrderWithCheckout:(SCCommerceCheckoutDataModel *)arg1 order:(SOJUCommerceOrder *)arg2 success:(_Bool)arg3 error:(NSError *)arg4;
- (void)logCheckoutSessionWithCheckout:(SCCommerceCheckoutDataModel *)arg1 actionType:(long long)arg2 success:(_Bool)arg3 error:(NSError *)arg4;
