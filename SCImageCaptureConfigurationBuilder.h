...
- (void).cxx_destruct;
- (id)setFingerDownCaptureStrategy:(long long)arg1;
- (id)setFingerDownCaptureEnabled:(_Bool)arg1;
- (id)setIsMainCamera:(_Bool)arg1;
- (id)setIsInteractiveSnap:(_Bool)arg1;
...
- (id)setExposureCaptureDelayEnabled:(_Bool)arg1;
