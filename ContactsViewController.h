...
@class AddFriendsDelegateObject, EGORefreshTableHeaderView, Friend, NSArray, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSSet, NSString, SCIndexedTableView, SCLazy, SCSearchFriendsSubViewController, SCUserSession, UILabel, UIView;
