...
- (void)_updateChatAffordanceWithConversationViewModelChanged:(_Bool)arg1;
...
- (void)_updateTableViewWithAddedPaths:(id)arg1 updatedPaths:(id)arg2 deletedPaths:(id)arg3 heightChanged:(_Bool)arg4;
- (void)_reloadRelevantTableCells;
- (void)_reestablishContentOffsetWithPreviousDistanceToBottom:(double)arg1;
- (void)_updateContentOffsetForPreviousDistanceToBottom:(double)arg1 isMessageAddedAtTheEnd:(_Bool)arg2;
