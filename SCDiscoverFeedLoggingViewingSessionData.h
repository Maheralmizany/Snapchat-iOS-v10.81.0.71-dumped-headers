...
- (id)initWithIdentifier:(id)arg1 storyLoggingInfo:(id)arg2 rerankingId:(unsigned long long)arg3 itemPos:(long long)arg4 itemSource:(long long)arg5 subitemId:(id)arg6 pageId:(id)arg7 entryEvent:(long long)arg8 entryIntent:(long long)arg9 viewSessionStartTime:(id)arg10 triggeringItemId:(id)arg11 triggeringItemPlaylistOffset:(long long)arg12 section:(id)arg13 isFullyViewed:(_Bool)arg14 fieldsOverrideDict:(id)arg15 enableTotalNumSnapsProperty:(_Bool)arg16;
