...
@interface SCFriendUnifiedProfileLeavePrivateStoryMenuDataProvider : NSObject <SCUnifiedActionMenuDataProvider>
{
...
- (void).cxx_destruct;
- (id)_leavePrivateStoryViewModel:(id)arg1;
- (void)updateViewModelWithCompletionBlock:(CDUnknownBlockType)arg1;
- (id)initWithCustomStoriesDataFetcher:(id)arg1 userId:(id)arg2;
