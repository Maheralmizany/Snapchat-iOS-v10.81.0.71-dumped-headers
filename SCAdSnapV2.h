...
- (id)initWithCreativeId:(id)arg1 adType:(long long)arg2 adProductType:(unsigned long long)arg3 identifier:(id)arg4 brandName:(id)arg5 brandHeadline:(id)arg6 snapMedia:(id)arg7 isSharable:(_Bool)arg8 isUnskippable:(_Bool)arg9 renditionList:(id)arg10 payingAdvertiserName:(id)arg11 unskippableDurationMs:(double)arg12 adSkippableType:(long long)arg13;
