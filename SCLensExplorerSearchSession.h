...
@class NSDictionary, NSString, SCFeatureSettingsService, SCSearchCachedRequestManager, SCSearchResultSectionDescriptor, SCSearchSession, SCUserSession;
...
- (id)initWithUserSession:(id)arg1 featureSettingsService:(id)arg2;
