...
@interface SCBloopsPreviewsHomeDataSource : NSObject <SCBloopsPreviewsDataSource>
{
...
- (id)initWithText:(id)arg1 sessionToken:(id)arg2 searchCachePriority:(id)arg3 itemsLimit:(id)arg4 bloopsModelType:(unsigned long long)arg5 scrollDirection:(unsigned long long)arg6 itemsInRow:(unsigned long long)arg7 preferredRows:(unsigned long long)arg8;
