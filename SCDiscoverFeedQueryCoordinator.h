...
@class NSMutableArray, NSString, SCCircumstanceEngine, SCDiscoverFeedDataStore, SCDiscoverFeedInteractionHistoryModifier, SCDiscoverFeedNetworkResponseProcessor, SCDiscoverFeedSectionExtensionServices, SCExperimentManager, SCGCDBlockTimer, SCLazy, SCQueuePerformer, SCSSMAdsClientInfo, SCSearchNavigationCoordinator, SCSearchQuery, SCSessionRequestManager, SCUserSession;
@protocol SCDiscoverFeedDebugInfoDataProviding, SCDiscoverFeedQueryCoordinatingDelegate, SCStoriesMixerEndpointManaging;
...
@interface SCDiscoverFeedQueryCoordinator : NSObject <SCDiscoverFeedQueryCoordinating>
{
    ...
    SCLazy *_discoverFeedEventController;
    SCLazy *_tapHistoryManager;
    SCLazy *_userInfoProviderLazy;
...
- (id)_createSectionFromResponse:(id)arg1 feedType:(int)arg2 query:(id)arg3 watchedStatesByEditionId:(id)arg4 interactionHistoryArray:(id)arg5;
...
- (void)_syncShowWatchedStateAndHandleStoriesResponse:(id)arg1 query:(id)arg2 interactionHistoryArray:(id)arg3 updatingBlock:(CDUnknownBlockType)arg4;
...
- (void)_persistStoriesToDataStoreWithStoriesResponse:(id)arg1 watchedStatesByEditionId:(id)arg2 metaStreamToken:(id)arg3 query:(id)arg4 interactionHistoryArray:(id)arg5;
...
- (void)_sendQuery:(id)arg1 snapToken:(id)arg2 tapHistory:(id)arg3 pageSessionId:(id)arg4 updatingBlock:(CDUnknownBlockType)arg5;
...
- (id)initWithUserSession:(id)arg1 snapTokenProvider:(id)arg2 discoverFeedDataCoordinator:(id)arg3 friendStoriesDataCoordinator:(id)arg4 docObjectContext:(id)arg5 storiesSyncNetworkRequester:(id)arg6 endpointManager:(id)arg7 circumstanceEngine:(id)arg8 discoverFeedDataStore:(id)arg9 discoverFeedEventsController:(id)arg10 tapHistoryManager:(id)arg11 userInfoProviderLazy:(id)arg12 bitmojiAvatarProvider:(id)arg13 discoverFeedRanker:(id)arg14 adsClientInfo:(id)arg15 bitmojiFriendAvatarProvider:(id)arg16 snapchattersSynchronousDataFetcher:(id)arg17;
