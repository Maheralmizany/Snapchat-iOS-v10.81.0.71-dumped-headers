...
@protocol SCLegacyPageViewLogger, SCPerforming, SCPromotedStoriesLogging;
...
@interface SCDiscoverFeedEventsController : NSObject <SCDiscoverFeedLoggingLongImpressionManagerDelegate, SCDiscoverFeedClientRerankingManagerDelegate, SCDiscoverFeedScrollTrackerDelegate, SCEventListener, SCDiscoverFeedEventsSessionProviding>
{
    ...
    id <SCPromotedStoriesLogging> _promotedStoriesLogger;
    ...
    long long _nextSubitemEntryIntent;
...
- (void)_setFeedPageViewWithOpenTimestamp:(id)arg1 sections:(id)arg2 pageType:(long long)arg3 pageTypeSpecific:(id)arg4;
...
- (void)_logFeedPageView:(long long)arg1;
...
- (id)initWithCheetahDataStore:(id)arg1 cheetahTapHistoryManager:(id)arg2 cheetahInteractionHistoryManager:(id)arg3 experimentManager:(id)arg4 snapTokenProvider:(id)arg5 requestManager:(id)arg6 pageViewLogger:(id)arg7 promotedStoriesLogger:(id)arg8;
