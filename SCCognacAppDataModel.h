...
@class NSString, SCCognacAppImageResources, SCCognacAppLeaderboardInfo, SCCognacAppPlayersLimits, SCCognacAppSnapCanvasSDKInfo, SCCognacContentUpdateInfo;
...
@interface SCCognacAppDataModel : NSObject <NSCopying, NSCoding>
{
    ...
    SCCognacAppSnapCanvasSDKInfo *_snapCanvasSDKInfo;
}

@property(readonly, copy, nonatomic) SCCognacAppSnapCanvasSDKInfo *snapCanvasSDKInfo; // @synthesize snapCanvasSDKInfo=_snapCanvasSDKInfo;
...
- (id)initWithAppId:(id)arg1 buildId:(id)arg2 appName:(id)arg3 appDescription:(id)arg4 contentURL:(id)arg5 resourceBundleURL:(id)arg6 imageResources:(id)arg7 playersLimits:(id)arg8 privacyPolicyURL:(id)arg9 termsOfServiceURL:(id)arg10 publisherType:(unsigned long long)arg11 contentUpdateInfo:(id)arg12 buildVersion:(id)arg13 leaderboardInfo:(id)arg14 type:(unsigned long long)arg15 snapCanvasSDKInfo:(id)arg16;
