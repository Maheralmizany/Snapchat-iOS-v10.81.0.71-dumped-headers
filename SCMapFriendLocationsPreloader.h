...
@class NSString, SCFeatureSettingsService, SCMapBasePersonLocationsProvider, SCServerConfig;
...
- (id)initWithFeatureSettingsService:(id)arg1 mapBasePersonLocationsProvider:(id)arg2 serverConfig:(id)arg3;
