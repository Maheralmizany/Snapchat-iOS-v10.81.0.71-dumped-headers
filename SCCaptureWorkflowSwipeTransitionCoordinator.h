...
@class NSString, SCCameraViewController, UINavigationController;
@protocol SCCameraViewContaining, SCSwipeTransitionCoordinator;

@interface SCCaptureWorkflowSwipeTransitionCoordinator : NSObject <SCSwipeTransitionCoordinatorDelegate, SCSwipeTransitionCoordinatorDataSource>
{
...
- (void)presentViewControllerAnimationDuration:(double)arg1 completion:(CDUnknownBlockType)arg2;
- (id)initWithCameraViewController:(id)arg1 navigationController:(id)arg2 cameraViewContainer:(id)arg3;
