...
@protocol SCSpectaclesReleaseNote;

@interface SCLagunaSettingsReleaseNoteCell : UITableViewCell
{
    _Bool _isNewNote;
    id <SCSpectaclesReleaseNote> _releaseNote;
...
@property(retain, nonatomic) id <SCSpectaclesReleaseNote> releaseNote; // @synthesize releaseNote=_releaseNote;
- (void).cxx_destruct;
