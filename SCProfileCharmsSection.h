...
@class NSArray, NSDictionary, NSString, SCCharmsBlizzardLogger, SCCollectionViewCarouselSectionConfiguration, SCCollectionViewSectionUpdateModel, SCProfileCharmsCollectionViewCell;
...
- (void)tearDown;
- (void)setUp;
- (id)initWithProfileSessionId:(id)arg1 emptyStateText:(id)arg2 supplementaryViewProvider:(id)arg3;
