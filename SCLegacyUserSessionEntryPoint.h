...
@class SCAuthenticatedNetworkServices, SCFeatureSettingsServices, SCScopeExposer, SCSystemScope, SCUserSessionScope, SCUserSessionWorkflow, SCUserStorageServices;
