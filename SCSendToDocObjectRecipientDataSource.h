...
@class NSMutableDictionary, NSString, SCLazy, SCQueuePerformer, SCSendToRanker, SCUserSession;
@protocol OS_dispatch_queue, SCGroupManager;
...
@interface SCSendToDocObjectRecipientDataSource : NSObject <SCSnapchattersDataRequestListener, SCTraceEnabled>
{
    ...
    SCLazy *_snapchattersSearchDataProvider;
    SCLazy *_snappableSnapchattersFetcher;
    SCLazy *_thisChatRecipientsFetcher;
