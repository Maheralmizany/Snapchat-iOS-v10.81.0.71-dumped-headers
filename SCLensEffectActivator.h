...
@protocol SCLensCrashLoggerProtocol, SCLensLoggerConsumptionTrackingProviding, SCLensTraceLoggerProtocol;
...
@interface SCLensEffectActivator : NSObject <SCTraceEnabled, SCLensEffectActivator, LSAEffectComponentListener>
{
    ...
    id <SCLensLoggerConsumptionTrackingProviding> _lensConsumptionLogger;
...
- (id)initWithEffectComponent:(id)arg1 videoProcessingComponent:(id)arg2 lensCrashLogger:(id)arg3 lensUserTraceLogger:(id)arg4 lensConsumptionLogger:(id)arg5;
