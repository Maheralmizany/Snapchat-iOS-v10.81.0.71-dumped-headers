...
@interface SCViewControllerPresentationSwipeUpAnimator : NSObject <SCViewControllerPresentationAnimator>
{
    UIViewController *_childVC;
    UIViewController *_parentVC;
    long long _baseViewBehavior;
    long long _swipeUpMode;
    _Bool _animating;
...
- (void)_blackBackgroundEntrance:(_Bool)arg1;
- (void)_scaleAnimation:(_Bool)arg1;
- (void)animateTransition:(_Bool)arg1;
- (id)initWithParentViewController:(id)arg1 childViewController:(id)arg2 baseView:(id)arg3 baseViewBehavior:(long long)arg4 swipeUpMode:(long long)arg5;
