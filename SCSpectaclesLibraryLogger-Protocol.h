...
@class NSDate, NSNumber, NSString, NSUUID, SCSpectaclesConnectionInfo, SCSpectaclesDevice, SCSpectaclesHDTransferSessionInfo, SCSpectaclesTransferSession;
...
- (void)logSpectaclesTransferHDFlowCancelled:(SCSpectaclesHDTransferSessionInfo *)arg1 fromSource:(unsigned long long)arg2;
- (void)logSpectaclesTransferHDFlowStarted:(SCSpectaclesHDTransferSessionInfo *)arg1 fromSource:(unsigned long long)arg2;
