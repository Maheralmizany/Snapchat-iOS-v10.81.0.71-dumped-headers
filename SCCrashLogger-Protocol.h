...
- (void)reportSpectaclesFirmwareCrashWithReportId:(NSString *)arg1 userId:(NSString *)arg2 title:(NSString *)arg3 description:(NSString *)arg4 otherInfoInJson:(NSString *)arg5 firmwareLogPath:(NSString *)arg6 onComplete:(void (^)(_Bool, NSError *))arg7;
