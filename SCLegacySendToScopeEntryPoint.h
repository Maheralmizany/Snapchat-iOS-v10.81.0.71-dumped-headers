...
@class SCActiveUserSessionScope, SCCustomStoriesServices, SCGroupServices, SCLegacySendToScope, SCLegacySendToWorkflow, SCLegacySnapchatterServices, SCMatchaSendToWorkflow, SCOptionalScopeExposer, SCSendToLegacyStoryThumbnailProvider, SCSendToLoggingServices, SCSnapKitPartnerAppServices, SCSnapchatterServices;
...
@interface SCLegacySendToScopeEntryPoint : SCEntryPoint
{
    ...
    SCSendToLegacyStoryThumbnailProvider *_storyThumbnailProvider;
...
@property(retain, nonatomic) SCOptionalScopeExposer *sendToScopeExposer; // @synthesize sendToScopeExposer=_sendToScopeExposer;
