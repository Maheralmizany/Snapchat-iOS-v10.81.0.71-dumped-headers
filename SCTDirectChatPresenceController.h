...
- (id)_createPillView;
- (void)_initView;
- (id)initWithParticipant:(id)arg1 avatarServices:(id)arg2 chatServices:(id)arg3 talkUIController:(id)arg4 speechActivityAnnouncer:(id)arg5 useMetalRenderer:(_Bool)arg6 rendererController:(id)arg7;
