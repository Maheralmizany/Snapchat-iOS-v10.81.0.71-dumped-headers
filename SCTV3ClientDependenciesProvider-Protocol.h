...
@class NSNotificationCenter, NSString, SCAppNotification, SCChatViewHeader, SCTV3PresenceContainer, SCUserSession, SIGActionSheet, UIView;
...
- (void)presentAudioRouteActionSheet:(SIGActionSheet *)arg1;
