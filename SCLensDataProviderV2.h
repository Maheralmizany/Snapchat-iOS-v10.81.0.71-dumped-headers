...
@class NSString, SCLens, SCLensBundledLensesStrategy, SCLensDataFetchingMediator, SCLensDataProviderListenerAnnouncer, SCLensMetadataProviderSettings;
@protocol SCBundledLensProvider, SCLensByIdRetrievable, SCLensCarouselBundledLensesGatingStatus, SCLensDataPrefetcher, SCLensDataProviderConfiguration, SCLensMetadataProviderSortStrategy, SCLensMetadataStoreProtocol, SCLensUIUpdateListener;
...
@interface SCLensDataProviderV2 : NSObject <SCTraceEnabled, SCLensMetadataStoreListener, SCLensDataFetchingMediatorDelegate, SCLensCameraScreenDataProviderProtocol, SCLensDataProviderConfigurable>
{
    ...
    SCLensBundledLensesStrategy *_bundledLensesStrategy;
...
- (id)lensesToPresent;
- (id)lenses;
- (void)_forceUpdateSelectedStudioLensIfNeededWithUpdatedLenses:(id)arg1;
...
- (void)warmUp;
- (void)dealloc;
- (id)initWithLensDataFetcher:(id)arg1 lensDataPrefetcher:(id)arg2 metadataStore:(id)arg3 prefetchMetadataStore:(id)arg4 staticAllLensesMetadataStore:(id)arg5 sortStrategy:(id)arg6 lensThumbnailLogger:(id)arg7 bundledLensProvider:(id)arg8 bundledLensesGatingStatus:(id)arg9 configuration:(id)arg10;
- (id)initWithLensDataFetcher:(id)arg1 metadataStore:(id)arg2 staticAllLensesMetadataStore:(id)arg3 sortStrategy:(id)arg4 bundledLensProvider:(id)arg5 bundledLensesGatingStatus:(id)arg6 configuration:(id)arg7;
