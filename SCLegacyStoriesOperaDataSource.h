...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSString, SCContextV2Session, SCLegacyStoriesOperaMediaManager, SCObservable, SCOperaEventListenerAnnouncer, SCOperaPerformanceTrackingPlugin, SCSearchFriendProvider, SCStoriesAutoAdvanceLoader, SCStoryUserProperties, SCStreamingResourceLoader, SCUserSession, Story;
@protocol NavigationDelegate, SCLegacyStoriesOperaDataSourceDelegate, SCOperaLabelTextProvider, SCOperaPlaylistItemController, SCOperaViewModelConnectionsCallbackControlling, SCOperaViewProvider;
...
- (id)initialPlaylistItemIDToDisplay;
