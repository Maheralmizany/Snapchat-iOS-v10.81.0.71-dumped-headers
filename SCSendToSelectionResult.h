...
- (id)initWithMyStorySelected:(_Bool)arg1 myStoryPrivacyOverride:(id)arg2 sharedStoriesSelected:(id)arg3 customStoriesSelected:(id)arg4 friendRecipientsSelected:(id)arg5 groupRecipientsSelected:(id)arg6 quickAddFriendsSelected:(id)arg7 contactSnapchattersSelected:(id)arg8 searchedUsersSelected:(id)arg9 businessProfilesSelected:(id)arg10 appStoriesSelected:(id)arg11;
