...
@class EGORefreshTableHeaderView, NSLock, NSMutableArray, NSMutableDictionary, NSString, PHCachingImageManager, SCSearchBar, SCSnapcodeCell, SCSnapcodeDetailController, SCUserSession, SCWebImageScraperClient, UITableView, UIView;
