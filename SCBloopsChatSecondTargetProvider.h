...
@protocol SCBloopsChatSecondTargetProviderDelegate, SCBloopsUserIdsProviding;
...
@interface SCBloopsChatSecondTargetProvider : NSObject <SCBloopsAPIListener>
{
    ...
    NSArray *_secondTargetCandidates;
}

@property(retain, nonatomic) NSArray *secondTargetCandidates; // @synthesize secondTargetCandidates=_secondTargetCandidates;
