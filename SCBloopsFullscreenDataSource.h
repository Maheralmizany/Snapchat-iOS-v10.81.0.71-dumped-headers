...
- (void).cxx_destruct;
- (id)_bloopModelForReenactmentResult:(id)arg1;
...
- (id)pageIndexForModelWithReenactmentResult:(id)arg1;
- (void)setFailForBloopModel:(id)arg1;
- (void)updateWithBloopsReenactmentResult:(id)arg1 withFullscreenViewOutput:(id)arg2;
