...
@protocol SCLongformShowOperaDataSourceDelegate, SCOperaMediaManager, SCOperaPlaylistItemController, SCStreamingURLProviding;
...
@interface SCLongformShowOperaDataSource : NSObject <SCImpalaWatchedStateUpdateListener, SCOperaPlaylistDataSource>
{
    ...
    id <SCLongformShowOperaDataSourceDelegate> _delegate;
...
@property(nonatomic) __weak id <SCLongformShowOperaDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)dealloc;
- (id)initWithUserSession:(id)arg1 mediaManager:(id)arg2 operaNavigationStyle:(long long)arg3;
