...
@class LSALocationParams, NSString, SCFeatureSettingsService, SCUserSession;
...
@property(retain, nonatomic) SCFeatureSettingsService *featureSettingsService; // @synthesize featureSettingsService=_featureSettingsService;
- (void).cxx_destruct;
