...
@class NSString, NSTimer, SCCognacAdDataSource, SCCognacAdRules, SCCognacAdSDKInfo, SCCognacAdsListenerAnnouncer, SCCognacOperaPlaylistSoftMutePlugin, SCEventListenerAnnouncer, SCOperaPresenter, SCQueueWithCapacity, SCUserSession;
...
@interface SCCognacConcreteAdsManager : NSObject <SCOperaPresenterDelegate, SCCognacAdsManager>
{
    ...
    SCEventListenerAnnouncer *_cognacDataUpdateAnnouncer;
    SCCognacOperaPlaylistSoftMutePlugin *_softMutePlugin;
}
...
- (void)initializeAdsWithRules:(id)arg1 sdkInfo:(id)arg2 cognacDataUpdateAnnouncer:(id)arg3;
