...
@interface SCSendFlowLogAggregator : NSObject
{
    ...
    NSMutableDictionary *_batchTaskIdToMessageIds;
}

- (void).cxx_destruct;
- (id)_timelineForMessageId:(id)arg1 createIfMissing:(_Bool)arg2;
- (void)_cleanupTimelineForMessageId:(id)arg1;
- (void)_cleanupTimelinesForBatchTaskId:(id)arg1;
- (void)_flushTemporaryTimestampsForMediaId:(id)arg1;
- (void)_storeTimestamp:(id)arg1 forMediaId:(id)arg2;
- (void)_associateMessageId:(id)arg1 toBatchTaskId:(id)arg2;
...
- (void)setArroyoGroupConversationIds:(id)arg1 forMessageId:(id)arg2;
- (void)setFsnGroupConversationIds:(id)arg1 forMessageId:(id)arg2;
- (void)setRecipientTypeToCount:(id)arg1 forMessageId:(id)arg2;
- (void)setMetadata:(id)arg1 forMessageId:(id)arg2;
- (void)registerBatchTaskId:(id)arg1;
