...
@interface SCOperaWebAppImageResources : NSObject <NSCopying>
{
    ...
    SCNetworkImage *_horizontalImage;
}

@property(readonly, copy, nonatomic) SCNetworkImage *horizontalImage; // @synthesize horizontalImage=_horizontalImage;
...
- (id)initWithIconImage:(id)arg1 loadingImage:(id)arg2 logoImage:(id)arg3 horizontalImage:(id)arg4;
