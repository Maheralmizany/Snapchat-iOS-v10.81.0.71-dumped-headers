...
@protocol SCCognacImpressionTrackingDelegate;
...
@interface SCCognacImpressionTracker : NSObject <SCCognacImpressionTracking>
{
    ...
    id <SCCognacImpressionTrackingDelegate> _delegate;
}

@property(nonatomic) __weak id <SCCognacImpressionTrackingDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
