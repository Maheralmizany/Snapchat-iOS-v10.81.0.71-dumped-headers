...
@class NSMutableArray, NSString, SCFeatureSettingsService, SCNotificationSettingsContext, SCNotificationSettingsLogger, SCSettingsSwitchTableViewCell, SCSettingsTextTableViewCell, SCUserSession, UITableView, UIView;
