...
@property(readonly, nonatomic) SCLongformShowOperaSession *longformShowSession; // @synthesize longformShowSession=_longformShowSession;
- (void).cxx_destruct;
...
- (id)type;
- (id)initWithUserSession:(id)arg1 navigationDelegate:(id)arg2 viewLocation:(long long)arg3 operaNavigationStyle:(long long)arg4;
