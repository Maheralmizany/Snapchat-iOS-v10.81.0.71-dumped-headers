...
- (id)initWithMediaURL:(id)arg1 mediaKey:(id)arg2 postParameters:(id)arg3 authenticated:(_Bool)arg4 requestContexts:(id)arg5 encryptionInfo:(id)arg6 trackingInfo:(id)arg7 manifestSnapTokenAccessType:(id)arg8 traceID:(id)arg9;
