...
@interface SOJUMessageStateMessage : SCSojuMessage <SOJUMessageStateMessage>
{
}
...
@property(readonly, nonatomic) NSString *chatMessageSenderId; // @dynamic chatMessageSenderId;
