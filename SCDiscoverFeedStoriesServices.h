...
- (void).cxx_destruct;
- (id)initWithDiscoverFeedFriendStoriesDataCoordinator:(id)arg1 publisherStoriesMetadataCoordinator:(id)arg2 replayManager:(id)arg3 discoverFeedDataCoordinator:(id)arg4 discoverFeedBadgeCoordinator:(id)arg5 discoverFeedBadgeReadyStateManager:(id)arg6;
