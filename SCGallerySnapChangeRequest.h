...
@class NSArray, NSDate, NSNumber, NSString, SCCDGallerySnap, SCObjectPlaceholder, SOJUGalleryServletSensorBlob, SOJUStoryFrame;
...
@property(copy, nonatomic) NSArray *sojuSnapAssets;
@property(copy, nonatomic) NSNumber *sojuMediaType;
@property(copy, nonatomic) NSString *snapId;
@property(copy, nonatomic) NSArray *snapAssets;
