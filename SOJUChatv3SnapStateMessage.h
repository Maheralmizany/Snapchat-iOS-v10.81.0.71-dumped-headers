...
@interface SOJUChatv3SnapStateMessage : SCSojuMessage <SOJUChatv3SnapStateMessage>
{
}
...
@property(readonly, nonatomic) NSNumber *chatMessageSeqNum; // @dynamic chatMessageSeqNum;
...
@property(readonly, nonatomic) NSNumber *openTimestamp; // @dynamic openTimestamp;
...
@property(readonly, nonatomic) NSString *senderChatMediaId; // @dynamic senderChatMediaId;
