...
@class NSString, SCCORECompositeStoryId, SCSSMCardDebugInfo, SCSSMClientDisplayInfo, SCSSMClientRankingFeatures, SCSSMCognacCard, SCSSMJaguarClientLogging, SCSSMLensCategoryCard, SCSSMLensChallengeCard, SCSSMLensChallengeStoryCard, SCSSMLensObjectCard, SCSSMMapTileCard, SCSSMMomentStoryCard, SCSSMOurStoryCard, SCSSMPivotCard, SCSSMPromotedStoryCard, SCSSMPublicUserStoryCard, SCSSMPublisherStoryCard, SCSSMSelectionCard, SCSSMSoloStoryCard, SCSSMStoryCard_TapAction, SCSSMTopicStoryCard, SCSSMUserStoryCard;
...
@property(retain, nonatomic) SCSSMTopicStoryCard *topicStoryCard; // @dynamic topicStoryCard;
