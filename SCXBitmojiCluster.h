...
@class NSArray, NSURL, SCStoriesThumbnailInfo, SCXBitmojiLabel, SCXCallout;
...
@interface SCXBitmojiCluster : NSObject <NSCopying>
{
    ...
    SCStoriesThumbnailInfo *_storyThumbnailInfo;
...
@property(readonly, nonatomic) SCStoriesThumbnailInfo *storyThumbnailInfo; // @synthesize storyThumbnailInfo=_storyThumbnailInfo;
...
- (id)initWithCenterCoordinate:(struct CLLocationCoordinate2D)arg1 bitmojis:(id)arg2 floorImageURL:(id)arg3 propImageURL:(id)arg4 callout:(id)arg5 bitmojiLabel:(id)arg6 friendStoryThumbnailInfo:(id)arg7 enlarged:(_Bool)arg8 depressed:(_Bool)arg9 crowd:(_Bool)arg10;
