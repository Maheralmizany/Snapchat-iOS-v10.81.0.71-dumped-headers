...
- (id)initWithGroupName:(id)arg1 participants:(id)arg2 usernameToParticipantsMap:(id)arg3 userIdToParticipantsMap:(id)arg4 hasUnexemptBlockedParticipants:(_Bool)arg5;
