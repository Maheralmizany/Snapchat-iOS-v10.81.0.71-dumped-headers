...
@interface SOJUUnlockablesOndemandFenceRequirements : SCSojuMessage <SOJUUnlockablesOndemandFenceRequirements>
{
}
...
@property(readonly, nonatomic) NSNumber *maxCoordinates; // @dynamic maxCoordinates;
