...
- (id)initWithOriginType:(long long)arg1 source:(long long)arg2 productId:(id)arg3 storeId:(id)arg4 editionId:(id)arg5 discoverSessionId:(id)arg6 publisherId:(id)arg7 snapId:(id)arg8;
