...
@property(nonatomic) double audioOutputVolume; // @synthesize audioOutputVolume=_audioOutputVolume;
@property(retain, nonatomic) NSMutableDictionary *adIdentifierToViewngStatusMap; // @synthesize adIdentifierToViewngStatusMap=_adIdentifierToViewngStatusMap;
- (void).cxx_destruct;
