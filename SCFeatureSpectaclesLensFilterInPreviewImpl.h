...
@class NSArray, NSString, SCDisposableObserverLifecycle, SCFeatureReference, SCLens, SCLensInPreviewUsageNotifier, SCLensInfoController, SCLensInfoViewModel, SCLensUIUpdateListenerAnnouncer, SCObservable, SCPreferences, SCPreviewConfiguration, SCPreviewView, SCSmartCarouselFilterArranger, SCSnapCommonLoggingParameters, SCSpectaclesAuxiliaryContentStore;
@protocol SCFeatureSpectaclesLensFilterInPreviewDelegate, SCLensCameraScreenDataProviderProtocol, SCLensIconInMemoryCache, SCLensLogger, SCLensUIUpdateListener, SCPreviewLensDataProviderFactoryProtocol;
...
- (void)_updateFilterStackingIcon;
- (void)_tryScrollFilterViewAndApplyLensWithIndex:(unsigned long long)arg1;
- (void)_tryCreateLensFilterWithLens:(id)arg1;
- (void)_loadLensDataIfAllLensesFetched;
...
- (_Bool)_isPrimaryDepthAvailable;
...
- (_Bool)allowTapGestureForLens;
- (_Bool)blockGesturesForLens;
- (void)applyPendingLensAfterMagicMomentDisabledIfNeed;
- (void)swipeAndApplyLensIfNeeded:(id)arg1;
