...
@class NSArray, NSString, SCBehaviorSubject, SCCaptureScope, SCDisposableObserverLifecycle, SCObservable;
...
- (void)beginWorkflow;
- (id)initWithDelegate:(id)arg1 captureWorkflowResultDelegate:(id)arg2 captureWorkflowPageRouter:(id)arg3 cameraViewConfigurationController:(id)arg4 cameraViewControllerLifecycleEvents:(id)arg5 applicationLifecycleEvents:(id)arg6 captureScope:(id)arg7;
