...
@protocol SCCognacLoadingProgressTracking;
...
@interface SCInSettingSupportDataProvider : NSObject <SCCognacSettingsDataProviding>
{
    ...
    id <SCCognacLoadingProgressTracking> _cognacLoadingProgressTracker;
}

@property(nonatomic) __weak id <SCCognacLoadingProgressTracking> cognacLoadingProgressTracker; // @synthesize cognacLoadingProgressTracker=_cognacLoadingProgressTracker;
- (void).cxx_destruct;
- (id)_miniOptionsListCellViewModels;
- (id)miniOptionsSectionViewModels;
