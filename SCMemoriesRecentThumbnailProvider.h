...
#import "SCMemoriesRecentThumbnailProviding-Protocol.h"
...
@interface SCMemoriesRecentThumbnailProvider : NSObject <SCMemoriesMergedDataSourceListener, SCMemoriesRecentThumbnailProviding>
{
...
@property(readonly, nonatomic) NSMutableArray *recentThumbnails; // @synthesize recentThumbnails=_recentThumbnails;
- (void).cxx_destruct;
