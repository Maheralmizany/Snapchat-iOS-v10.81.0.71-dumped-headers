...
@class SCBitmojiFetchServices, SCBitmojiSelfieServices, SCServicesExposer, SCSnapProServices, SCUserInfoServices, SCUserSessionScope, SCUserTooltipStatusServices;
...
- (void).cxx_destruct;
- (id)_legacyFeedHeaderPromptStateAdaptor;
- (void)begin;
