...
@class NSArray, NSAttributedString, NSString, SCActionModel;

@interface SCChatTextContentViewModel : NSObject <SCSavableTextChatCellViewConfig, SCChatUIContentRenderable, NSCopying>
{
    ...
    SCActionModel *_cellWillDisplayAction;
}

@property(readonly, copy, nonatomic) SCActionModel *cellWillDisplayAction; // @synthesize cellWillDisplayAction=_cellWillDisplayAction;
...
- (id)initWithRawText:(id)arg1 attributedText:(id)arg2 chatLabelHeight:(double)arg3 mediaCardsHeight:(double)arg4 contentWidth:(double)arg5 mediaCards:(id)arg6 shouldShowChatLabel:(_Bool)arg7 reuseIdentifier:(id)arg8 contentHeight:(double)arg9 externalTapAction:(id)arg10 externalLongPressAction:(id)arg11 cellWillDisplayAction:(id)arg12;
