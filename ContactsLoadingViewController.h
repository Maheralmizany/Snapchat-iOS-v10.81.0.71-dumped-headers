...
@class DancingGhostImageView, NSString, SCButton, UIButton, UILabel, UIView;
...
@property(retain, nonatomic) SCButton *loadingFailedButton; // @synthesize loadingFailedButton=_loadingFailedButton;
