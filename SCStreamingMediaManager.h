...
@protocol SCStreamingDelegate, SCStreamingRequestExtraInfoProviding, SCStreamingResponseCaching><SCStreamingResponseCacheObserving, SCStreamingZipDataCaching, SCWebProxyRequestHandling;

@interface SCStreamingMediaManager : NSObject
{
    id <SCStreamingResponseCaching><SCStreamingResponseCacheObserving> _responseCache;
