...
#import "SCPromotedStoriesLogging-Protocol.h"

@class NSMutableDictionary, NSMutableSet, NSNumber, NSString, SCQueuePerformer;

@interface SCCheetahPromotedStoriesLogger : NSObject <SCPromotedStoriesLogging>
{
