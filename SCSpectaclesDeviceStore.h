...
@class NSArray, NSDictionary, NSMutableDictionary, NSString, SCSpectaclesCache, SCSpectaclesDeviceNamer, SCSpectaclesEventListenerAnnouncer, SCSpectaclesSensorStore;
...
- (void)_setupInternalDevicesWithUnarchivedDevices:(id)arg1 centralManager:(id)arg2;
- (id)_readArchivedDevices;
- (void)retrieveArchivedDevicesWithCentralManager:(id)arg1;
- (void)archiveDevices;
- (void)_archiveDevicesForced:(_Bool)arg1;
- (void)_updateRequiredFirmwareStatus:(id)arg1;
- (void)_clearDevices;
- (void)_archiveDevicesToCache:(id)arg1;
- (void)dealloc;
- (id)initWithAnnouncer:(id)arg1 cache:(id)arg2 namer:(id)arg3 analyticsLogger:(id)arg4 crashLogger:(id)arg5 tweaksConfigProvider:(id)arg6 sensorStore:(id)arg7;
