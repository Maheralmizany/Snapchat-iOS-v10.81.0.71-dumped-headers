...
- (id)initWithBrandFriendliness:(long long)arg1 adPlacement:(id)arg2 adCanFollow:(_Bool)arg3 isSponsered:(_Bool)arg4 sponsor:(id)arg5 sponsoredSlug:(id)arg6 isPetraBrandSafe:(_Bool)arg7;
