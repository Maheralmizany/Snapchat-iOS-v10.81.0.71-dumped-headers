...
@class GPBInt64Array, HappeningNowHoroscope, NSMutableArray, NSString, SCSCOREGeoLocation, SCSSMAppInfo, SCSSMConnectionInfo, SCSSMDeviceInfo, SCSSMUserRecentInteractionsHistory, SCSSMUserRecentTapHistory;
...
@property(nonatomic) _Bool hasHoroscope; // @dynamic hasHoroscope;
...
@property(retain, nonatomic) HappeningNowHoroscope *horoscope; // @dynamic horoscope;
