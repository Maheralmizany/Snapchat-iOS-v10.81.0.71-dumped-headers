...
@class NSString, SCCognacAppViewLifeCycleListenerAnnouncer, SCCognacBlizzardEventLoggingController, SCCognacDataStorage, SCCognacOperaDataSource, SCCognacServiceCoordinator, SCCognacSnapchatterService, SCOperaEventListenerAnnouncer, SCPreferences, UIViewController;
@protocol SCCognacPresentLeaderboardOperationDelegate, SCImageDownloading;

@interface SCCognacPresentLeaderboardOperation : SCCognacCypressRequestOperation
{
...
@property(retain, nonatomic) SCOperaEventListenerAnnouncer *operaEventAnnouncer; // @synthesize operaEventAnnouncer=_operaEventAnnouncer;
