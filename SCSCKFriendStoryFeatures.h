...
@class EngagementFeatures, FriendMetadataFeatures, SCSCKFriendLinkFeatures, SCSCKFriendStoryClientEngagementFeatures, SCSCKFriendStoryDerivedEngagementFeatures, SCSCKFriendStoryMetadataFeatures, SCSCKFriendStoryNotificationFeatures, SCSCKFriendStoryPosterEngagementFeatures;
...
@property(retain, nonatomic) SCSCKFriendLinkFeatures *friendLinkFeatures; // @dynamic friendLinkFeatures;
@property(retain, nonatomic) FriendMetadataFeatures *friendMetadataFeatures; // @dynamic friendMetadataFeatures;
...
@property(retain, nonatomic) SCSCKFriendStoryNotificationFeatures *friendStoryNotificationFeatures; // @dynamic friendStoryNotificationFeatures;
...
@property(nonatomic) _Bool hasFriendLinkFeatures; // @dynamic hasFriendLinkFeatures;
@property(nonatomic) _Bool hasFriendMetadataFeatures; // @dynamic hasFriendMetadataFeatures;
...
@property(nonatomic) _Bool hasFriendStoryNotificationFeatures; // @dynamic hasFriendStoryNotificationFeatures;
