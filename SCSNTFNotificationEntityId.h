...
@class SCSNTFHNNewsSection, SCSNTFLiveStreamId, SCSNTFOurStoryId, SCSNTFPublisherStoryId, SCSNTFUserStoryId;
...
@property(retain, nonatomic) SCSNTFHNNewsSection *hnNewsSection; // @dynamic hnNewsSection;
