...
@interface SOJUTalkCallingRequest : SCSojuMessage <SOJUTalkCallingRequest>
{
}
...
@property(readonly, nonatomic) NSString *medium; // @dynamic medium;
@property(readonly, nonatomic) NSString *reqToken; // @dynamic reqToken;
@property(readonly) Class superclass;
@property(readonly, nonatomic) NSString *talkCorePayload; // @dynamic talkCorePayload;
