...
@class MainViewController, NSString, SCMapViewController, SCUserSession, UIPanGestureRecognizer, UIView, UIViewController;
@protocol NavigationDelegate, SCMapTransitionAnimator;

@interface SCMapPresenter : NSObject <SCMapTransitionAnimatorDelegate, SCMapViewControllerDelegate, SCTraceEnabled, UIGestureRecognizerDelegate, SCMapPullDownTransitionDelegate, SCMapPresenter>
{
    ...
    _Bool _presentationAnimatorDidBegin;
    _Bool _gestureDidFinishSuccessfully;
