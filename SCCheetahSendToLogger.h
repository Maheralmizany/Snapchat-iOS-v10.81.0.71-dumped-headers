...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSString, SCARankingSessionMetadata, SCEventListenerAnnouncer, SCLazy, SCSelectionTracker, SCSendToConfiguration, SCSendToDocObjectRecipientDataSource;
@protocol SCSendToStoriesDataSource;

@interface SCCheetahSendToLogger : NSObject <SCLegacySendToLogger>
{
...
- (void).cxx_destruct;
- (id)_appStorySendToMetadataMap:(id)arg1;
...
- (id)initWithRecipientDataSource:(id)arg1 storiesDataSource:(id)arg2 listsDataFetcher:(id)arg3 sessionId:(id)arg4 configuration:(id)arg5;
