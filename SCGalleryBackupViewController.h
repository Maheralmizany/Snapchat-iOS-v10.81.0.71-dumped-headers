...
@class NSArray, NSString, NSTimer, SCCloudSyncOperation, SCFeatureSettingsService, SCGalleryBackupFailedView, SCGradientView, SCHeader, SCLoadingIndicatorView, SCUserSession, UIButton, UILabel, UIProgressView, UITextView, UIView;
@protocol SCCanceling, SCObserving;

@interface SCGalleryBackupViewController : SCGalleryLeftSwipableViewController <SCHeaderDelegate, SCHeaderDataSource, SCNetworkConnectivityListener, SCCloudSyncStatusListener, SCTraceEnabled, SIGDialogDelegate, SCPageNameLogging>
{
