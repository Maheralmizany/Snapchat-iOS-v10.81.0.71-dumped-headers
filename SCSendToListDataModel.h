...
- (id)initWithListId:(id)arg1 name:(id)arg2 snapchatterDisplayNames:(id)arg3 groupDisplayNames:(id)arg4 snapchatterUserIds:(id)arg5 groupIds:(id)arg6 creationTimestamp:(double)arg7;
