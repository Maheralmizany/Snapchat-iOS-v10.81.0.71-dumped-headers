...
@class CAShapeLayer, NSString, SCActionModel, SCDiscoverFeedDebugView, SCEventListenerAnnouncer, SCLazy, SCNetworkImageView, SCRoundedCornerContainerView, UILabel, UITapGestureRecognizer, UIView;
@protocol SCActionHandling, SCImageDownloading;

@interface SCPremiumContentHNNewsStoryCollectionViewCell : UICollectionViewCell <UIGestureRecognizerDelegate, SCEventAnnouncing, SCEventListener, SCViewModelConfigurable, SCActionable, SCViewportConfigurable, SCDiscoverFeedStoryTileWithCoverImageConfigurable, SCDiscoverFeedCollectionViewCellAnimating>
{
    ...
    CAShapeLayer *_circularStatusViewShapeLayer;
    UILabel *_categoryLabel;
    UILabel *_timestampLabel;
    UIView *_readIndicatorView;
...
- (void)_updateLogoWithCurrentViewModel;
- (double)updatedWidthForLogoFrameForCurrentDisplayedImage;
- (_Bool)_isCurrentPublisherStoryJustRead;
