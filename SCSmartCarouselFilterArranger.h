...
#import "SCPreviewFilterCarouselOrderProviding-Protocol.h"

@class NSMutableArray, NSMutableDictionary, NSString, SCExperimentManager, SCFilterCarouselLoggingParameters, SCPreviewFilterCarouselOrderUpdateListenerAnnouncer, SCSmartCarouselStackingManager, SCSmartCarouselSwipeOrder;
...
@interface SCSmartCarouselFilterArranger : NSObject <SCPreviewFilterCarouselOrderProviding>
{
    ...
    SCPreviewFilterCarouselOrderUpdateListenerAnnouncer *_filterCarouselOrderUpdateListenerAnnouncer;
    _Bool _isSnap3D;
