...
@interface SCLensLayoutProvider : NSObject
{
    ...
    double _sponsoredSlugVerticalMargin;
...
@property(readonly, nonatomic) double sponsoredSlugVerticalMargin; // @synthesize sponsoredSlugVerticalMargin=_sponsoredSlugVerticalMargin;
...
- (void).cxx_destruct;
- (id)initWithItemDimension:(double)arg1 selectedItemDimension:(double)arg2 collectionViewReusableIdentifier:(id)arg3 collectionViewBottomOffset:(double)arg4 collectionViewHeight:(double)arg5 parentViewFrame:(struct CGRect)arg6 sponsoredSlugOffset:(double)arg7 sponsoredSlugVerticalMargin:(double)arg8 cutoutMaskEnabled:(_Bool)arg9;
