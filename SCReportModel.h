...
@class NSData, NSNumber, NSString, SCChatMediaContent, SCLens, SCReportStoryMetadataParams;
@protocol SCChatRenderingMessage, SCReportStoryDataParamsProvider;
...
@interface SCReportModel : NSObject
{
    ...
    NSString *_reasonId;
    id <SCChatRenderingMessage> _chatMessage;
...
@property(copy, nonatomic) NSString *bloopId; // @synthesize bloopId=_bloopId;
...
@property(retain, nonatomic) id <SCChatRenderingMessage> chatMessage; // @synthesize chatMessage=_chatMessage;
...
- (id)clusterId;
- (id)reportTypeString;
- (void)prepareBloopsReportWithBloopId:(id)arg1;
...
- (void)prepareStoryReportWithReportStoryDataParams:(id)arg1 source:(unsigned long long)arg2 reportType:(long long)arg3;
- (void)prepareStoryReport:(id)arg1 source:(unsigned long long)arg2;
- (void)prepareChatMessageReport:(id)arg1 username:(id)arg2 mediaContent:(id)arg3;
