...
@class NSData, NSString, SCCheetahPublicUserStory, SCDiscoverFeedActionSheetNotificationStatusManager, SCDiscoverFeedSubscribeStatusManager, SCExperimentManager, SCScopedAccess, SCSnapchatter;
...
- (id)_actionSheetViewModelForSnapchatter:(id)arg1 publicUserStory:(id)arg2;
- (void)reload;
