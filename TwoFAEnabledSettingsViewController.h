...
@class NSString, SCLoadingScreen, SCSettingsSwitchTableViewCell, SCUserInfoServices, SCUserSession, UILabel, UITableView;
...
- (void).cxx_destruct;
- (id)_formattedMobile;
- (id)_getSMSInstructionText;
- (_Bool)_hasValidMobile;
...
- (void)loadView;
- (id)initWithPageViewName:(id)arg1 title:(id)arg2 leftSwipeable:(_Bool)arg3 userSession:(id)arg4 userInfoServices:(id)arg5;
