...
@class NSString, SCFuture, SCLazy;
@protocol SCApplicationDataChecker, SCAuthenticationRouter, SCLegacyAuthFlowProxy, SCPerforming, SCTransitionMomentLogger, SCUserSessionRepository;
...
@interface SCAuthenticationWorkflow : NSObject <SCDataUnavailableWorkflowDelegate, SCUnauthenticatedWorkflowDelegate, SCUserSessionWorkflowDelegate>
{
    ...
    NSString *_currentUserSessionUserId;
    NSString *_previousUserSessionUserId;
    SCFuture *_previousUserSessionCleanUp;
}
...
- (void)_beginUserSessionWorkflowWithUserSession:(id)arg1 context:(id)arg2;
...
- (void)beginWorkflow;
- (id)initWithApplicationDataChecker:(id)arg1 userSessionRepository:(id)arg2 legacyAuthFlowProxy:(id)arg3 router:(id)arg4 deviceLevelABfetcher:(id)arg5 transitionMomentLogger:(id)arg6 performer:(id)arg7;
