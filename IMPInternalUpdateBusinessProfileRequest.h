...
@property(nonatomic) _Bool hasIsBrandProfile; // @dynamic hasIsBrandProfile;
@property(nonatomic) _Bool hasIsLensCreator; // @dynamic hasIsLensCreator;
...
@property(retain, nonatomic) IMPUpdateBool *isBrandProfile; // @dynamic isBrandProfile;
@property(retain, nonatomic) IMPUpdateBool *isLensCreator; // @dynamic isLensCreator;
