...
@class NSArray, NSObject, NSString, SOJUSticker, UIImage;
@protocol OS_dispatch_queue, SCCanceling, SCStickerProtocol;

@protocol SCChatStickerImageFetching <NSObject>
- (void)resetCache;
- (void)fetchUnlockableStickerPackPreviewImageWithUrl:(NSString *)arg1 completionQueue:(NSObject<OS_dispatch_queue> *)arg2 completionBlock:(void (^)(UIImage *))arg3;
- (void)getSnapReplyStickerImageFromStickerId:(NSString *)arg1 completion:(void (^)(UIImage *))arg2;
- (NSString *)snapReplyStickerIdForImage:(UIImage *)arg1;
