...
@class NSString, SCCapturerToken, SCLazy, SCLens, SCLongPressGestureRecognizer, SCOnDemandGeofilterPillButton, SCOnDemandLensAllTimeHitsDataProvider, SCOnDemandLensDataProvider, SCOnDemandLensDataStore, SCOnDemandLensDiscoveryViewController, SOJUUnlockablesOndemandTemplateCategory, UITapGestureRecognizer, UIView;
...
@interface SCOnDemandLensViewController : UIViewController <UIGestureRecognizerDelegate, SCLensUserInterfaceDelegate, SCLensUIUpdateListener, SCOnDemandLensDiscoveryViewControllerDelegate, SCLensDataProviderListener, SCFeatureToggleCameraButtonDelegate, SCOnDemandLensViewControllerProtocol, SCCameraLiveDisplayCustomer>
{
    ...
    SCOnDemandLensAllTimeHitsDataProvider *_lensAllTimeHitsDataProvider;
    SCOnDemandLensDataProvider *_lensDataProvider;
    SCOnDemandLensDataStore *_lensDataStore;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithGeofilterSession:(id)arg1 templateCategory:(id)arg2 lensDataStore:(id)arg3 lensDataProvider:(id)arg4 lensAllTimeHitsDataProvider:(id)arg5 lensViewController:(id)arg6 carouselParentView:(id)arg7 managedCapturer:(id)arg8 lensLogger:(id)arg9;
