...
#import "SCSpectaclesContextNotificationTaskHandler-Protocol.h"
#import "SCSpectaclesDeviceStoreDelegate-Protocol.h"
#import "SCSpectaclesManaging-Protocol.h"
#import "SCSpectaclesManagingDeviceList-Protocol.h"
#import "SCSpectaclesManagingTweaks-Protocol.h"
#import "SCSpectaclesManagingUIAutomation-Protocol.h"

@class NSNumber, NSString, SCLazy, SCSpectaclesCache, SCSpectaclesDataFlowsManager, SCSpectaclesDeviceNamer, SCSpectaclesDeviceStore, SCSpectaclesEventListenerAnnouncer, SCSpectaclesPairingManager, SCSpectaclesProfile, SCSpectaclesSensorStore, SCSpectaclesWifiController;
...
@interface SCSpectaclesManager : NSObject <SCSpectaclesManagingTweaks, SCSpectaclesManagingUIAutomation, SCSpectaclesManagingDeviceList, SCSpectaclesDeviceStoreDelegate, SCCacheClearing, SCSpectaclesContextNotificationTaskHandler, SCSpectaclesManaging>
{
    SCSpectaclesProfile *_spectaclesProfile;
    SCSpectaclesDataFlowsManager *_dataFlowsManager;
    SCSpectaclesWifiController *_wifiController;
    SCSpectaclesSensorStore *_sensorStore;
    NSNumber *_bluetoothOverrideOn;
...
@property(retain, nonatomic) NSNumber *bluetoothOverrideOn; // @synthesize bluetoothOverrideOn=_bluetoothOverrideOn;
- (void).cxx_destruct;
- (void)wifiControllerDismissWifiView;
- (void)wifiControllerCancelWifiConnection;
- (id)wifiController;
- (id)dataFlowsManager;
- (id)managerUIAutomation;
- (id)managerTweaks;
- (id)managerPairing;
- (id)managerDeviceList;
...
- (unsigned long long)numberOfUntransferredHDContentWithDevice:(id)arg1;
...
- (void)initiateDataFlowWithRequest:(id)arg1;
...
- (void)sendAccessTokenForDevice:(id)arg1 accessToken:(id)arg2 refreshToken:(id)arg3 expirationTimeMs:(long long)arg4 userId:(id)arg5;
...
- (id)getOverrideBluetoothOn;
- (void)setOverrideBluetoothOn:(id)arg1;
