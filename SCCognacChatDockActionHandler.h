...
- (void).cxx_destruct;
- (void)_openAppWithAppId:(id)arg1 conversationId:(id)arg2 context:(unsigned long long)arg3 shareInfo:(id)arg4;
- (void)didTapOnAppShareMessageView:(id)arg1;
- (void)didTapOnCognacMessageViewButton:(id)arg1;
- (void)_openAppWithAppInstance:(id)arg1 context:(unsigned long long)arg2 shareInfo:(id)arg3;
