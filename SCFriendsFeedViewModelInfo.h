...
@class NSString, SCAvatarAccessoryIcon, SCFriendsFeedComponentViewRightButtonViewModel, SCFriendsFeedFriendmojiViewModel, SCFriendsFeedItem;
...
@interface SCFriendsFeedViewModelInfo : NSObject <NSCopying>
{
    ...
    NSString *_displayPrefix;
}

@property(readonly, copy, nonatomic) NSString *displayPrefix; // @synthesize displayPrefix=_displayPrefix;
...
- (id)initWithFriendsFeedItem:(id)arg1 isStoryReplayable:(_Bool)arg2 canShowDoubleTapToReply:(_Bool)arg3 isReplayingSnap:(_Bool)arg4 tooltipState:(long long)arg5 isJustViewedSnap:(_Bool)arg6 rightButtonViewModel:(id)arg7 friendmojiViewModel:(id)arg8 sublabelFriendmojiViewModel:(id)arg9 avatarAccessoryIcon:(id)arg10 displayPrefix:(id)arg11;
