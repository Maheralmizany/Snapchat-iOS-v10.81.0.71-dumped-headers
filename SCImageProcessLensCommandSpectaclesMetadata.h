...
- (void).cxx_destruct;
- (id)initWithMediaType:(unsigned long long)arg1 fieldOfView:(float)arg2 imuData:(id)arg3 depthData:(id)arg4 primaryCameraLookupTable:(id)arg5 secondaryCameraLookupTable:(id)arg6 calibrationFilePath:(id)arg7 skyClassifierPath:(id)arg8 magicMomentEnabled:(_Bool)arg9;
