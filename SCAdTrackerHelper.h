...
- (void)_swipedFromTopSnap:(_Bool)arg1 adResponse:(id)arg2 snapIndex:(long long)arg3 adViewContext:(id)arg4 adSessionId:(id)arg5 context:(id)arg6 params:(id)arg7 petraReportingInfo:(id)arg8 attachmentTriggerType:(long long)arg9;
...
- (void)didSwipeUpOnCard:(id)arg1 snapIndex:(long long)arg2 params:(id)arg3;
- (void)onHide:(id)arg1 adViewContext:(id)arg2 snapIndex:(long long)arg3 context:(id)arg4 fromSwipeUp:(_Bool)arg5 petraReportingInfo:(id)arg6;
...
- (void)updateTopSnapViewTimeWithContext:(id)arg1 params:(id)arg2 adRequestClientId:(id)arg3 snapIndex:(long long)arg4 topSnapBackgroundType:(unsigned long long)arg5;
- (_Bool)trackCloseViewEventWithContext:(id)arg1 adViewContext:(id)arg2 params:(id)arg3 adResponse:(id)arg4 lastInteraction:(id)arg5 snapIndex:(long long)arg6 adSessionId:(id)arg7 topSnapBackgroundType:(unsigned long long)arg8 petraReportingInfo:(id)arg9 navigationStyle:(long long)arg10;
- (void)trackOpenViewLoadedEventWithAdRequestClientId:(id)arg1 adMediaTrackingKeys:(id)arg2 context:(id)arg3 lastInteraction:(id)arg4 snapIndex:(long long)arg5 isUnSkippableAd:(_Bool)arg6 adResponse:(id)arg7 isTopPanelOpen:(_Bool)arg8 isBottomPanelOpen:(_Bool)arg9 navigationStyle:(long long)arg10 lastNavigationEvent:(id)arg11;
