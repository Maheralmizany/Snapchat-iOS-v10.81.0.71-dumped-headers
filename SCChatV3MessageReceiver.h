...
@protocol SCChatConversationBatchFetching, SCChatConversationFetcher, SCChatLogger, SCChatMessageActionHandling, SCFideliusUnwrapProtocol, SCGroupManager, SCPerforming, SCSnapLogger, SCUserHelperProtocol;

@interface SCChatV3MessageReceiver : NSObject <SCTraceEnabled, SCChatMessageReceiveListener, SCChatV3ConversationFetcherHandler>
{
