...
@property(nonatomic) int snapsViewed;
...
@property(nonatomic) _Bool seenInCarousel;
...
@property(copy, nonatomic) NSDate *latestSnapCaptureTimeUtc;
...
- (void)updateDateRangeWithServletGallerySnaps:(id)arg1;
- (id)_dateFromServletTime:(long long)arg1;
