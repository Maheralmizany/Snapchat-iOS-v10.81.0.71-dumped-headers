...
@class NSString, SC3DBitmojiMetadataStore, SCLensBitmojiAssetDataFetcher, SCLensBitmojiListManager, SCLensBlobDataFetcher, SCLensContentDataFetcher, SCLensSecurity;
@protocol SCBitmojiImageFetcher, SCLensDownloadLogger, SCLensIconInMemoryCache, SCLensPreferences, SCLensRemoteAssetLoggerProtocol, SCLensRemoteAssetsLensResourceResolver, SCLensUserProvider;
...
@interface SCLensDownloadOperationFactory : NSObject <SCTraceEnabled>
{
    ...
    SCLensBitmojiAssetDataFetcher *_bitmojiAssetDataFetcher;
...
@property(retain, nonatomic) SCLensBitmojiAssetDataFetcher *bitmojiAssetDataFetcher; // @synthesize bitmojiAssetDataFetcher=_bitmojiAssetDataFetcher;
