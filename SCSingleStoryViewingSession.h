...
@class NSMutableArray, NSMutableSet, SCLazy, SCOperaContextLongformViewLogger, SCOperaViewInteraction, SCScopedAccess, SCSessionRequestManager, SCStopwatch, SCStoriesOperaPlaybackSequence, SCStoriesPlaybackLoggingInfo, SCStoriesSnapPlaybackMetadata, SCStoriesViewingSession, SCUnlockableBlizzardLogger, SCUserSession;
