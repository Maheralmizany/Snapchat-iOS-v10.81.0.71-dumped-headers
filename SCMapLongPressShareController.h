...
@protocol SCMapInstance, SCMapScreenshotCropProvider, SCMapScreenshotOverlayViewsProvider, SCMapScreenshotPresenter, SCMapTouchResponderPresentationDelegate;
...
@interface SCMapLongPressShareController : NSObject <SCMapTouchResponder>
{
    ...
    id <SCMapScreenshotCropProvider> _cropProvider;
...
- (id)initWithMapInstanceView:(id)arg1 mapScreenshotPresenter:(id)arg2 overlaysProvider:(id)arg3 presentationDelegate:(id)arg4 cropProvider:(id)arg5 renderLayer:(id)arg6;
