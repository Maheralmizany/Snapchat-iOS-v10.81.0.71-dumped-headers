...
@class NSString, SCQuickStickerImage, SCReplyParameters, SCScopedAccess, UIImageView;
...
@interface SCFeatureSnapReplyImpl : SCFeature <SCFeatureSnapReply>
{
    ...
    SCScopedAccess *_conversationIdResolver;
...
- (id)initWithStickerImage:(id)arg1 conversationId:(id)arg2;
