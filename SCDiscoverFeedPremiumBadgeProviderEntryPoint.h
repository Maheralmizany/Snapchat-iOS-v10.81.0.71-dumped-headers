...
@class SCDiscoverFeedPremiumBadgeProvider, SCNavigationItemBadgeProviderScope;

@interface SCDiscoverFeedPremiumBadgeProviderEntryPoint : SCEntryPoint
{
    SCDiscoverFeedPremiumBadgeProvider *_badgeProvider;
