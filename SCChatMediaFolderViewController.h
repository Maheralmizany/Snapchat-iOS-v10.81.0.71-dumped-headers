...
@class FBKVOController, NSArray, NSString, SCEventListenerAnnouncer, SCGalleryTabCollectionViewFlowLayout, SCProfileChatMediaDataSource, SCProfileChatMediaFolderPageActionHandler, SCProfileChatMediaScreenCaptureMonitor, SCSavedInChatCollectionViewLayoutCalculator, SCSavedInChatFolderHeaderBar, SCUnifiedProfileLoggingService, UICollectionView;
