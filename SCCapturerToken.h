...
#import "SCBitmojiCameraAdaptorCapturerToken-Protocol.h"

@class NSString, SCCaptureStateMachineContext;

@interface SCCapturerToken : NSObject <SCBitmojiCameraAdaptorCapturerToken>
{
...
- (void)stopRunningWithCompletion:(CDUnknownBlockType)arg1;
