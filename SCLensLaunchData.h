...
@class NSString, SCLensLaunchParams, SCLensLures, SCLensPersistentStore, SCLensSbSnappable, SCLensUserData;
...
@property(nonatomic) _Bool hasLaunchParams; // @dynamic hasLaunchParams;
...
@property(retain, nonatomic) SCLensLaunchParams *launchParams; // @dynamic launchParams;
