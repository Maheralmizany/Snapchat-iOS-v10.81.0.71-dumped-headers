...
@class NSString, SCFeatureSettingsService, SCQueuePerformer, SCRequestManager;
...
- (id)initWithRequestManager:(id)arg1 identityUserAdaptor:(id)arg2 featureSettingsService:(id)arg3;
