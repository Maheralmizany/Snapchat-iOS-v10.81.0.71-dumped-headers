...
- (id)initWithPlacementId:(id)arg1 compositeCreativeId:(id)arg2 tileImageURL:(id)arg3 tileLogoURL:(id)arg4 tileHeadline:(id)arg5 shouldLoop:(_Bool)arg6 storyDedupeFp:(unsigned long long)arg7;
