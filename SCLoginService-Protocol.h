...
- (void)loginWithUsernameOrEmail:(NSString *)arg1 password:(NSString *)arg2 preAuthToken:(NSString *)arg3 twoFAMethod:(int)arg4 odlvPreAuthToken:(NSString *)arg5 otpType:(long long)arg6 confirmReactivation:(_Bool)arg7 rememberDevice:(_Bool)arg8 fideliusClientInit:(SOJUSecurityFideliusClientInit *)arg9 successBlock:(void (^)(SOJULoginResponse *))arg10 failureBlock:(void (^)(SCLogInError *))arg11;
