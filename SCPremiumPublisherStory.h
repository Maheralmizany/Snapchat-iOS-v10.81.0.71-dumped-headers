...
@class NSArray, NSString, SCPremiumPublisher, SCPublisherHNNewsMetadata, SCPublisherShowMetadata, SCPublisherStoryWatchedState;
...
@interface SCPremiumPublisherStory : NSObject <NSCopying, NSCoding>
{
    ...
    SCPublisherHNNewsMetadata *_hNNewsMetaData;
...
@property(readonly, copy, nonatomic) SCPublisherHNNewsMetadata *hNNewsMetaData; // @synthesize hNNewsMetaData=_hNNewsMetaData;
