...
@property(readonly, nonatomic) _Bool isFirstFrameOptional; // @synthesize isFirstFrameOptional=_isFirstFrameOptional;
...
- (id)initWithFirstFrameImage:(id)arg1 isFirstFrameOptional:(_Bool)arg2 video:(id)arg3;
