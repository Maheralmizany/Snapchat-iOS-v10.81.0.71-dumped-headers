...
- (id)initWithRowid:(long long)arg1 badgeId:(id)arg2 badgeType:(long long)arg3 badgeMetadata:(id)arg4 renderInfo:(id)arg5 tapDestination:(id)arg6 fetchedTimestampInSec:(double)arg7 serverNextRequestTimestampInSec:(double)arg8 streamId:(id)arg9;
