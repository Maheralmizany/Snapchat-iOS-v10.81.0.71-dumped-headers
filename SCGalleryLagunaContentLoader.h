...
@class NSMutableArray, NSString, SCCloudFSFile, SCGalleryLagunaContentListenerAnnouncer, SCSpectaclesServices, SCUserSession;
...
- (id)initWithSnap:(id)arg1 content:(id)arg2 performer:(id)arg3 userSession:(id)arg4 spectaclesServices:(id)arg5;
