...
@class NSArray, NSString, SCLazy, User;
...
@property(readonly, copy, nonatomic) NSString *incomingFriendsSyncToken;
@property(readonly, copy, nonatomic) NSString *outgoingFriendsSyncToken;
...
- (id)allSuggestedSnapchattersForSuggestionPage:(unsigned int)arg1;
