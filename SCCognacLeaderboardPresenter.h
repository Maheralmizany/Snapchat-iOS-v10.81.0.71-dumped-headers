...
@class NSString, SCCognacLeaderboardViewController, UIViewController;
@protocol SCCognacLeaderboardPresenterDelegate, SCSwipeTransitionCoordinator;
...
{
    id <SCSwipeTransitionCoordinator> _transitionCoordinator;
