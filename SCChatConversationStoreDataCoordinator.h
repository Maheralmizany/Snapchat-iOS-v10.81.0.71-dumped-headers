...
@class NSMutableDictionary, NSString, SCChatConversationV3, SCChatSendBlockAssigner, SCChatSendBlockInfo, SCChatV3ConversationStore, SCDataCoordinatorListenerAnnouncer, SCQueuePerformer;
@protocol SCArroyoConversationIdsManaging, SCChatMessageActionHandling;
...
- (void)_resumeActiveConversationId:(id)arg1 chatIdentifier:(id)arg2;
