...
- (void)prepareStickerPostSendTasksOnMultiSnapEphemeralMediaList:(SCPreviewEphemeralMediaList *)arg1 forSticker:(_Bool (^)(SCStickerState *))arg2 prepareBlock:(SCStickerState * (^)(EphemeralMedia *, SCStickerState *, NSMutableDictionary *))arg3;
