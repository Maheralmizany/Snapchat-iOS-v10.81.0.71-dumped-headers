...
#import "SCLegacyPageViewLogger-Protocol.h"
...
- (void)_logPageViewSession:(id)arg1 withCpuUsageDict:(id)arg2 gpuUsageDict:(id)arg3 cpuHistory:(id)arg4 gpuHistory:(id)arg5 badgeStates:(id)arg6 nextPageName:(id)arg7;
- (void)_endPageViewWithPageName:(id)arg1 nextPageName:(id)arg2 endTime:(double)arg3 exitEvent:(long long)arg4 badgeStates:(id)arg5;
...
- (id)getPreviousPage;
- (id)getCurrentPage;
- (void)endPageViewWithPageName:(id)arg1 nextPageName:(id)arg2 exitEvent:(long long)arg3 badgeStates:(id)arg4;
