...
@class NSString, SCUserInfoServices, SCUserSession, User;
...
- (id)messageReceiver;
- (id)messageSender;
- (id)initWithUser:(id)arg1 userSession:(id)arg2 userInfoServices:(id)arg3 conversationIdResolver:(id)arg4 loadMessageLogger:(id)arg5 storyMediaLoader:(id)arg6 graphene:(id)arg7;
