...
@class NSString, SCFeatureSettingsService, SCGroupUnifiedProfileDataSource;
...
- (id)initWithGroupManager:(id)arg1 groupId:(id)arg2 sourcePageType:(id)arg3 hideProfileOption:(_Bool)arg4 featureSettingsService:(id)arg5 dataSource:(id)arg6 shouldDisplayBadgeInManageGroup:(_Bool)arg7;
