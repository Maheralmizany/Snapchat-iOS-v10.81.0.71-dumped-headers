...
@interface SOJUGalleryServletGetUploadUrlsResponse : SCSojuMessage <SOJUGalleryServletGetUploadUrlsResponse>
{
}
...
@property(readonly, nonatomic) NSArray *urls; // @dynamic urls;
