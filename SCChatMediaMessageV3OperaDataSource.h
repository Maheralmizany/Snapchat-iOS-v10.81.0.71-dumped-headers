...
- (void)_unarchiveStorySnapContentIfNecessary:(id)arg1 posterStoryId:(id)arg2 storySnapIsPublic:(_Bool)arg3 message:(id)arg4;
...
- (void)_updateViewModelForStorySnapContent:(id)arg1 posterStoryId:(id)arg2 storySnapIsPublic:(_Bool)arg3 message:(id)arg4;
...
- (void)_initViewModelsWithStorySnapMediaContent:(id)arg1 posterStoryId:(id)arg2 storySnapIsPublic:(_Bool)arg3 message:(id)arg4;
