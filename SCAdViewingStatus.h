...
@interface SCAdViewingStatus : NSObject <SCStoryAdTrackInfo>
{
    ...
    long long _attachmentTriggerType;
...
- (void)setDeepLinkFromCard:(_Bool)arg1 deepLinkFallBackToAppStore:(_Bool)arg2 deepLinkFallBackToWebview:(_Bool)arg3 deepLinkURI:(id)arg4 snapIndex:(long long)arg5 interactionZoneItemIndex:(id)arg6;
...
- (void)setTopSnapMediaDurationMillis:(long long)arg1 topSnapReportedViewDurationMillis:(long long)arg2 snapIndex:(long long)arg3;
- (void)resetForSwipeBackTracking;
- (void)adScreenshotAtSnapIndex:(long long)arg1;
- (void)adLongPressedAtSnapIndex:(long long)arg1;
- (void)swipeUpToCardAtSnapIndex:(long long)arg1 attachmentTriggerType:(long long)arg2;
- (void)swipedFromTopSnap:(_Bool)arg1 snapIndex:(long long)arg2 viewContext:(id)arg3 currentMediaVolumePercent:(double)arg4 attachmentTriggerType:(long long)arg5;
