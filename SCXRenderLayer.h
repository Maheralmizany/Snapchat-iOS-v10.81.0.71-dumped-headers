...
@class CADisplayLink, EAGLContext, NSArray, NSMutableArray, NSMutableSet, NSString, SCThrottleTimer, SCXBlackOverlayRenderer, SCXBlockBasedCustomGLLayer, SCXHeatmapRenderer, SCXOverlaySpriteRenderer, SCXPathRenderer, SCXPluginSpriteRenderer, SCXRenderContext, SCXRenderLockManager, SCXShadedRadiusRenderer, SCXStandingObjectsRenderer, SCXTapAnimationViewStateManager, SCXTapCircleRenderer, SCXThumbnailViewStateManager, SCXWeather, SCXWeatherRenderer, UIView;
@protocol SCMapConfiguration, SCMapCustomGLRenderer, SCMapLoadingState, SCMapViewport;
