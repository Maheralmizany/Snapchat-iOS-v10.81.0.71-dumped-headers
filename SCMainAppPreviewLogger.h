...
@protocol SCImageProcessVideoPlaybackLogging, SCPreviewAggregateLatencyLogging, SCPreviewLatencyLogging, SCPreviewUserInteractionStateLogging;
...
@property(retain, nonatomic) id <SCImageProcessVideoPlaybackLogging> videoPlaybackLogger; // @synthesize videoPlaybackLogger=_videoPlaybackLogger;
...
- (id)blizzardEventsForSendingSharedMessage:(id)arg1 isFromSnapchatGallery:(_Bool)arg2;
