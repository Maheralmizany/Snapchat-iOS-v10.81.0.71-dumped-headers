...
@class GPBBoolValue, GPBInt32Value, GPBInt64Value, GPBStringValue, NSData, NSMutableArray, SCAdsAdKitFeatureFlags, SCAdsApplication, SCAdsDevice, SCAdsNetwork, SCAdsPreferences;
