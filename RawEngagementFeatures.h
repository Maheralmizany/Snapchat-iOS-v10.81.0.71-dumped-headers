...
@property(retain, nonatomic) GPBInt32UInt64Dictionary *entryIntentCounts; // @dynamic entryIntentCounts;
@property(readonly, nonatomic) unsigned long long entryIntentCounts_Count; // @dynamic entryIntentCounts_Count;
...
@property(retain, nonatomic) GPBInt32UInt64Dictionary *exitIntentCounts; // @dynamic exitIntentCounts;
@property(readonly, nonatomic) unsigned long long exitIntentCounts_Count; // @dynamic exitIntentCounts_Count;
