...
@class NSString, SCCognacLSBCypressProxy, SCCognacOperaDataSource, SCCognacOperaPlayerItem, SCCognacOperaViewingSession, SCCognacPreconditionsChecker, SCCognacWebProxy, SCOperaViewController, UIView;
...
@interface SCCognacOperaPresenter : NSObject <SCOperaEventListener, SCCognacOperaDataSourceAppURLTransformer>
{
    ...
    SCCognacLSBCypressProxy *_cypressProxy;
