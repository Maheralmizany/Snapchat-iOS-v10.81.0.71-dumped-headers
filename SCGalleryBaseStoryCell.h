...
@class MASConstraint, NSIndexPath, NSString, NSTimer, SCGalleryEntrySyncStatusGenerator, SCGalleryEntryThumbnailGenerator, SCGalleryStoryViewModel, SCLoadingIndicatorView, SCMemoriesCollectionViewSelectionHelper, SCMemoriesStatusIcon, SCUserSession, UIButton, UICollectionView, UIImage, UIImageView, UILabel, UILongPressGestureRecognizer, UITextField, UIView, UIViewController;
@protocol SCGalleryStoryCellDelegate;

@interface SCGalleryBaseStoryCell : SCGalleryStoriesTabCell <SCGalleryEntryThumbnailGeneratorDelegate, SCProgressReceiving, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UITextFieldDelegate, UIGestureRecognizerDelegate, SCMemoriesCellUpdating, SCMemoriesCellTransitioning, SCMemoriesCellSelecting>
{
    ...
    SCMemoriesCollectionViewSelectionHelper *_selectionHelper;
...
@property(nonatomic) __weak SCMemoriesCollectionViewSelectionHelper *selectionHelper; // @synthesize selectionHelper=_selectionHelper;
...
- (void)setViewModel:(id)arg1 mediaScenePath:(CDStruct_bac8f6e9)arg2 offset:(double)arg3 selectMode:(_Bool)arg4 userSession:(id)arg5;
