...
- (id)initWithSnapchattersDataTracker:(id)arg1 nonSnapchattersDataFetcher:(id)arg2 snapchattersDataFetcher:(id)arg3 userInfoProvider:(id)arg4 viewedIncomingFriendsTracker:(id)arg5 inviteFriendStateTracker:(id)arg6 imageDownloader:(id)arg7 userSession:(id)arg8;
