...
@class NSString, SCLazy, SCSendToSelectionStateManager, SCSnapKitAppFeatureToggleRequestCoordinator, SCUserSession, UIViewController;
@protocol SCSearchContentViewControlling, SCSendToStoriesDataSource;
...
- (_Bool)_isAppStoryConnectFromSnapchatItemForAppId:(id)arg1;
- (void)_handleLocalUpdateForDidAuthorize:(id)arg1;
- (void)handleConnectFromSnapchatCompletionWithApplicationId:(id)arg1 didAuthorize:(_Bool)arg2;
- (void)_handleSelectAppStoryForDataModel:(id)arg1;
- (_Bool)handleActionWithSender:(id)arg1 actionModel:(id)arg2 fromSourceView:(id)arg3;
- (id)initWithUserSession:(id)arg1 selectionStateManager:(id)arg2 storiesDataSource:(id)arg3 userTrackedLogger:(id)arg4;
