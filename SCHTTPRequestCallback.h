...
- (void)onFinishWithParsedData:(id)arg1 info:(id)arg2 error:(id)arg3 shouldInvokeCallback:(_Bool)arg4;
- (void)onCanceled:(id)arg1 info:(id)arg2;
- (void)onFailed:(id)arg1 info:(id)arg2 error:(id)arg3 willRetry:(_Bool)arg4;
- (void)onWriteCompleted:(id)arg1 totalBytesWritten:(long long)arg2 totalBytesExpectedToWrite:(long long)arg3;
- (void)onSucceeded:(id)arg1 info:(id)arg2 buffer:(id)arg3 willRetry:(_Bool)arg4;
