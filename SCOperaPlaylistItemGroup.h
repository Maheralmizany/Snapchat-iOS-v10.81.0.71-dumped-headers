...
@interface SCOperaPlaylistItemGroup : NSObject
{
    ...
    _Bool _forwardAutoAdvanceEnabled;
    _Bool _backwardsAutoAdvanceEnabled;
...
@property(nonatomic) _Bool backwardsAutoAdvanceEnabled; // @synthesize backwardsAutoAdvanceEnabled=_backwardsAutoAdvanceEnabled;
@property(nonatomic) _Bool forwardAutoAdvanceEnabled; // @synthesize forwardAutoAdvanceEnabled=_forwardAutoAdvanceEnabled;
...
- (id)initWithID:(id)arg1 type:(id)arg2 featureName:(id)arg3 context:(id)arg4 swipeToDismissEnabled:(_Bool)arg5 forwardAutoAdvanceEnabled:(_Bool)arg6 backwardsAutoAdvanceEnabled:(_Bool)arg7 loopToFirstItemEnabled:(_Bool)arg8;
